...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Familiar_CloneVData : public source2sdk::client::CitadelAbilityVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Familiar_CloneVData) == 0x1908);
    };
};
