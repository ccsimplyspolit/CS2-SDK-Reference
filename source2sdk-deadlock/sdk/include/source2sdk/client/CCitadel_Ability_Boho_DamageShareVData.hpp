...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_DamageShareParticle[0xe0]; // 0x1818            
            ...
            char m_DamageShareModifier[0x10]; // 0x18f8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Boho_DamageShareVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Boho_DamageShareVData) == 0x1908);
    };
};
