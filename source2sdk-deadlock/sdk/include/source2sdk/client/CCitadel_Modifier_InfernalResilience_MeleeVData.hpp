...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_InfernalResilience_MeleeVData : public source2sdk::client::CCitadel_Modifier_BaseEventProcVData
        {
        public:
        ...
        // Cannot assert offsets of fields in CCitadel_Modifier_InfernalResilience_MeleeVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_InfernalResilience_MeleeVData) == 0x950);
    };
};
