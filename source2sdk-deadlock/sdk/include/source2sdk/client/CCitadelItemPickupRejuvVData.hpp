...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadelItemPickupRejuvVData : public source2sdk::client::CCitadelItemPickupVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadelItemPickupRejuvVData) == 0x220);
    };
};
