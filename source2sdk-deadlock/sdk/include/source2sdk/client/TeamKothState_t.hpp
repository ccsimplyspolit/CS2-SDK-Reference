...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // C_NetworkUtlVectorBase<source2sdk::client::HeroID_t> m_vecParticipants;
            char m_vecParticipants[0x18]; // 0x40            
        };
        #pragma pack(pop)
        
        static_assert(offsetof(source2sdk::client::TeamKothState_t, m_flCaptureProgressFrac) == 0x30);
        static_assert(offsetof(source2sdk::client::TeamKothState_t, m_nCapturerCount) == 0x34);
        static_assert(offsetof(source2sdk::client::TeamKothState_t, m_bIsBlocked) == 0x38);
        static_assert(offsetof(source2sdk::client::TeamKothState_t, m_vecParticipants) == 0x40);
        
        static_assert(sizeof(source2sdk::client::TeamKothState_t) == 0x58);
    };
};
