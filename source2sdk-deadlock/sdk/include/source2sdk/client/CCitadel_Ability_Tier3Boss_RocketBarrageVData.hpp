...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Tier3Boss_RocketBarrageVData : public source2sdk::client::CitadelAbilityVData
        {
        public:
        ...
        // Cannot assert offsets of fields in CCitadel_Ability_Tier3Boss_RocketBarrageVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Tier3Boss_RocketBarrageVData) == 0x1930);
    };
};
