...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Item_PrismBlastVData : public source2sdk::client::CCitadel_Item_BubbleVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Item_PrismBlastVData) == 0x1c78);
    };
};
