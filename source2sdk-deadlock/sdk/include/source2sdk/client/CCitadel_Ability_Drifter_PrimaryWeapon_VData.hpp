...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_strSwipeTracerParticleLeft[0xe0]; // 0x1aa0            
            ...
            char m_vecOriginOffsetsLeft[0x18]; // 0x1b80            
            float m_flCenterBulletRadiusOverride; // 0x1b98            
            uint8_t _pad1b9c[0x4];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Drifter_PrimaryWeapon_VData) == 0x1ba0);
    };
};
