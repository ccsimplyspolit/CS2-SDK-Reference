...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::AbilityUpgradeState_t, m_ItemID) == 0x30);
        static_assert(offsetof(source2sdk::client::AbilityUpgradeState_t, m_nUpgradeInfo) == 0x34);
        
        static_assert(sizeof(source2sdk::client::AbilityUpgradeState_t) == 0x38);
    };
};
