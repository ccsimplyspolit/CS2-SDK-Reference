...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::CModifierProperty, m_bModifierStatesDirty) == 0x1c5);
        static_assert(offsetof(source2sdk::client::CModifierProperty, m_bPredictedOwner) == 0x1c6);
        static_assert(offsetof(source2sdk::client::CModifierProperty, m_bAllowModifiersOnDeadEntities) == 0x1c7);
        static_assert(offsetof(source2sdk::client::CModifierProperty, m_iLockRefCount) == 0x1c8);
        static_assert(offsetof(source2sdk::client::CModifierProperty, m_hHandle) == 0x1ca);
