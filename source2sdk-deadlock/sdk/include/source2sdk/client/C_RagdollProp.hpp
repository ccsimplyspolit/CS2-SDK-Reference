...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_hRagdollSource[0x4]; // 0xcfc            
            // metadata: MNotSaved
            source2sdk::modellib::AttachmentHandle_t m_iEyeAttachment; // 0xd00            
            uint8_t _pad0d01[0x3]; // 0xd01
            // metadata: MNotSaved
            float m_flBlendWeightCurrent; // 0xd04            
            // metadata: MNotSaved
            ...
            char m_parentPhysicsBoneIndices[0x18]; // 0xd08            
            // metadata: MNotSaved
            ...
            char m_worldSpaceBoneComputationOrder[0x18]; // 0xd20            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_RagdollProp because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_RagdollProp) == 0xd38);
    };
};
