...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_ArmorUpgrade_AutoCleanseVData : public source2sdk::client::CitadelItemVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_ArmorUpgrade_AutoCleanseVData) == 0x19b8);
    };
};
