...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_BulletShredImbue_ProcVData : public source2sdk::client::CCitadel_Modifier_BaseEventProcVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::client::CBaseModifier> m_BuffNonHeroModifier;
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_BulletShredImbue_ProcVData) == 0x7a0);
    };
};
