...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int8_t m_nDeathReplayAvailable; // 0xc30
            // metadata: MNetworkEnable
            source2sdk::client::CitadelLobbyPlayerSlot_t m_unLobbyPlayerSlot; // 0xc31
            bool m_bHasCheckedFriendName; // 0xc32
            uint8_t _pad0c33[0x5]; // 0xc33
            CUtlString m_sFriendName; // 0xc38
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CCitadelPlayerController because it is not a standard-layout class

        static_assert(sizeof(source2sdk::client::CCitadelPlayerController) == 0xc40);
    };
};
