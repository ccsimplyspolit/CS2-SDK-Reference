...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_WeaponUpgrade_RechargingBulletsVData : public source2sdk::client::CitadelItemVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_WeaponUpgrade_RechargingBulletsVData) == 0x19b8);
    };
};
