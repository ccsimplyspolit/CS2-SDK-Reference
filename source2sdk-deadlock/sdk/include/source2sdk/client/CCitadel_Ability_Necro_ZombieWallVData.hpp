...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Necro_ZombieWallVData : public source2sdk::client::CitadelAbilityVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Necro_ZombieWallVData) == 0x1ad8);
    };
};
