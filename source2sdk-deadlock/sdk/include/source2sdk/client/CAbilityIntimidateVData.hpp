...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_EnemyModifier[0x10]; // 0x1818            
            ...
            char m_AoEPlayerParticle[0xe0]; // 0x1838            
