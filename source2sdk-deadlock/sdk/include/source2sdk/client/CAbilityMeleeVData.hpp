...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float m_flMeleeInputBufferTime; // 0x1818            
            ...
            float m_flLightAttackMaxHoldTime; // 0x1824            
            ...
            float m_flSideDashDodgeDist; // 0x1828            
            ...
            float m_flBackDashDodgeDist; // 0x182c            
            source2sdk::client::TakeDamageFlags_t m_MeleeDamageFlags; // 0x1830            
            CUtlString m_strEffectsAttachName; // 0x1838            
            // metadata: MPropertyStartGroup "AnimGraph2"
            float m_flChargeAnimDelayTime; // 0x1840            
        ...
        static_assert(sizeof(source2sdk::client::CAbilityMeleeVData) == 0x1848);
    };
};
