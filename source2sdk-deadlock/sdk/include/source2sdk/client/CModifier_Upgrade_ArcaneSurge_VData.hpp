...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_SurgeWindowModifier;
        ...
        static_assert(sizeof(source2sdk::client::CModifier_Upgrade_ArcaneSurge_VData) == 0x778);
    };
};
