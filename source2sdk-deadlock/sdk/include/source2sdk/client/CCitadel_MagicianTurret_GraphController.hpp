...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_MagicianTurret_GraphController : public source2sdk::client::CAnimGraphControllerBase
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_MagicianTurret_GraphController) == 0xe0);
    };
};
