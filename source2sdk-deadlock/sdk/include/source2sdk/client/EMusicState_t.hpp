...
namespace source2sdk
{
    namespace client
    {
        ...
        enum class EMusicState_t : std::uint32_t
        {
            ...
            EMusicState_Idol_Carry = 0x6,
            EStinger_HeroDeath = 0x7,
            EStinger_KillStreak_01 = 0x8,
            EStinger_KillStreak_02 = 0x9,
            EStinger_KillStreak_03 = 0xa,
            EStinger_KillStreak_04 = 0xb,
            EStinger_KillStreak_05 = 0xc,
            EStinger_KillStreak_06 = 0xd,
            EStinger_KillStreak_07 = 0xe,
            EStinger_KillStreak_08 = 0xf,
            EStinger_KillStreak_09 = 0x10,
            EStinger_KillStreak_10 = 0x11,
            EStinger_Idol_DropAnnounce = 0x12,
            EStinger_MidBoss_Arrived = 0x13,
            EMusicState_Idol_ReturnTimer = 0x14,
            EMusicState_Koth_ReturnTimer = 0x15,
            EStinger_Idol_Returned_Team = 0x16,
            EStinger_Idol_Returned_Opponent = 0x17,
            EStinger_Koth_Win = 0x18,
            EStinger_Koth_Lose = 0x19,
            EStinger_Koth_Expire = 0x1a,
            EStinger_BossKilled_T1_Friendly = 0x1b,
            EStinger_BossKilled_T1_Enemy = 0x1c,
            EStinger_BossKilled_T2_Friendly = 0x1d,
            EStinger_BossKilled_T2_Enemy = 0x1e,
