...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_BounceModifier[0x10]; // 0x1818            
            ...
            char m_AllyBounceModifier[0x10]; // 0x1828            
            ...
            char m_SpeedOnLandModifier[0x10]; // 0x1838            
            ...
            char m_NoBounceModifier[0x10]; // 0x1848            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityBouncePadVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CAbilityBouncePadVData) == 0x1858);
    };
};
