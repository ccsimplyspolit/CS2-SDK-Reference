...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_Objective_BulletReistVData) == 0x758);
    };
};
