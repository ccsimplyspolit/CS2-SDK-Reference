...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Bounce_Pad_GraphController : public source2sdk::client::CAnimGraphControllerBase
        {
        public:
