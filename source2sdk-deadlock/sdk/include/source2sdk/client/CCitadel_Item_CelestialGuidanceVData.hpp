...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Item_CelestialGuidanceVData : public source2sdk::client::CitadelItemVData
        {
        public:
        ...
        // Cannot assert offsets of fields in CCitadel_Item_CelestialGuidanceVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Item_CelestialGuidanceVData) == 0x19b8);
    };
};
