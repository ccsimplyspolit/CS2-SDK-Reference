...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_InnateModifier[0x10]; // 0x1818            
            ...
            float m_flDamageFalloffEndScale; // 0x1838            
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_ShieldedSentry_VData) == 0x1840);
    };
};
