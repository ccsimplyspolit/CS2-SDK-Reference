...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Necro_KillSummonTriggerVData : public source2sdk::client::CBaseTriggerAbilityVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Necro_KillSummonTriggerVData) == 0x1938);
    };
};
