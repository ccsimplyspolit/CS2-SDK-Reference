...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CModifier_Fencer_Ultimate_Target_VData : public source2sdk::client::CCitadelModifierVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CModifier_Fencer_Ultimate_Target_VData) == 0x868);
    };
};
