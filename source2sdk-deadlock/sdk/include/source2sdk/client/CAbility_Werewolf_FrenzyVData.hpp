...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CAbility_Werewolf_FrenzyVData : public source2sdk::client::CitadelAbilityVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CAbility_Werewolf_FrenzyVData) == 0x1ae8);
    };
};
