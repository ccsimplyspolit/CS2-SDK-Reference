...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Item_ShadowStepVData : public source2sdk::client::CitadelItemVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Item_ShadowStepVData) == 0x1c78);
    };
};
