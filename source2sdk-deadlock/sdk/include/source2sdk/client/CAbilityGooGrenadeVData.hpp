...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_GooGrenadePuddleAuraFriendlyModifier;
        ...
        static_assert(sizeof(source2sdk::client::CAbilityGooGrenadeVData) == 0x1a20);
    };
};
