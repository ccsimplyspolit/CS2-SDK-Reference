...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            CSoundEventName m_strWeaponShootSound; // 0x830            
            CSoundEventName m_strBulletWhizSound; // 0x840            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_TargetPracticeSelfVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_TargetPracticeSelfVData) == 0x850);
    };
};
