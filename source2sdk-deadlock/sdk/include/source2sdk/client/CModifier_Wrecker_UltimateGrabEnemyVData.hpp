...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_EnemyHeroStasisEffect[0xe0]; // 0x750            
            ...
            char m_EnemyHeroGrabEffect[0xe0]; // 0x830            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CModifier_Wrecker_UltimateGrabEnemyVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CModifier_Wrecker_UltimateGrabEnemyVData) == 0x910);
    };
};
