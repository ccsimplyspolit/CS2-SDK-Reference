...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            CSoundEventName m_BerserkerSound; // 0x750            
            ...
            char m_ModifierActiveDisplay[0x10]; // 0x760            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_Surging_PowerVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_Surging_PowerVData) == 0x770);
    };
};
