...
#include "source2sdk/client/CCitadel_MultiCapturePointVData.hpp"
...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_KothCashInVData : public source2sdk::client::CCitadel_MultiCapturePointVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::client::CBaseModifier> m_ComebackAuraModifier;
            ...
            // CEmbeddedSubclass<source2sdk::client::CBaseModifier> m_TrooperModifier;
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_KothCashInVData) == 0x848);
    };
};
