...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_Werewolf_TransformationWatcherVData : public source2sdk::client::CCitadelModifierVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_HunterModifier;
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_Werewolf_TransformationWatcherVData) == 0x7a0);
    };
};
