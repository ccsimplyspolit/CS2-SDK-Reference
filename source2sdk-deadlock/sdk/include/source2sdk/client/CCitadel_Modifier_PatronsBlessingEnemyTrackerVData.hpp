...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_PatronsBlessingEnemyTrackerVData : public source2sdk::client::CCitadelModifierVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_PatronsBlessingEnemyTrackerVData) == 0x850);
    };
};
