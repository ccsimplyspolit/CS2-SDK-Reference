...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::PlayerDataGlobal_t, m_vecUpgrades) == 0x90);
        static_assert(offsetof(source2sdk::client::PlayerDataGlobal_t, m_vecBonusCounterAbilities) == 0xa8);
        static_assert(offsetof(source2sdk::client::PlayerDataGlobal_t, m_vecBonusCounterValues) == 0xc0);
        static_assert(offsetof(source2sdk::client::PlayerDataGlobal_t, m_vecBonusCounterModifiers) == 0xd8);
        static_assert(offsetof(source2sdk::client::PlayerDataGlobal_t, m_vecModifierBonusCounterValues) == 0xf0);
        static_assert(offsetof(source2sdk::client::PlayerDataGlobal_t, m_tHeldItem) == 0x108);
        static_assert(offsetof(source2sdk::client::PlayerDataGlobal_t, m_vecImbuements) == 0x110);
        static_assert(offsetof(source2sdk::client::PlayerDataGlobal_t, m_vecDynamicAbilityValues) == 0x178);
        static_assert(offsetof(source2sdk::client::PlayerDataGlobal_t, m_vecStatViewerModifierValues) == 0x1e0);
        static_assert(offsetof(source2sdk::client::PlayerDataGlobal_t, m_vecStolenAbilities) == 0x248);
        static_assert(offsetof(source2sdk::client::PlayerDataGlobal_t, m_vecAbilityUpgradeState) == 0x2b0);
        static_assert(offsetof(source2sdk::client::PlayerDataGlobal_t, m_strIconHeroCardOverride) == 0x318);
        static_assert(offsetof(source2sdk::client::PlayerDataGlobal_t, m_strIconHeroCardCriticalOverride) == 0x320);
        static_assert(offsetof(source2sdk::client::PlayerDataGlobal_t, m_strIconHeroCardGloatOverride) == 0x328);
        
        static_assert(sizeof(source2sdk::client::PlayerDataGlobal_t) == 0x330);
    };
};
