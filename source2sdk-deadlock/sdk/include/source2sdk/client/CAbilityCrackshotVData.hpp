...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_ExplosionVictimParticle[0xe0]; // 0x18f8            
            ...
            char m_ReadyParticle[0xe0]; // 0x19d8            
            ...
            char m_CrackshotImmuneModifier[0x10]; // 0x1ac8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_HeadShotVictimSound; // 0x1ad8            
            CSoundEventName m_HeadShotConfirmationSound; // 0x1ae8            
            CSoundEventName m_ReadySound; // 0x1af8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityCrackshotVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CAbilityCrackshotVData) == 0x1b08);
    };
};
