...
namespace source2sdk
{
    namespace client
    {
        ...
        enum class Class_T : std::uint32_t
        {
            ...
            CLASS_ITEM_PICKUP = 0x2b,
            CLASS_GOLDEN_IDOL_PICKUP = 0x2c,
            CLASS_KOTH_SPAWNER = 0x2d,
            ...
            CLASS_KOTH_CAPTURE_POINT = 0x5a,
            CLASS_ESCORT = 0x5b,
            CLASS_NPC_FLYING_PIGEON = 0x5c,
            CLASS_NPC_HIDEOUT_CAT = 0x5d,
            CLASS_HIDEOUT_BALL = 0x5e,
            CLASS_PRIEST_BEARTRAP_PROJECTILE = 0x5f,
            CLASS_SHIELD = 0x60,
            CLASS_NECRO_SKELE = 0x61,
            CLASS_NECRO_HAUNTINGSKULL = 0x62,
            CLASS_NECRO_GRAVESTONE = 0x63,
            CLASS_TRIGGER_NO_PORTALS = 0x64,
            CLASS_AIRHEART_STICKYBOMBINWORLD = 0x65,
            CLASS_AIRHEART_PACKAGE = 0x66,
            CLASS_FAMILIAR_SHIELD = 0x67,
            CLASS_TEAM_REVEAL_HERO_CARD = 0x68,
            CLASS_FAMILIAR_HELPINGHAND = 0x69,
