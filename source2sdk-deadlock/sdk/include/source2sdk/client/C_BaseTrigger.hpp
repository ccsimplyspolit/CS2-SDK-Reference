...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::entity2::CEntityIOOutput m_OnEndTouch; // 0x9d8            
            source2sdk::entity2::CEntityIOOutput m_OnEndTouchAll; // 0x9f0            
            source2sdk::entity2::CEntityIOOutput m_OnTouching; // 0xa08            
            source2sdk::entity2::CEntityIOOutput m_OnTouchingEachEntity; // 0xa20            
            source2sdk::entity2::CEntityIOOutput m_OnNotTouching; // 0xa38            
            ...
            char m_hTouchingEntities[0x18]; // 0xa50            
            CUtlSymbolLarge m_iFilterName; // 0xa68            
            // m_hFilter has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::client::CBaseFilter> m_hFilter;
            char m_hFilter[0x4]; // 0xa70            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "OnNetworkedDisableChanged"
            bool m_bDisabled; // 0xa74            
            uint8_t _pad0a75[0x3];
        ...
        static_assert(sizeof(source2sdk::client::C_BaseTrigger) == 0xa78);
    };
};
