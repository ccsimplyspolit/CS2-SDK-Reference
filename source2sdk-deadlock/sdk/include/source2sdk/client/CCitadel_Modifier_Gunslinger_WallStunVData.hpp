...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_StunModifier[0x10]; // 0x830            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_CasterMarkTriggerSound; // 0x840            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_Gunslinger_WallStunVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_Gunslinger_WallStunVData) == 0x850);
    };
};
