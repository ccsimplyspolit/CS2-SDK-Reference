...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_PetrifyModifier[0x10]; // 0x1908            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strBolaExplodeSound; // 0x1918            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Viper_PetrifyBolaVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Viper_PetrifyBolaVData) == 0x1928);
    };
};
