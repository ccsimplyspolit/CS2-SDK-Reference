...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_BleedModifier[0x10]; // 0x780            
            ...
            char m_BulletImpactParticle[0xe0]; // 0x7a0            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_Item_Bleeding_Bullets_ActiveVData) == 0x880);
    };
};
