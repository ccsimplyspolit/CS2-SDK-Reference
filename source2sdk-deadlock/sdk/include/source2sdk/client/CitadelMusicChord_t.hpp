...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            CUtlString m_strRenderedChordEvent; // 0x28
        };
        #pragma pack(pop)
        ...
        static_assert(offsetof(source2sdk::client::CitadelMusicChord_t, m_strRenderedChordEvent) == 0x28);

        static_assert(sizeof(source2sdk::client::CitadelMusicChord_t) == 0x30);
    };
};
