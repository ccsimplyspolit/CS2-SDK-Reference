...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // CEmbeddedSubclass<source2sdk::client::CCitadelModifier> m_DamageAmpModifier;
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Nano_CatFormVData) == 0x1a18);
    };
};
