...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CModifier_Mirage_Tornado_EvasionVData : public source2sdk::client::CCitadelModifierVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CModifier_Mirage_Tornado_EvasionVData) == 0xbd0);
    };
};
