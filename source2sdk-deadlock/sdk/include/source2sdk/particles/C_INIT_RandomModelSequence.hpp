...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            char m_ActivityName[256]; // 0x1e0            
            // metadata: MPropertyFriendlyName "sequence"
            // metadata: MPropertySuppressExpr "mod == dota"
            char m_SequenceName[256]; // 0x2e0            
