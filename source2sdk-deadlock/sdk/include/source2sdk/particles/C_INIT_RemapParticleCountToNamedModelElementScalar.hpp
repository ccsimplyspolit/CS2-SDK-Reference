...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            CUtlString m_outputMinName; // 0x218            
            // metadata: MPropertyFriendlyName "output max name"
            CUtlString m_outputMaxName; // 0x220            
        ...
        static_assert(sizeof(source2sdk::particles::C_INIT_RemapParticleCountToNamedModelElementScalar) == 0x230);
    };
};
