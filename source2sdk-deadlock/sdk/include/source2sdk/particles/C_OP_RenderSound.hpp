...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            float m_flSndLvlScale; // 0x22c            
            // metadata: MPropertyFriendlyName "pitch scale"
            float m_flPitchScale; // 0x230            
            // metadata: MPropertyFriendlyName "volume scale"
            float m_flVolumeScale; // 0x234            
            // metadata: MPropertyFriendlyName "decibel level field"
            // metadata: MPropertyAttributeChoiceName "particlefield_scalar"
            source2sdk::particles::ParticleAttributeIndex_t m_nSndLvlField; // 0x238            
        ...
        static_assert(sizeof(source2sdk::particles::C_OP_RenderSound) == 0x358);
    };
};
