...
namespace source2sdk
{
    namespace particles
    {
        ...
        static_assert(sizeof(source2sdk::particles::C_INIT_RandomTrailLength) == 0x1f0);
    };
};
