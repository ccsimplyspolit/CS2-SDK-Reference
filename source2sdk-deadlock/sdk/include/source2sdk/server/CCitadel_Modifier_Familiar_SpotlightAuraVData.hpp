...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_Familiar_SpotlightAuraVData : public source2sdk::server::CCitadelModifierAuraVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_Familiar_SpotlightAuraVData) == 0x890);
    };
};
