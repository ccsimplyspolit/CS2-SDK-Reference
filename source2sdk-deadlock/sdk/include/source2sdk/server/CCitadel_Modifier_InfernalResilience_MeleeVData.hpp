...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_InfernalResilience_MeleeVData : public source2sdk::server::CCitadel_Modifier_BaseEventProcVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_InfernalResilience_MeleeVData) == 0x950);
    };
};
