...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strRosterAvoidedSound) == 0x9b0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strVoteRevealSound) == 0x9c0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strLowHealthSound) == 0x9d0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strHeroSpecificLowHealthSound) == 0x9e0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strMovementLoop) == 0x9f0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strPostGameVictorySound) == 0xa00);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strPostGameDefeatSound) == 0xa10);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hGameSoundEventScript) == 0xa20);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_hGeneratedVOEventScript) == 0xb00);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flStealthSpeedMetersPerSecond) == 0xbe0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bInDevelopment) == 0xbe4);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bAssignedPlayersOnly) == 0xbe5);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bNewPlayerRecommended) == 0xbe6);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bLaneTestingRecommended) == 0xbe7);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bNeedsTesting) == 0xbe8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bLimitedTesting) == 0xbe9);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bDisabled) == 0xbea);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bPlayerSelectable) == 0xbeb);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bPrereleaseOnly) == 0xbec);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_nComplexity) == 0xbf0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_nAllyBotDifficulty) == 0xbf4);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_nEnemyBotDifficulty) == 0xbf8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMinLowHealthPercentage) == 0xbfc);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMaxLowHealthPercentage) == 0xc00);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMinMidHealthPercentage) == 0xc04);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMaxMidHealthPercentage) == 0xc08);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMinHealthForThreshold) == 0xc0c);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flMaxHealthForThreshold) == 0xc10);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flInCombatWithHeroDuration) == 0xc14);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flInCombatWithNonHeroDuration) == 0xc18);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flInCombatWithNeutralDuration) == 0xc1c);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bNAGunFalloffRange) == 0xc20);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_bAllowedInTunnels) == 0xc21);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapStartingStats) == 0xc28);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapScalingStats) == 0xc50);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_groundDashPositionCurve) == 0xc78);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapModCostBonuses) == 0xcb8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapBoundAbilities) == 0xcf8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapWIPAbilities) == 0xd20);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapItemSlotInfo) == 0xd48);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_eAbilityResourceType) == 0xdc0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strGunTag) == 0xdc8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_vecHeroTags) == 0xdd0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_eHeroType) == 0xde8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strRosterBackgroundLayout) == 0xdf0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strHideoutRichPresence) == 0xdf8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapItemDraftCounterWeights) == 0xe00);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapStandardLevelUpUpgrades) == 0xe40);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapLevelInfo) == 0xe68);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapPurchaseBonuses) == 0xe90);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapItemDraftBucketing) == 0xeb8);
        
        static_assert(sizeof(source2sdk::server::CitadelHeroData_t) == 0xf08);
    };
};
