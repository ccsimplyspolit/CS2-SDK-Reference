...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_GraveStoneVData : public source2sdk::server::CCitadelModifierAuraVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_CasterBuffModifier;
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_GravestoneCriticalModifier;
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_GraveStoneVData) == 0xa78);
    };
};
