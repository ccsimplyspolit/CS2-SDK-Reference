...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Necro_KillSummonVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Necro_KillSummonVData) == 0x18f8);
    };
};
