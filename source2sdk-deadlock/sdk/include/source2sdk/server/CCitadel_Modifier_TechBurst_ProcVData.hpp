...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_ProcParticle[0xe0]; // 0x788            
            ...
            char m_ProcNotificationModifier[0x10]; // 0x868            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_TechBurst_ProcVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_TechBurst_ProcVData) == 0x878);
    };
};
