...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_DazzlingOrbWatcherVData : public source2sdk::server::CCitadelModifierVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_NextTargetModifier;
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_OrbFriendlyBounceWatcherModifier;
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_DazzlingOrbWatcherVData) == 0xb48);
    };
};
