...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hSpriteMaterial[0x8]; // 0x780            
            // metadata: MNetworkEnable
            ...
            char m_hAttachedToEntity[0x4]; // 0x788            
            // metadata: MNetworkEnable
            source2sdk::modellib::AttachmentHandle_t m_nAttachment; // 0x78c            
            uint8_t _pad078d[0x3]; // 0x78d
            // metadata: MNetworkEnable
            ...
            source2sdk::entity2::GameTime_t m_flDieTime; // 0x798            
            uint8_t _pad079c[0xc]; // 0x79c
            // metadata: MNetworkEnable
            std::uint32_t m_nBrightness; // 0x7a8            
            // metadata: MNetworkEnable
            ...
            source2sdk::entity2::GameTime_t m_flLastTime; // 0x7c4            
            float m_flMaxFrame; // 0x7c8            
            float m_flStartScale; // 0x7cc            
            float m_flDestScale; // 0x7d0            
            source2sdk::entity2::GameTime_t m_flScaleTimeStart; // 0x7d4            
            std::int32_t m_nStartBrightness; // 0x7d8            
            std::int32_t m_nDestBrightness; // 0x7dc            
            source2sdk::entity2::GameTime_t m_flBrightnessTimeStart; // 0x7e0            
            // metadata: MNotSaved
            std::int32_t m_nSpriteWidth; // 0x7e4            
            // metadata: MNotSaved
            std::int32_t m_nSpriteHeight; // 0x7e8            
        ...
        static_assert(sizeof(source2sdk::server::CSprite) == 0x7f0);
    };
};
