...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Familiar_CloneVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
        ...
        // Cannot assert offsets of fields in CCitadel_Ability_Familiar_CloneVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Familiar_CloneVData) == 0x1908);
    };
};
