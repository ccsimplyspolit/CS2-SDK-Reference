...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Werewolf_KickFlipVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_SuccessSelfModifier;
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_SuccessEnemyModifier;
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Werewolf_KickFlipVData) == 0x1b98);
    };
};
