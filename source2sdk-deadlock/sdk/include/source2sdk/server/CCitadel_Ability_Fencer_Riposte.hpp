...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            uint8_t _pad0f98[0x880]; // 0xf98
            // m_vecHitEnemies has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CUtlVector<CHandle<source2sdk::server::CBaseEntity>> m_vecHitEnemies;
            char m_vecHitEnemies[0x18]; // 0x1818
            Vector m_vecLastPosition; // 0x1830
            source2sdk::entity2::GameTime_t m_flStuckTime; // 0x183c
            source2sdk::client::ParticleIndex_t m_nParriedFXIndex; // 0x1840
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Fencer_Riposte) == 0x1848);
    };
};
