...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            bool m_bCanProcFromItems; // 0x754
            uint8_t _pad0755[0x3]; // 0x755
            source2sdk::client::CITADEL_UNIT_TARGET_TYPE m_nAbilityTargetTypes; // 0x758
            source2sdk::client::CITADEL_UNIT_TARGET_FLAGS m_nAbilityTargetFlags; // 0x75c
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_BaseEventProcVData) == 0x780);
    };
};
