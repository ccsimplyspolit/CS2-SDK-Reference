...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::PlayOfTheGameTrigger_t, m_tTriggerTime) == 0x30);
        static_assert(offsetof(source2sdk::server::PlayOfTheGameTrigger_t, m_eType) == 0x34);
        static_assert(offsetof(source2sdk::server::PlayOfTheGameTrigger_t, m_nTarget) == 0x38);
        
        static_assert(sizeof(source2sdk::server::PlayOfTheGameTrigger_t) == 0x40);
    };
};
