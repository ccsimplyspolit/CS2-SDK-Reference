...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_ProgressModifier[0x10]; // 0x760            
            ...
            char m_FlameDashParticle[0xe0]; // 0x770            
            ...
            char m_FlameAuraParticle[0xe0]; // 0x850            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_FlameDashVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_FlameDashVData) == 0x930);
    };
};
