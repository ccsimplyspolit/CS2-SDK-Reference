...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_ProcModifier[0x10]; // 0x790            
            ...
            char m_BuildupSuccessEffect[0xe0]; // 0x7a0            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_TechOverflowProcWatcherVData) == 0x880);
    };
};
