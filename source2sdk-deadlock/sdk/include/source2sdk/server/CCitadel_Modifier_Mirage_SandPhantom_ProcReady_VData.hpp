...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_ProcReadyParticle[0xe0]; // 0x750            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strProcReadySound; // 0x830            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_Mirage_SandPhantom_ProcReady_VData) == 0x840);
    };
};
