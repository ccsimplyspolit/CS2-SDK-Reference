...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Necro_GraveStoneVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_GraveStoneModifier;
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_ZombieSummonModifier;
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Necro_GraveStoneVData) == 0x1a40);
    };
};
