...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::server::ice_path_shard_model_desc_t m_icePathModelDesc; // 0x0            
            ...
            source2sdk::server::ice_path_shard_model_desc_t m_icePathSurfModelDesc; // 0x40            
        ...
        static_assert(offsetof(source2sdk::server::CIcePathShardGenerator, m_icePathModelDesc) == 0x0);
        static_assert(offsetof(source2sdk::server::CIcePathShardGenerator, m_hBaseModel) == 0x38);
        static_assert(offsetof(source2sdk::server::CIcePathShardGenerator, m_icePathSurfModelDesc) == 0x40);
        static_assert(offsetof(source2sdk::server::CIcePathShardGenerator, m_hSurfModel) == 0x78);
        static_assert(offsetof(source2sdk::server::CIcePathShardGenerator, m_flRadius) == 0x80);
        static_assert(offsetof(source2sdk::server::CIcePathShardGenerator, m_vecPreviousShard) == 0x88);
        static_assert(offsetof(source2sdk::server::CIcePathShardGenerator, m_vecPreviousShardOrigin) == 0xa0);
        static_assert(offsetof(source2sdk::server::CIcePathShardGenerator, m_vecPreviousPreviousShardOrigin) == 0xac);
        static_assert(offsetof(source2sdk::server::CIcePathShardGenerator, m_vecUnitCirclePoints) == 0xb8);
        static_assert(offsetof(source2sdk::server::CIcePathShardGenerator, m_vPrevFrontEdgeVerts) == 0xd0);
        
        static_assert(sizeof(source2sdk::server::CIcePathShardGenerator) == 0xe8);
    };
};
