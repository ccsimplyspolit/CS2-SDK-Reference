...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float m_flPercentageMultiplierStart; // 0x750            
            float m_flPercentageMultiplierEnd; // 0x754            
            float m_flRampUpTime; // 0x758            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_ZiplineSpeedVData) == 0x760);
    };
};
