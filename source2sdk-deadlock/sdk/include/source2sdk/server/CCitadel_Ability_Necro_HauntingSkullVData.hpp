...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Necro_HauntingSkullVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_SummonBuffModifier;
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Necro_HauntingSkullVData) == 0x20b8);
    };
};
