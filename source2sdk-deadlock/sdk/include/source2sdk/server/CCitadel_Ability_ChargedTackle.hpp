...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            bool m_bPreparing; // 0x13f0            
            // metadata: MNetworkEnable
            bool m_bTackling; // 0x13f1            
            uint8_t _pad13f2[0x2]; // 0x13f2
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flTackleStartTime; // 0x13f4            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flPrepareStartTime; // 0x13f8            
            // metadata: MNetworkEnable
            Vector m_vecTackleDir; // 0x13fc            
            Vector m_vecLastPosition; // 0x1408            
            std::int32_t m_nStuckFramesCount; // 0x1414            
            // m_vecHitEnemies has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CUtlVector<CHandle<source2sdk::server::CBaseEntity>> m_vecHitEnemies;
            char m_vecHitEnemies[0x18]; // 0x1418            
            source2sdk::client::ParticleIndex_t m_nDistancePreview; // 0x1430            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_ChargedTackle) == 0x1438);
    };
};
