...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_Werewolf_Kickflip_SucessSelfVData : public source2sdk::server::CCitadelModifierVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_Werewolf_Kickflip_SucessSelfVData) == 0x7d0);
    };
};
