...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_DisarmProcModifier[0x10]; // 0x790            
            ...
            char m_ImmunityModifier[0x10]; // 0x7a0            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_DisarmProcWatcherVData) == 0x890);
    };
};
