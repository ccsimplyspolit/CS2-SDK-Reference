...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float m_MaxWeight; // 0x8e0            
            // metadata: MNetworkEnable
            float m_FadeDuration; // 0x8e4            
            // metadata: MNetworkEnable
            float m_Weight; // 0x8e8            
            // metadata: MNetworkEnable
            char m_lookupFilename[512]; // 0x8ec            
            float m_LastEnterWeight; // 0xaec            
            source2sdk::entity2::GameTime_t m_LastEnterTime; // 0xaf0            
            float m_LastExitWeight; // 0xaf4            
            source2sdk::entity2::GameTime_t m_LastExitTime; // 0xaf8            
        ...
        static_assert(sizeof(source2sdk::server::CColorCorrectionVolume) == 0xb00);
    };
};
