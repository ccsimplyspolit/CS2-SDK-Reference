...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_EarnedParticle[0xe0]; // 0x18b8            
            ...
            char m_GoldModifier[0x10]; // 0x1998            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strEarnedSound; // 0x19a8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Item_TrophyCollectorVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Item_TrophyCollectorVData) == 0x19b8);
    };
};
