...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifierAura> m_GroundAuraModifier;
        ...
        static_assert(sizeof(source2sdk::server::CModifierTier3BossLaserBeamVData) == 0xce8);
    };
};
