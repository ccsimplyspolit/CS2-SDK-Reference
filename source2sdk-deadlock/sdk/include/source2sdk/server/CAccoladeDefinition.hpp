...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::CAccoladeDefinition, m_sDescription) == 0x30);
        static_assert(offsetof(source2sdk::server::CAccoladeDefinition, m_eThresholdType) == 0x40);
        static_assert(offsetof(source2sdk::server::CAccoladeDefinition, m_vecThresholds) == 0x48);
        static_assert(offsetof(source2sdk::server::CAccoladeDefinition, m_vecEnabledGameModes) == 0x60);
        
        static_assert(sizeof(source2sdk::server::CAccoladeDefinition) == 0x78);
    };
};
