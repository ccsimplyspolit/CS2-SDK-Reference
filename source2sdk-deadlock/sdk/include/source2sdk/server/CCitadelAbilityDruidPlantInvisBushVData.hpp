...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadelAbilityDruidPlantInvisBushVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_InvisAreaModifier;
        ...
        static_assert(sizeof(source2sdk::server::CCitadelAbilityDruidPlantInvisBushVData) == 0x1908);
    };
};
