...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_CastCompleteParticle[0xe0]; // 0x18b8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strBuffGainedSound; // 0x1998            
            ...
            char m_InvisModifier[0x10]; // 0x19a8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_UtilityUpgrade_AOESmokeBombVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_UtilityUpgrade_AOESmokeBombVData) == 0x19b8);
    };
};
