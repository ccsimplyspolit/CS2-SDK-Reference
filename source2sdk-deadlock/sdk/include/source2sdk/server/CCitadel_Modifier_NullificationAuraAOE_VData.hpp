...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_NullificationAuraAOE_VData : public source2sdk::server::CCitadelModifierVData
        {
        public:
            ...
            char m_TargetModifier[0x10]; // 0x750            
            ...
            char m_PurgeCastParticle[0xe0]; // 0x760            
            CSoundEventName m_PurgeSound; // 0x840            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_NullificationAuraAOE_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_NullificationAuraAOE_VData) == 0x850);
    };
};
