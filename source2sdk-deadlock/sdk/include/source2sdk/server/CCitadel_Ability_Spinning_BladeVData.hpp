...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_CatchIndicator[0xe0]; // 0x1828            
            ...
            char m_CatchParticle[0xe0]; // 0x1908            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strThrowSound; // 0x19e8            
            CSoundEventName m_strReturnSound; // 0x19f8            
            CSoundEventName m_strCatchSound; // 0x1a08            
            CSoundEventName m_strFailSound; // 0x1a18            
            CSoundEventName m_strHitSound; // 0x1a28            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Spinning_BladeVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Spinning_BladeVData) == 0x1a38);
    };
};
