...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_T2Boss_Stagger_WatcherVData : public source2sdk::server::CCitadelModifierVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_StaggeredModifier;
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_T2Boss_Stagger_WatcherVData) == 0x780);
    };
};
