...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int8_t m_nDeathReplayAvailable; // 0xd08
            // metadata: MNetworkEnable
            source2sdk::client::CitadelLobbyPlayerSlot_t m_unLobbyPlayerSlot; // 0xd09
            uint8_t _pad0d0a[0x2]; // 0xd0a
            source2sdk::entity2::GameTime_t m_flLastCommsTime; // 0xd0c
            source2sdk::entity2::GameTime_t m_flNextAllowedCommsTime; // 0xd10
            source2sdk::entity2::GameTime_t m_flLastFailedCommsTime; // 0xd14
            ...
            char m_vecRecentCommAttempts[0x18]; // 0xd18
            std::int32_t m_nTotalCommsAttempted; // 0xd30
            std::int32_t m_nGuideBotNumTasksComplete; // 0xd34
        ...
        static_assert(sizeof(source2sdk::server::CCitadelPlayerController) == 0xd38);
    };
};
