...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraDemonCarbineShotFired; // 0x1840            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Gunslinger_DemonCarbineVData) == 0x18c8);
    };
};
