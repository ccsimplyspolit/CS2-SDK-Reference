...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_MysticalPianoVData : public source2sdk::server::CCitadelModifierAuraVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_DazeModifier;
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_MysticalPianoVData) == 0x8a8);
    };
};
