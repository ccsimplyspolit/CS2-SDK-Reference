...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::entity2::CEntityIOOutput m_OnPlayerInZone; // 0x788            
            source2sdk::entity2::CEntityIOOutput m_OnPlayerOutZone; // 0x7a0            
            ...
            char m_PlayersInCount[0x20]; // 0x7b8            
            ...
            char m_PlayersOutCount[0x20]; // 0x7d8            
        ...
        static_assert(sizeof(source2sdk::server::CGamePlayerZone) == 0x7f8);
    };
};
