...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_Necro_SpawnZombies_AreaVData : public source2sdk::server::CCitadelModifierVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_SummonDecayModifier;
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_SpawningInModifier;
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_Necro_SpawnZombies_AreaVData) == 0x880);
    };
};
