...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // CUtlVector<source2sdk::server::CModifierHandleBase> m_ModifierHandles;
            char m_ModifierHandles[0x18]; // 0x0            
        };
        #pragma pack(pop)
        
        static_assert(offsetof(source2sdk::server::CBaseAnimGraph_ModifierHandleVector_t, m_ModifierHandles) == 0x0);
        
        static_assert(sizeof(source2sdk::server::CBaseAnimGraph_ModifierHandleVector_t) == 0x18);
    };
};
