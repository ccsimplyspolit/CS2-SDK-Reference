...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Pickup_Modifier_VData : public source2sdk::server::CCitadel_Pickup_VData
        {
        public:
