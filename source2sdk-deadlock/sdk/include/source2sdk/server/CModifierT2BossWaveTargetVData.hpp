...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CModifierT2BossWaveTargetVData : public source2sdk::server::CCitadelModifierVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CModifierT2BossWaveTargetVData) == 0x7b0);
    };
};
