...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CModifierTier3BossLaserBeamAuraVData : public source2sdk::server::CCitadelModifierAuraVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CModifierTier3BossLaserBeamAuraVData) == 0x968);
    };
};
