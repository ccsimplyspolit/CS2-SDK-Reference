...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Unicorn_RadiantBlastVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Unicorn_RadiantBlastVData) == 0x1a18);
    };
};
