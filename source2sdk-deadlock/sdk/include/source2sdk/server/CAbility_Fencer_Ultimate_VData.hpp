...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CAbility_Fencer_Ultimate_VData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_CasterArrivalModifier;
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_TargetNonHeroModifier;
        ...
        static_assert(sizeof(source2sdk::server::CAbility_Fencer_Ultimate_VData) == 0x1dc0);
    };
};
