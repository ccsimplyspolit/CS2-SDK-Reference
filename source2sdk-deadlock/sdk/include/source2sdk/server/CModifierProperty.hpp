...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            uint8_t _pad0050[0x175]; // 0x50
            // metadata: MNotSaved
            bool m_bModifierStatesDirty; // 0x1c5
            // metadata: MNotSaved
            bool m_bPredictedOwner; // 0x1c6
            // metadata: MNetworkEnable
            bool m_bAllowModifiersOnDeadEntities; // 0x1c7
            // metadata: MNotSaved
            std::int8_t m_iLockRefCount; // 0x1c8
            uint8_t _pad01c9[0x1]; // 0x1c9
            // metadata: MNotSaved
            source2sdk::client::ModifierPropRuntimeHandle_t m_hHandle; // 0x1ca
            // metadata: MNotSaved
        ...
        static_assert(offsetof(source2sdk::server::CModifierProperty, m_bModifierStatesDirty) == 0x1c5);
        static_assert(offsetof(source2sdk::server::CModifierProperty, m_bPredictedOwner) == 0x1c6);
        static_assert(offsetof(source2sdk::server::CModifierProperty, m_bAllowModifiersOnDeadEntities) == 0x1c7);
        static_assert(offsetof(source2sdk::server::CModifierProperty, m_iLockRefCount) == 0x1c8);
        static_assert(offsetof(source2sdk::server::CModifierProperty, m_hHandle) == 0x1ca);
