...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Familiar_Ability01VData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_StaringModifier;
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Familiar_Ability01VData) == 0x1fe8);
    };
};
