...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_DebuffReducedParticle[0xe0]; // 0x18b8            
            ...
            char m_PurgeCastParticle[0xe0]; // 0x1998            
            ...
            char m_MoveSpeedModifier[0x10]; // 0x1a78            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_ArmorUpgrade_DebuffReducerVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_ArmorUpgrade_DebuffReducerVData) == 0x1a88);
    };
};
