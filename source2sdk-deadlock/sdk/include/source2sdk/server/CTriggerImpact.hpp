...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float m_flMagnitude; // 0x8f8            
            float m_flNoise; // 0x8fc            
            float m_flViewkick; // 0x900            
            ...
            char m_pOutputForce[0x28]; // 0x908            
        ...
        static_assert(sizeof(source2sdk::server::CTriggerImpact) == 0x930);
    };
};
