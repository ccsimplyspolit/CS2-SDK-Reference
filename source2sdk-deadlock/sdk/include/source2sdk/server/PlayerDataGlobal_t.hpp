...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_nPreGameHeroID) == 0x20);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_unHeroBadgeXP) == 0x24);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_iGoldNetWorth) == 0x28);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_iAPNetWorth) == 0x2c);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_iCreepGold) == 0x30);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_iCreepGoldSoloBonus) == 0x34);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_iCreepGoldKill) == 0x38);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_iCreepGoldAirOrb) == 0x3c);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_iCreepGoldGroundOrb) == 0x40);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_iCreepGoldDeny) == 0x44);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_iCreepGoldNeutral) == 0x48);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_iFarmBaseline) == 0x4c);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_iHealth) == 0x50);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_iPlayerKills) == 0x54);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_iPlayerAssists) == 0x58);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_iDeaths) == 0x5c);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_iDenies) == 0x60);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_iLastHits) == 0x64);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_iKillStreak) == 0x68);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_bAlive) == 0x6c);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_nHeroDraftPosition) == 0x70);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_bUltimateTrained) == 0x74);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_flUltimateCooldownStart) == 0x78);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_flUltimateCooldownEnd) == 0x7c);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_bHasRejuvenator) == 0x80);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_bHasRebirth) == 0x81);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_bFlaggedAsCheater) == 0x82);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_bAbandon) == 0x83);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_iHeroDamage) == 0x84);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_iHeroHealing) == 0x88);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_iSelfHealing) == 0x8c);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_iObjectiveDamage) == 0x90);
        ...
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_vecAbilityUpgradeState) == 0x2b8);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_strIconHeroCardOverride) == 0x320);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_strIconHeroCardCriticalOverride) == 0x328);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_strIconHeroCardGloatOverride) == 0x330);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_unPackedRank) == 0x338);

        static_assert(sizeof(source2sdk::server::PlayerDataGlobal_t) == 0x340);
    };
};
