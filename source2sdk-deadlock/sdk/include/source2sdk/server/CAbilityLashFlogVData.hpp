...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_FlogParticle[0xe0]; // 0x1818            
            // metadata: MPropertyGroupName "Visuals"
            ...
            char m_FlogLifeLeachParticle[0xe0]; // 0x18f8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strHitConfirmSound; // 0x19d8            
            ...
            char m_FlogDebuffModifier[0x10]; // 0x19e8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityLashFlogVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CAbilityLashFlogVData) == 0x19f8);
    };
};
