...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_LaunchTossModifier;
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Familiar_AttachVData) == 0x1b18);
    };
};
