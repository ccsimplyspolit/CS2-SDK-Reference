...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            CSoundEventName m_StackSound; // 0x18c8            
            CSoundEventName m_AmmoSound; // 0x18d8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Upgrade_AmmoScavenger_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Upgrade_AmmoScavenger_VData) == 0x18e8);
    };
};
