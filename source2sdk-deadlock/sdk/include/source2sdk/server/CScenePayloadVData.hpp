...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::CScenePayloadVData, m_eNPCBehavior) == 0x0);
        static_assert(offsetof(source2sdk::server::CScenePayloadVData, m_sSceneFile) == 0x8);
        
        static_assert(sizeof(source2sdk::server::CScenePayloadVData) == 0xe8);
    };
};
