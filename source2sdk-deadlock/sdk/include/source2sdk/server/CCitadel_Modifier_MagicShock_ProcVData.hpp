...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_ProcParticle[0xe0]; // 0x780            
            ...
            char m_hDamageTrackModifier[0x10]; // 0x860            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_MagicShock_ProcVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_MagicShock_ProcVData) == 0x870);
    };
};
