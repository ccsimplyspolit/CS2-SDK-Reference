...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_CastOtherParticle[0xe0]; // 0x1818            
            ...
            char m_ArmorModifier[0x10]; // 0x18f8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Protection_RacketVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Protection_RacketVData) == 0x1908);
    };
};
