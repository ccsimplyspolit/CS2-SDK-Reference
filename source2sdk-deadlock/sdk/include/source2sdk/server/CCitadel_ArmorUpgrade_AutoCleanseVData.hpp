...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_ArmorUpgrade_AutoCleanseVData : public source2sdk::server::CitadelItemVData
        {
        public:
            // metadata: MPropertyGroupName "Sounds"
            CSoundEventName m_strPurgeSound; // 0x18b8            
            ...
            char m_PurgeCastParticle[0xe0]; // 0x18c8            
            ...
            char m_BarrierModifier[0x10]; // 0x19a8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_ArmorUpgrade_AutoCleanseVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_ArmorUpgrade_AutoCleanseVData) == 0x19b8);
    };
};
