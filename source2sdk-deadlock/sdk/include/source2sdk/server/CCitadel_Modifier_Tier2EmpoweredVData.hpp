...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float m_flTransitionDuration; // 0x750            
            std::int32_t m_nMaxHealth; // 0x754            
            float m_flModelScale; // 0x758            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_Tier2EmpoweredVData) == 0x760);
    };
};
