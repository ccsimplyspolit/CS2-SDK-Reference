...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CAbility_Fencer_Lunge_VData : public source2sdk::server::CitadelAbilityVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_DashBuffModifier;
        ...
        static_assert(sizeof(source2sdk::server::CAbility_Fencer_Lunge_VData) == 0x20e8);
    };
};
