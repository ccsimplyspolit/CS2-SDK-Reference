...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_HauntDamageModifier[0x10]; // 0x780            
            ...
            CSoundEventName m_ExplodeSound; // 0x7a0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_HauntWatcherVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_HauntWatcherVData) == 0x7b0);
    };
};
