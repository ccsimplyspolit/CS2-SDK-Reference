...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float m_flFrameRate; // 0x780            
            // metadata: MNetworkEnable
            float m_flHDRColorScale; // 0x784            
            source2sdk::entity2::GameTime_t m_flFireTime; // 0x788            
            float m_flDamage; // 0x78c            
            // metadata: MNetworkEnable
            std::uint8_t m_nNumBeamEnts; // 0x790            
            ...
            char m_hBaseMaterial[0x8]; // 0x798            
            // metadata: MNetworkEnable
            ...
            char m_nHaloIndex[0x8]; // 0x7a0            
            // metadata: MNetworkEnable
            source2sdk::client::BeamType_t m_nBeamType; // 0x7a8            
            // metadata: MNetworkEnable
            std::uint32_t m_nBeamFlags; // 0x7ac            
            // metadata: MNetworkEnable
            ...
            char m_hAttachEntity[0x28]; // 0x7b0            
            // metadata: MNetworkEnable
            source2sdk::modellib::AttachmentHandle_t m_nAttachIndex[10]; // 0x7d8            
            ...
            // metadata: MNetworkEncodeFlags "2"
            float m_fWidth; // 0x7e4            
            // metadata: MNetworkEnable
            // metadata: MNetworkBitCount "10"
            // metadata: MNetworkMinValue "0,000000"
            // metadata: MNetworkMaxValue "102,300003"
            // metadata: MNetworkEncodeFlags "2"
            float m_fEndWidth; // 0x7e8            
            // metadata: MNetworkEnable
            float m_fFadeLength; // 0x7ec            
            // metadata: MNetworkEnable
            float m_fHaloScale; // 0x7f0            
            // metadata: MNetworkEnable
            // metadata: MNetworkBitCount "8"
            // metadata: MNetworkMinValue "0,000000"
            // metadata: MNetworkMaxValue "64,000000"
            // metadata: MNetworkEncodeFlags "1"
            float m_fAmplitude; // 0x7f4            
            // metadata: MNetworkEnable
            // metadata: MNetworkBitCount "8"
            // metadata: MNetworkMinValue "0,000000"
            // metadata: MNetworkMaxValue "256,000000"
            // metadata: MNetworkEncodeFlags "1"
            float m_fStartFrame; // 0x7f8            
            // metadata: MNetworkEnable
            // metadata: MNetworkBitCount "8"
            // metadata: MNetworkMinValue "0,000000"
            // metadata: MNetworkMaxValue "100,000000"
            float m_fSpeed; // 0x7fc            
            // metadata: MNetworkEnable
            ...
            float m_flFrame; // 0x800            
            // metadata: MNetworkEnable
            source2sdk::client::BeamClipStyle_t m_nClipStyle; // 0x804            
            // metadata: MNetworkEnable
            bool m_bTurnedOff; // 0x808            
            uint8_t _pad0809[0x3]; // 0x809
            // metadata: MNetworkEnable
            // metadata: MNetworkEncoder "coord"
            VectorWS m_vecEndPos; // 0x80c            
            ...
            char m_hEndEntity[0x4]; // 0x818            
            std::int32_t m_nDissolveType; // 0x81c            
        ...
        static_assert(sizeof(source2sdk::server::CBeam) == 0x820);
    };
};
