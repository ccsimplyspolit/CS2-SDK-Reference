...
#include "source2sdk/server/ItemDraftOption_t.hpp"
...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // CUtlVectorEmbeddedNetworkVar<source2sdk::server::ItemDraftOption_t> m_vecOptions;
        ...
        static_assert(offsetof(source2sdk::server::ItemDraftRoundState_t, m_vecOptions) == 0x8);
        static_assert(offsetof(source2sdk::server::ItemDraftRoundState_t, m_nID) == 0x70);
        static_assert(offsetof(source2sdk::server::ItemDraftRoundState_t, m_nDraftsRemaining) == 0x74);
        static_assert(offsetof(source2sdk::server::ItemDraftRoundState_t, m_nDraftsTotal) == 0x78);
        static_assert(offsetof(source2sdk::server::ItemDraftRoundState_t, m_nRoundsRemaining) == 0x7c);
        static_assert(offsetof(source2sdk::server::ItemDraftRoundState_t, m_nRoundsTotal) == 0x80);
        static_assert(offsetof(source2sdk::server::ItemDraftRoundState_t, m_flCompletedTime) == 0x84);
        
        static_assert(sizeof(source2sdk::server::ItemDraftRoundState_t) == 0x88);
    };
};
