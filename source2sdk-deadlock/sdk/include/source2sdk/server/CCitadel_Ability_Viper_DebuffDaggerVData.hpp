...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            CSoundEventName m_strWorldImpactSound; // 0x18f8            
            ...
            char m_SlowModifier[0x10]; // 0x1918            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Viper_DebuffDaggerVData) == 0x1938);
    };
};
