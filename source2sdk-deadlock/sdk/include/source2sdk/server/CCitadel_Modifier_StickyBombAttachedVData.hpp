...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_OnGroundModifier;
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_StickyBombAttachedVData) == 0xb18);
    };
};
