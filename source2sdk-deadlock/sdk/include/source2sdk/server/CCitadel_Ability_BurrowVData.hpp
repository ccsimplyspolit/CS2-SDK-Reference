...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_BurrowStartParticle[0xe0]; // 0x18f8            
            ...
            char m_BurrowEndParticle[0xe0]; // 0x19d8            
            ...
            char m_BurrowInGroundParticle[0xe0]; // 0x1ab8            
            ...
            char m_BurrowModifier[0x10]; // 0x1b98            
            ...
            char m_SpinModifier[0x10]; // 0x1ba8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strBurrowEndSound; // 0x1bb8            
            // metadata: MPropertyStartGroup "+Burrow Properties"
            float m_flChannelEndEnemyPopUpForce; // 0x1bc8            
            float m_flChannelEndEnemyPopUpCylinderHeight; // 0x1bcc            
            // metadata: MPropertyDescription "Spin Camera Controller that matches the modifier for client"
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSpinStart; // 0x1bd0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_BurrowVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_BurrowVData) == 0x1c58);
    };
};
