...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Item_ShadowStrikeVData : public source2sdk::server::CitadelItemVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_ShadowStrikeInvisModifier;
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Item_ShadowStrikeVData) == 0x18d8);
    };
};
