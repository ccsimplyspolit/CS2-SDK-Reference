...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t m_nImportance; // 0x4a8            
            std::int32_t m_nLightChoice; // 0x4ac            
        ...
        static_assert(sizeof(source2sdk::server::CInfoDynamicShadowHint) == 0x4b8);
    };
};
