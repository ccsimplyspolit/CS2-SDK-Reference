...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_LaunchParticle[0xe0]; // 0x18b8            
            ...
            char m_InAirWatcherModifier[0x10]; // 0x1998            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flMinHeadClearance; // 0x19a8            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_UtilityUpgrade_RocketBootsVData) == 0x19b0);
    };
};
