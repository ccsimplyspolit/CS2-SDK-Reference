...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_OutOfCombatSprintCamera;
        ...
        static_assert(sizeof(source2sdk::server::CAbility_Drifter_Darkness_VData) == 0x1a28);
    };
};
