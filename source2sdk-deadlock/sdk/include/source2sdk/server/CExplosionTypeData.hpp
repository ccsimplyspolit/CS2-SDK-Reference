...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::CExplosionTypeData, m_SoundName) == 0x0);
        static_assert(offsetof(source2sdk::server::CExplosionTypeData, m_ParticleEffect) == 0x10);
        static_assert(offsetof(source2sdk::server::CExplosionTypeData, m_bIsIncindiary) == 0xf0);
        static_assert(offsetof(source2sdk::server::CExplosionTypeData, m_bHasForces) == 0xf1);
        static_assert(offsetof(source2sdk::server::CExplosionTypeData, m_DecalType) == 0xf8);
        
        static_assert(sizeof(source2sdk::server::CExplosionTypeData) == 0x100);
    };
};
