...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_WerewolfVData : public source2sdk::server::CCitadelModifierVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_StackingBuffModifier;
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_WerewolfVData) == 0x988);
    };
};
