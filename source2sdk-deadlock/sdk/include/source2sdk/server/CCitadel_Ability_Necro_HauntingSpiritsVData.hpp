...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Ability_Necro_HauntingSpiritsVData : public source2sdk::server::CitadelAbilityVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Necro_HauntingSpiritsVData) == 0x1a08);
    };
};
