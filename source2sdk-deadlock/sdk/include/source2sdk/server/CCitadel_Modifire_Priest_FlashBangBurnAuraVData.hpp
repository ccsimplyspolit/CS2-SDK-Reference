...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifire_Priest_FlashBangBurnAuraVData : public source2sdk::server::CCitadelModifierAuraVData
        {
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_BurnModifier;
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifire_Priest_FlashBangBurnAuraVData) == 0x898);
    };
};
