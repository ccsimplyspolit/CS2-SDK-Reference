...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CModifierT3BossWaveTargetVData : public source2sdk::server::CCitadelModifierVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CModifierT3BossWaveTargetVData) == 0x780);
    };
};
