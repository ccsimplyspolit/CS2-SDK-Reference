...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadelModifierTier2BossLaserBeamVData : public source2sdk::server::CCitadelModifierVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadelModifierTier2BossLaserBeamVData) == 0x958);
    };
};
