...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_FriendlyImpactModifier;
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Viscous_TelepunchVData) == 0x1cf0);
    };
};
