...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::entity2::CEntityIOOutput m_OnStartTouch; // 0x800            
            source2sdk::entity2::CEntityIOOutput m_OnStartTouchAll; // 0x818            
            source2sdk::entity2::CEntityIOOutput m_OnEndTouch; // 0x830            
            source2sdk::entity2::CEntityIOOutput m_OnEndTouchAll; // 0x848            
            source2sdk::entity2::CEntityIOOutput m_OnTouching; // 0x860            
            source2sdk::entity2::CEntityIOOutput m_OnTouchingEachEntity; // 0x878            
            source2sdk::entity2::CEntityIOOutput m_OnNotTouching; // 0x890            
            ...
            char m_hTouchingEntities[0x18]; // 0x8a8            
            ...
            bool m_bDisabled; // 0x8cc            
            uint8_t _pad08cd[0xb]; // 0x8cd
            bool m_bUseAsyncQueries; // 0x8d8            
        ...
        static_assert(sizeof(source2sdk::server::CBaseTrigger) == 0x8e0);
    };
};
