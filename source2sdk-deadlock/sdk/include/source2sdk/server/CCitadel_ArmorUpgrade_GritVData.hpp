...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_ArmorUpgrade_GritVData : public source2sdk::server::CitadelItemVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_ArmorUpgrade_GritVData) == 0x18c8);
    };
};
