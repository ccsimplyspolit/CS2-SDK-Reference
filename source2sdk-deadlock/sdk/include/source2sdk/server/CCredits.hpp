...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::entity2::CEntityIOOutput m_OnCreditsDone; // 0x4a0            
            bool m_bRolledOutroCredits; // 0x4b8            
            uint8_t _pad04b9[0x3]; // 0x4b9
            float m_flLogoLength; // 0x4bc            
        ...
        static_assert(sizeof(source2sdk::server::CCredits) == 0x4c0);
    };
};
