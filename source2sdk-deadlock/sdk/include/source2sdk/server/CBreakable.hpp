...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::server::CPropDataComponent m_CPropDataComponent; // 0x788            
            source2sdk::server::Materials m_Material; // 0x7c8            
            ...
            char m_hBreaker[0x4]; // 0x7cc            
            source2sdk::server::Explosions m_Explosion; // 0x7d0            
            uint8_t _pad07d4[0x4]; // 0x7d4
            CUtlSymbolLarge m_iszSpawnObject; // 0x7d8            
            float m_flPressureDelay; // 0x7e0            
            std::int32_t m_iMinHealthDmg; // 0x7e4            
            CUtlSymbolLarge m_iszPropData; // 0x7e8            
            float m_impactEnergyScale; // 0x7f0            
            source2sdk::server::EOverrideBlockLOS_t m_nOverrideBlockLOS; // 0x7f4            
            source2sdk::entity2::CEntityIOOutput m_OnStartDeath; // 0x7f8            
            source2sdk::entity2::CEntityIOOutput m_OnBreak; // 0x810            
            // m_OnHealthChanged has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CEntityOutputTemplate<float> m_OnHealthChanged;
            char m_OnHealthChanged[0x20]; // 0x828            
            source2sdk::client::PerformanceMode_t m_PerformanceMode; // 0x848            
            // m_hPhysicsAttacker has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::server::CBasePlayerPawn> m_hPhysicsAttacker;
            char m_hPhysicsAttacker[0x4]; // 0x84c            
            source2sdk::entity2::GameTime_t m_flLastPhysicsInfluenceTime; // 0x850            
        ...
        static_assert(sizeof(source2sdk::server::CBreakable) == 0x858);
    };
};
