...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // m_TargetLifestealModifier has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_TargetLifestealModifier;
            char m_TargetLifestealModifier[0x10]; // 0x1b08
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flAirSpeedMax; // 0x1b18
            float m_flAirDrag; // 0x1b1c
            float m_flFallSpeedMax; // 0x1b20
            float m_flParryMoveSpeed; // 0x1b24
            float m_flDashAnimDelay; // 0x1b28
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Fencer_RiposteVData) == 0x1b30);
    };
};
