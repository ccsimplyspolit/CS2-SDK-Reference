...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float m_flMagnitude; // 0x900            
            float m_flNoise; // 0x904            
            float m_flViewkick; // 0x908            
            ...
            char m_pOutputForce[0x28]; // 0x910            
        ...
        static_assert(sizeof(source2sdk::server::CTriggerImpact) == 0x938);
    };
};
