...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hPositionKeys[0x8]; // 0x778            
            ...
            char m_hRotationKeys[0x8]; // 0x780            
            Vector m_vAnimationBoundsMin; // 0x788            
            Vector m_vAnimationBoundsMax; // 0x794            
            // metadata: MNotSaved
            float m_flStartTime; // 0x7a0            
            float m_flStartFrame; // 0x7a4            
        ...
        static_assert(sizeof(source2sdk::server::CTextureBasedAnimatable) == 0x7a8);
    };
};
