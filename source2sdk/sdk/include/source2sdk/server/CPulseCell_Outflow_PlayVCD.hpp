...
#include "source2sdk/server/CPulseCell_Outflow_PlayVCDBase.hpp"
...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CPulseCell_Outflow_PlayVCD : public source2sdk::server::CPulseCell_Outflow_PlayVCDBase
        {
        public:
            ...
            char m_hChoreoScene[0x8]; // 0x138            
            source2sdk::pulse_runtime_lib::CPulse_OutflowConnection m_OnPaused; // 0x140            
            source2sdk::pulse_runtime_lib::CPulse_OutflowConnection m_OnResumed; // 0x188            
            ...
            char m_OutRequirements[0x18]; // 0x1d0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CPulseCell_Outflow_PlayVCD because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CPulseCell_Outflow_PlayVCD) == 0x1e8);
    };
};
