...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hSoundscape[0x4]; // 0x8e8            
            uint8_t _pad08ec[0x4]; // 0x8ec
            CUtlSymbolLarge m_SoundscapeName; // 0x8f0            
