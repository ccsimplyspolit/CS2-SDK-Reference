...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            CUtlString m_strStartTouchEventName; // 0x8e8            
            CUtlString m_strEndTouchEventName; // 0x8f0            
            CUtlString m_strTriggerID; // 0x8f8            
        ...
        static_assert(sizeof(source2sdk::server::CTriggerGameEvent) == 0x900);
    };
};
