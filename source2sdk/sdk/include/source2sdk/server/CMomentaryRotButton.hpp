...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_Position[0x20]; // 0x8f0            
            source2sdk::entity2::CEntityIOOutput m_OnUnpressed; // 0x910            
            source2sdk::entity2::CEntityIOOutput m_OnFullyOpen; // 0x928            
            source2sdk::entity2::CEntityIOOutput m_OnFullyClosed; // 0x940            
            source2sdk::entity2::CEntityIOOutput m_OnReachedPosition; // 0x958            
            std::int32_t m_lastUsed; // 0x970            
            QAngle m_start; // 0x974            
            QAngle m_end; // 0x980            
            float m_IdealYaw; // 0x98c            
            CUtlSymbolLarge m_sNoise; // 0x990            
            bool m_bUpdateTarget; // 0x998            
            uint8_t _pad0999[0x3]; // 0x999
            std::int32_t m_direction; // 0x99c            
            float m_returnSpeed; // 0x9a0            
            float m_flStartPosition; // 0x9a4            
        ...
        static_assert(sizeof(source2sdk::server::CMomentaryRotButton) == 0x9a8);
    };
};
