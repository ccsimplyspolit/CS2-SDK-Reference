...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            bool m_bPlayerFireOnly; // 0x8e8            
            uint8_t _pad08e9[0x7]; // 0x8e9
            source2sdk::entity2::CEntityIOOutput m_OnDetectedBulletFire; // 0x8f0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CTriggerDetectBulletFire because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CTriggerDetectBulletFire) == 0x908);
    };
};
