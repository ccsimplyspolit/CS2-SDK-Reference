...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_vecCornerPairsNetworked[0x60]; // 0x5a8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CSoundEventPathCornerEntity because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CSoundEventPathCornerEntity) == 0x608);
    };
};
