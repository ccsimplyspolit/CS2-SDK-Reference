...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            CGameSoundEventName m_NoiseMoving; // 0x7f0            
            CGameSoundEventName m_NoiseArrived; // 0x7f8            
            uint8_t _pad0800[0x8]; // 0x800
            float m_volume; // 0x808            
            float m_flTWidth; // 0x80c            
            float m_flTLength; // 0x810            
        ...
        static_assert(sizeof(source2sdk::server::CBasePlatTrain) == 0x818);
    };
};
