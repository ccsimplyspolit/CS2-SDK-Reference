...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::server::CPropDataComponent m_CPropDataComponent; // 0x778            
            source2sdk::server::Materials m_Material; // 0x7b8            
            ...
            char m_hBreaker[0x4]; // 0x7bc            
            source2sdk::server::Explosions m_Explosion; // 0x7c0            
            uint8_t _pad07c4[0x4]; // 0x7c4
            CUtlSymbolLarge m_iszSpawnObject; // 0x7c8            
            float m_flPressureDelay; // 0x7d0            
            std::int32_t m_iMinHealthDmg; // 0x7d4            
            CUtlSymbolLarge m_iszPropData; // 0x7d8            
            float m_impactEnergyScale; // 0x7e0            
            source2sdk::server::EOverrideBlockLOS_t m_nOverrideBlockLOS; // 0x7e4            
            source2sdk::entity2::CEntityIOOutput m_OnStartDeath; // 0x7e8            
            source2sdk::entity2::CEntityIOOutput m_OnBreak; // 0x800            
            // m_OnHealthChanged has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CEntityOutputTemplate<float> m_OnHealthChanged;
            char m_OnHealthChanged[0x20]; // 0x818            
            source2sdk::client::PerformanceMode_t m_PerformanceMode; // 0x838            
            // m_hPhysicsAttacker has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::server::CBasePlayerPawn> m_hPhysicsAttacker;
            char m_hPhysicsAttacker[0x4]; // 0x83c            
            source2sdk::entity2::GameTime_t m_flLastPhysicsInfluenceTime; // 0x840            
        ...
        static_assert(sizeof(source2sdk::server::CBreakable) == 0x848);
    };
};
