...
#include "source2sdk/server/modifiedconvars_t.hpp"
...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // m_ModifiedConvars has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CUtlVector<source2sdk::server::modifiedconvars_t> m_ModifiedConvars;
            char m_ModifiedConvars[0x18]; // 0x20            
        ...
        static_assert(offsetof(source2sdk::server::CCommentarySystem, m_ModifiedConvars) == 0x20);
