...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::entity2::CEntityIOOutput m_OnPlayerInZone; // 0x778            
            source2sdk::entity2::CEntityIOOutput m_OnPlayerOutZone; // 0x790            
            ...
            char m_PlayersInCount[0x20]; // 0x7a8            
            ...
            char m_PlayersOutCount[0x20]; // 0x7c8            
        ...
        static_assert(sizeof(source2sdk::server::CGamePlayerZone) == 0x7e8);
    };
};
