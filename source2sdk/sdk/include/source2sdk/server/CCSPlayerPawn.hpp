...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            VectorWS m_vecStashedGrenadeThrowPawnCenter; // 0x1340
            Vector m_vecStashedVelocity; // 0x134c
            uint8_t _pad1358[0x8]; // 0x1358
            bool m_bCommittingSuicideOnTeamChange; // 0x1360
            bool m_wasNotKilledNaturally; // 0x1361
            uint8_t _pad1362[0x2]; // 0x1362
            source2sdk::entity2::GameTime_t m_fImmuneToGunGameDamageTime; // 0x1364
            bool m_bGunGameImmunity; // 0x1368
            uint8_t _pad1369[0x3]; // 0x1369
            float m_fMolotovDamageTime; // 0x136c
            QAngle m_angEyeAngles; // 0x1370
            uint8_t _pad137c[0x4];
