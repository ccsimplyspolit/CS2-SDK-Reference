...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::pulse_runtime_lib::SignatureOutflow_Resume m_OnFired; // 0xd8            
            CGlobalSymbol m_strEntityOutput; // 0x120            
