...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_hEntAttached[0x4]; // 0x600            
            uint8_t _pad0604[0x24]; // 0x604
            ...
            char m_hOldAttached[0x4]; // 0x628            
            bool m_bCheapEffect; // 0x62c            
            uint8_t _pad062d[0x1b];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_EntityFlame because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_EntityFlame) == 0x648);
    };
};
