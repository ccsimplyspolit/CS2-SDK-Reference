...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float m_flRange; // 0x604            
            std::int32_t m_nImportance; // 0x608            
            std::int32_t m_nLightChoice; // 0x60c            
        ...
        static_assert(sizeof(source2sdk::client::CInfoDynamicShadowHint) == 0x618);
    };
};
