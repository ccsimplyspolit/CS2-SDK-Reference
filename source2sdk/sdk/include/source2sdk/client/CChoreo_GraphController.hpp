...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_tChoreoTargetWarp[0x18]; // 0xa0            
            ...
            char m_tChoreoExitWarp[0x18]; // 0xb8            
        ...
        static_assert(sizeof(source2sdk::client::CChoreo_GraphController) == 0x110);
    };
};
