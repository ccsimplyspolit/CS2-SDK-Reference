...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            uint8_t _pad1840[0xa8]; // 0x1840
            bool m_bClearWeaponIdentifyingUGC; // 0x18e8
            bool m_bVisualsDataSet; // 0x18e9
            bool m_bUIWeapon; // 0x18ea
            uint8_t _pad18eb[0x1]; // 0x18eb
            std::int32_t m_nCustomEconReloadEventId; // 0x18ec
            uint8_t _pad18f0[0x8]; // 0x18f0
            bool m_bCanBePickedUp; // 0x18f8
            uint8_t _pad18f9[0x3]; // 0x18f9
            source2sdk::entity2::GameTime_t m_nextPrevOwnerUseTime; // 0x18fc
            ...
            char m_hPrevOwner[0x4]; // 0x1900
            source2sdk::entity2::GameTick_t m_nDropTick; // 0x1904
            bool m_bWasActiveWeaponWhenDropped; // 0x1908
            uint8_t _pad1909[0x23]; // 0x1909
            bool m_donated; // 0x192c
            uint8_t _pad192d[0x3]; // 0x192d
            source2sdk::entity2::GameTime_t m_fLastShotTime; // 0x1930
            bool m_bWasOwnedByCT; // 0x1934
            bool m_bWasOwnedByTerrorist; // 0x1935
            uint8_t _pad1936[0x2]; // 0x1936
            float m_flNextClientFireBulletTime; // 0x1938
            float m_flNextClientFireBulletTime_Repredict; // 0x193c
            uint8_t _pad1940[0x50]; // 0x1940
