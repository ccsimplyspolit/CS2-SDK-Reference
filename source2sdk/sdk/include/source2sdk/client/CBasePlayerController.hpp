...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // metadata: MNotSaved
            source2sdk::client::C_CommandContext m_CommandContext; // 0x608            
            // metadata: MNotSaved
            ...
            // metadata: MNotSaved
            source2sdk::client::PlayerConnectedState m_iMostConnected; // 0x6f0            
            // metadata: MNotSaved
            char m_iszPlayerName[128]; // 0x6f4            
            uint8_t _pad0774[0xc]; // 0x774
            // metadata: MNotSaved
