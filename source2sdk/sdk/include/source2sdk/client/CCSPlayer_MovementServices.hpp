...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::entity2::GameTime_t m_fStashGrenadeParameterWhen; // 0x684            
            bool m_bUseFrictionStashedSpeed; // 0x688            
            uint8_t _pad0689[0x3]; // 0x689
            float m_flUseFrictionStashedSpeedUntilFrac; // 0x68c            
            float m_flFrictionStashedSpeed; // 0x690            
            float m_flStamina; // 0x694            
            float m_flHeightAtJumpStart; // 0x698            
            float m_flMaxJumpHeightThisJump; // 0x69c            
            float m_flMaxJumpHeightLastJump; // 0x6a0            
            float m_flStaminaAtJumpStart; // 0x6a4            
            float m_flVelMulAtJumpStart; // 0x6a8            
            float m_flAccumulatedJumpError; // 0x6ac            
            source2sdk::client::CCSPlayerLegacyJump m_LegacyJump; // 0x6b0            
            source2sdk::client::CCSPlayerModernJump m_ModernJump; // 0x6c8            
            source2sdk::entity2::GameTick_t m_nLastJumpTick; // 0x700            
            float m_flLastJumpFrac; // 0x704            
            float m_flLastJumpVelocityZ; // 0x708            
            bool m_bJumpApexPending; // 0x70c            
            uint8_t _pad070d[0x3]; // 0x70d
            float m_flTicksSinceLastSurfingDetected; // 0x710            
            bool m_bWasSurfing; // 0x714            
            uint8_t _pad0715[0x8f]; // 0x715
            Vector2D m_vecWalkWishVel; // 0x7a4            
            uint8_t _pad07ac[0x824]; // 0x7ac
        ...
        static_assert(sizeof(source2sdk::client::CCSPlayer_MovementServices) == 0xfe0);
    };
};
