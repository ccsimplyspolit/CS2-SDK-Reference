...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t max_charges_per_kill; // 0x1a78
            float recharge_time; // 0x1a7c
            bool m_bFull; // 0x1a80
            uint8_t _pad1a81[0x3]; // 0x1a81
            std::int32_t bonus_intellect; // 0x1a84
            std::int32_t movement_speed; // 0x1a88
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Bottomless_Chalice) == 0x1a90);
    };
};
