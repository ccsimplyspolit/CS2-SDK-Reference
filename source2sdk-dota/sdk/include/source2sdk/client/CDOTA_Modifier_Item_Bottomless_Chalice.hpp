...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t max_charges_per_kill; // 0x1a58            
            float recharge_time; // 0x1a5c            
            bool m_bFull; // 0x1a60            
            uint8_t _pad1a61[0x3]; // 0x1a61
            std::int32_t bonus_intellect; // 0x1a64            
            std::int32_t movement_speed; // 0x1a68            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Bottomless_Chalice) == 0x1a70);
    };
};
