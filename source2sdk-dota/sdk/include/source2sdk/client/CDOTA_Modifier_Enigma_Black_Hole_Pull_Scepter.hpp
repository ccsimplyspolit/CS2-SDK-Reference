...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t scepter_drag_speed; // 0x1a78
            float scepter_pull_rotate_speed; // 0x1a7c
            float aura_origin_x; // 0x1a80
            float aura_origin_y; // 0x1a84
            source2sdk::client::ParticleIndex_t m_nFXIndex; // 0x1a88
            VectorWS m_vCenter; // 0x1a8c
            source2sdk::entity2::GameTime_t m_flLastThinkTime; // 0x1a98
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Enigma_Black_Hole_Pull_Scepter) == 0x1aa0);
    };
};
