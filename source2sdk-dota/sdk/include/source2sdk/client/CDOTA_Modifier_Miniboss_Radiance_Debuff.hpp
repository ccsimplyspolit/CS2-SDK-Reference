...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t aura_damage_per_upgrade; // 0x1a90
            float aura_interval; // 0x1a94
            float aura_radius; // 0x1a98
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Miniboss_Radiance_Debuff) == 0x1aa0);
    };
};
