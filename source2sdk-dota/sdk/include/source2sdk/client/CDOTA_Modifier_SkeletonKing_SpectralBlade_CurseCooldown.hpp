...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::client::ParticleIndex_t m_nCooldownEffect; // 0x1a78
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_SkeletonKing_SpectralBlade_CurseCooldown) == 0x1a80);
    };
};
