...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float shrapnel_damage; // 0x1a5c            
            std::int32_t fast_tick; // 0x1a60            
            std::int32_t m_nTracker; // 0x1a64            
            bool bFirst; // 0x1a68            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Sniper_Shrapnel_Slow) == 0x1a70);
    };
};
