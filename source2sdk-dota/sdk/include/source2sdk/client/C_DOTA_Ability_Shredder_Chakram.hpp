...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            float radius; // 0x6a8            
            float speed; // 0x6ac            
            float pass_slow_duration; // 0x6b0            
            std::int32_t pass_damage; // 0x6b4            
            VectorWS m_vEndLocation; // 0x6b8            
            float m_fZCoord; // 0x6c4            
            bool m_bIsReturning; // 0x6c8            
            uint8_t _pad06c9[0x3]; // 0x6c9
            source2sdk::client::ParticleIndex_t m_nFXIndex; // 0x6cc            
            source2sdk::client::ParticleIndex_t m_nFXIndexB; // 0x6d0            
            source2sdk::client::ParticleIndex_t m_nFXIndexC; // 0x6d4            
            std::int32_t m_nProjectileIndex; // 0x6d8            
            // m_hThinker has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::client::C_BaseEntity> m_hThinker;
            char m_hThinker[0x4]; // 0x6dc            
