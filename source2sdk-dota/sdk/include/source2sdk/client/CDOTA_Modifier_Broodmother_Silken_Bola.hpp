...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t miss_chance; // 0x1a60            
            std::int32_t shard_miss_chance; // 0x1a64            
            std::int32_t roots; // 0x1a68            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Broodmother_Silken_Bola) == 0x1a70);
    };
};
