...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t m_iAccumulatedDamage; // 0x1a58            
            float m_flDelayDuration; // 0x1a5c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Kunkka_GhostShip_DamageDelay because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Kunkka_GhostShip_DamageDelay) == 0x1a60);
    };
};
