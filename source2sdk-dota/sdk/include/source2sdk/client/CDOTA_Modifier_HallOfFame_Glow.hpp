...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_vecGlowingPlayerIDs[0x18]; // 0x1a78
            ...
            char m_vecGlowingPlayerIDs2[0x18]; // 0x1a90
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_HallOfFame_Glow because it is not a standard-layout class

        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_HallOfFame_Glow) == 0x1aa8);
    };
};
