...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t berserk_spell_amp; // 0x1a78
            std::int32_t berserk_manacost_reduction; // 0x1a7c
            std::int32_t berserk_magic_resistance; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_MaskOfDispair_Berserk) == 0x1a88);
    };
};
