...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_hSecondaryTarget[0x4]; // 0x1a5c            
            ...
            char m_hTertiaryTarget[0x4]; // 0x1a60            
            ...
            char m_hReturnBrewling[0x4]; // 0x1a64            
            std::int32_t primal_split_cancel; // 0x1a68            
            std::int32_t m_nFXIndex; // 0x1a6c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Brewmaster_PrimalSplit because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Brewmaster_PrimalSplit) == 0x1a70);
    };
};
