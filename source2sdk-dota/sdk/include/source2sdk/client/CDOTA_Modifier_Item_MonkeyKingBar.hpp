...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t bonus_chance; // 0x1a7c
            std::int32_t bonus_chance_damage; // 0x1a80
            std::int32_t bonus_damage; // 0x1a84
            std::int32_t melee_attack_range; // 0x1a88
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_MonkeyKingBar) == 0x1aa8);
    };
};
