...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t shard_dps; // 0x1a78
            std::int32_t shard_move_slow_pct; // 0x1a7c
            float shard_interval; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Special_Mars_Spear_Burning_Trail_Burn) == 0x1a88);
    };
};
