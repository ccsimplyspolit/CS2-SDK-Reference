...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t barrier_pct; // 0x1a7c
            std::int32_t applied_damage; // 0x1a80
            std::int32_t barrier; // 0x1a84
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Lina_LagunaBlade_Barrier because it is not a standard-layout class

        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Lina_LagunaBlade_Barrier) == 0x1a88);
    };
};
