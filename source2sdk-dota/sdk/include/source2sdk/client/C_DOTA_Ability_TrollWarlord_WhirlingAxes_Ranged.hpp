...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float axe_width; // 0x6b8            
            float axe_speed; // 0x6bc            
            float axe_range; // 0x6c0            
            float axe_spread; // 0x6c4            
            std::int32_t axe_count; // 0x6c8            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_TrollWarlord_WhirlingAxes_Ranged) == 0x6e8);
    };
};
