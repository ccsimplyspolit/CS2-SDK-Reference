...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float moveslow_drain_rate; // 0x1a78
            float max_moveslow; // 0x1a7c
            float max_moveslow_time; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_DeathProphet_SpiritSiphon_Slow) == 0x1a88);
    };
};
