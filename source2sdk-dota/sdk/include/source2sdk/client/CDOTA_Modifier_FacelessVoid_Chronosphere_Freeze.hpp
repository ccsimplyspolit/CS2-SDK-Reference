...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float m_flChronosphereDuration; // 0x1a58            
            float m_flChronosphereStartTime; // 0x1a5c            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_FacelessVoid_Chronosphere_Freeze) == 0x1a60);
    };
};
