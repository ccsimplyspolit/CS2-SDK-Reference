...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            bool m_bMiniGameActive; // 0x19b8            
            std::int8_t m_vecTargetAssignments[10]; // 0x19b9            
            std::uint8_t m_vecMiniGamePoints[10]; // 0x19c3            
            std::uint8_t m_vecMiniGameKills[10]; // 0x19cd            
            uint8_t _pad19d7[0x11]; // 0x19d7
            ...
            char m_activeGravestones[0x18]; // 0x19e8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CIngameEvent_MuertaReleaseSpring2023 because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CIngameEvent_MuertaReleaseSpring2023) == 0x1a00);
    };
};
