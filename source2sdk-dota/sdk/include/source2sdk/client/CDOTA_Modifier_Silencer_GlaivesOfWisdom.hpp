...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float intellect_damage_pct; // 0x1a58            
            ...
            // CUtlVector<source2sdk::client::AttackRecord_t> m_InFlightSilenceAttackRecords;
            char m_InFlightSilenceAttackRecords[0x18]; // 0x1a78            
            source2sdk::client::CDOTA_Buff* m_pAttackCounterBuff; // 0x1a90            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Silencer_GlaivesOfWisdom because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Silencer_GlaivesOfWisdom) == 0x1a98);
    };
};
