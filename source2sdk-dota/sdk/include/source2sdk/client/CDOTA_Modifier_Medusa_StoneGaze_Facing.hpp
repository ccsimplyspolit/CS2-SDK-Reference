...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float stone_duration; // 0x1a5c            
            float duration; // 0x1a60            
            float vision_cone; // 0x1a64            
            float m_flAccumulatedTime; // 0x1a68            
            uint8_t _pad1a6c[0x4]; // 0x1a6c
            source2sdk::client::CountdownTimer ctFacing; // 0x1a70            
            bool m_bAlreadyStoned; // 0x1a88            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Medusa_StoneGaze_Facing) == 0x1a90);
    };
};
