...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t bonus_hero_damage; // 0x1a78
            std::int32_t creep_damage_penalty; // 0x1a7c
            float radius; // 0x1a80
            float attack_interval; // 0x1a84
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_EmberSpirit_SleightOfFist_Caster) == 0x1a88);
    };
};
