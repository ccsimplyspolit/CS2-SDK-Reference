...
namespace source2sdk
{
    namespace client
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CDOTA_Modifier_Item_NetherRaiment : public source2sdk::client::CDOTA_Buff_Item
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_NetherRaiment) == 0x1a70);
    };
};
