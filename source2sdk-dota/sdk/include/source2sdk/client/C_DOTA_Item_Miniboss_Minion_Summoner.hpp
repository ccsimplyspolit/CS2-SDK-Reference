...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::entity2::GameTime_t m_fEquipTime; // 0x758            
            source2sdk::entity2::GameTime_t m_flActivatedTime; // 0x75c            
            // m_hOwner has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::client::C_BaseEntity> m_hOwner;
            char m_hOwner[0x4]; // 0x760            
            bool m_bItemActivated; // 0x764            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Item_Miniboss_Minion_Summoner) == 0x768);
    };
};
