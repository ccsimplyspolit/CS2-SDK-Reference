...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float distance_damage_pct; // 0x1a58            
            std::int32_t distance_cap; // 0x1a5c            
            float illusion_damage_multiplier; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Enchantress_Impetus) == 0x1a80);
    };
};
