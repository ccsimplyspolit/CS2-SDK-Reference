...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float distance_damage_pct; // 0x1a78
            std::int32_t distance_cap; // 0x1a7c
            float illusion_damage_multiplier; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Enchantress_Impetus) == 0x1aa0);
    };
};
