...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // CUtlVector<source2sdk::client::AttackRecord_t> m_EnchantTotemAttackRecords;
            char m_EnchantTotemAttackRecords[0x18]; // 0x1a58            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Earthshaker_Slugger_Intrinsic) == 0x1a70);
    };
};
