...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t chain_chance; // 0x1a80
            std::int32_t chain_strikes; // 0x1a84
            std::int32_t chain_damage; // 0x1a88
            std::int32_t chain_radius; // 0x1a8c
            std::int32_t chain_damage_per_charge; // 0x1a90
            std::int32_t max_charges; // 0x1a94
            float chain_cooldown; // 0x1a98
            ...
            source2sdk::client::CountdownTimer m_ChainTimer; // 0x1ab8
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Item_Mjollnir because it is not a standard-layout class

        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Mjollnir) == 0x1ad0);
    };
};
