...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_hShackleTarget[0x4]; // 0x6a8            
            source2sdk::client::ParticleIndex_t nShackleFXIndex; // 0x6ac            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_AghsFort_ShadowShaman_Shackles) == 0x6b0);
    };
};
