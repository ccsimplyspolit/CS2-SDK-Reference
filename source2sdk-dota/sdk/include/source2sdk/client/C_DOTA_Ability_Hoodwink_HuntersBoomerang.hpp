...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t damage; // 0x6b0            
            float mark_duration; // 0x6b4            
            ...
            char m_vecHitEntities[0x18]; // 0x6c0            
            uint8_t _pad06d8[0x18];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_DOTA_Ability_Hoodwink_HuntersBoomerang because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_Hoodwink_HuntersBoomerang) == 0x6f0);
    };
};
