...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float radius; // 0x1a64            
            std::int32_t damage_reduction; // 0x1a68            
            source2sdk::entity2::GameTime_t m_flLastSeen; // 0x1a6c            
            bool transfer_on_death; // 0x1a70            
            ...
            char m_vhAffectedEnemyHeroes[0x18]; // 0x1a78            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Winter_Wyvern_Winters_Curse_Aura) == 0x1a90);
    };
};
