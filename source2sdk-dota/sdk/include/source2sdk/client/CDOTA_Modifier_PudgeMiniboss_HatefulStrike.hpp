...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t maxhp_percent_damage; // 0x1a7c
            std::int32_t every_n_attacks; // 0x1a80
            bool crit_active; // 0x1a84
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_PudgeMiniboss_HatefulStrike) == 0x1a88);
    };
};
