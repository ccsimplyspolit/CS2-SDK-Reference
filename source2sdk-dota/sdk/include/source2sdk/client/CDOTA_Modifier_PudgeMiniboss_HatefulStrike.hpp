...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t maxhp_percent_damage; // 0x1a5c            
            std::int32_t every_n_attacks; // 0x1a60            
            bool crit_active; // 0x1a64            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_PudgeMiniboss_HatefulStrike) == 0x1a68);
    };
};
