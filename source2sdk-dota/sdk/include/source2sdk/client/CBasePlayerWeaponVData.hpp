...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_szWorldModelAg2Override) == 0xf8);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_sToolsOnlyOwnerModelName) == 0x1d8);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_bBuiltRightHanded) == 0x2b8);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_bAllowFlipping) == 0x2b9);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_sMuzzleAttachment) == 0x2c0);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_szMuzzleFlashParticle) == 0x2e0);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_szMuzzleFlashParticleConfig) == 0x3c0);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_szBarrelSmokeParticle) == 0x3c8);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_nMuzzleSmokeShotThreshold) == 0x4a8);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_flMuzzleSmokeTimeout) == 0x4ac);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_flMuzzleSmokeDecrementRate) == 0x4b0);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_bGenerateMuzzleLight) == 0x4b4);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_bLinkedCooldowns) == 0x4b5);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_iFlags) == 0x4b6);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_iWeight) == 0x4b8);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_bAutoSwitchTo) == 0x4bc);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_bAutoSwitchFrom) == 0x4bd);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_nPrimaryAmmoType) == 0x4be);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_nSecondaryAmmoType) == 0x4bf);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_iMaxClip1) == 0x4c0);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_iMaxClip2) == 0x4c4);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_iDefaultClip1) == 0x4c8);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_iDefaultClip2) == 0x4cc);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_bReserveAmmoAsClips) == 0x4d0);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_bTreatAsSingleClip) == 0x4d1);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_bKeepLoadedAmmo) == 0x4d2);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_iRumbleEffect) == 0x4d4);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_flDropSpeed) == 0x4d8);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_iSlot) == 0x4dc);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_iPosition) == 0x4e0);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_aShootSounds) == 0x4e8);
        
        static_assert(sizeof(source2sdk::client::CBasePlayerWeaponVData) == 0x510);
    };
};
