...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::client::ParticleIndex_t m_nAmbientFXIndex; // 0xac0            
            ...
            char m_nFXIndex[0x8]; // 0xac8            
            Color m_ParticleTintColor; // 0xad0            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_PortraitBuilding) == 0xad8);
    };
};
