...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t attack_range_bonus; // 0x1a58            
            std::int32_t bonus_health; // 0x1a5c            
            std::int32_t bonus_attackspeed; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Enchantress_Enchant_Intrinsic) == 0x1a70);
    };
};
