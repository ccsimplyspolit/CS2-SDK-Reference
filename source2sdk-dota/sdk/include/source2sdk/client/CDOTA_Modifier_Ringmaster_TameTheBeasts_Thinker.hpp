...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float m_flRadiusChannelPct; // 0x1a58            
            float m_flDamageChannelPct; // 0x1a5c            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Ringmaster_TameTheBeasts_Thinker) == 0x1a60);
    };
};
