...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t area_of_effect; // 0x6a8            
            source2sdk::client::ParticleIndex_t m_nfxIndex_roar; // 0x6ac            
            float fire_interval; // 0x6b0            
            float delay; // 0x6b4            
            float target_range; // 0x6b8            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_Nian_Apocalypse) == 0x6e0);
    };
};
