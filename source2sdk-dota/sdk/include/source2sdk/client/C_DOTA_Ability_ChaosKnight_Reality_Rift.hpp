...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_hRiftIllusion[0x4]; // 0x6c8            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_ChaosKnight_Reality_Rift) == 0x6d0);
    };
};
