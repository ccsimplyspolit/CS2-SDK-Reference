...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::particleslib::CNewParticleEffect* m_pVisionRangeFX; // 0x1a58            
            std::int32_t vision_radius; // 0x1a60            
            bool m_bHasBeenMagnetized; // 0x1a64            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_EarthSpirit_StoneThinker) == 0x1a70);
    };
};
