...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t m_iWisdomShrinesTaken; // 0xf4c
            float m_flDamageByTypeReceivedPreReduction[3]; // 0xf50
            float m_flDamageByTypeReceivedPostReduction[3]; // 0xf5c
            float m_flOutgoingDamageByTypePreReduction[3]; // 0xf68
            float m_flOutgoingDamageByTypePostReduction[3]; // 0xf74
            source2sdk::client::OverworldID_t m_uSelectedOverworldID; // 0xf80
            source2sdk::client::OverworldTokenID_t m_uSelectedOverworldTokenRewards[3]; // 0xf81
            source2sdk::client::OverworldTarotCardID_t m_uOverworldFortune[3]; // 0xf84
        ...
        static_assert(offsetof(source2sdk::client::DataTeamPlayer_t, m_iWisdomShrinesTaken) == 0xf4c);
        static_assert(offsetof(source2sdk::client::DataTeamPlayer_t, m_flDamageByTypeReceivedPreReduction) == 0xf50);
        static_assert(offsetof(source2sdk::client::DataTeamPlayer_t, m_flDamageByTypeReceivedPostReduction) == 0xf5c);
        static_assert(offsetof(source2sdk::client::DataTeamPlayer_t, m_flOutgoingDamageByTypePreReduction) == 0xf68);
        static_assert(offsetof(source2sdk::client::DataTeamPlayer_t, m_flOutgoingDamageByTypePostReduction) == 0xf74);
        static_assert(offsetof(source2sdk::client::DataTeamPlayer_t, m_uSelectedOverworldID) == 0xf80);
        static_assert(offsetof(source2sdk::client::DataTeamPlayer_t, m_uSelectedOverworldTokenRewards) == 0xf81);
        static_assert(offsetof(source2sdk::client::DataTeamPlayer_t, m_uOverworldFortune) == 0xf84);
        static_assert(offsetof(source2sdk::client::DataTeamPlayer_t, m_iCommandsIssued) == 0xf88);
        static_assert(offsetof(source2sdk::client::DataTeamPlayer_t, m_iGoldSpentOnConsumables) == 0xf8c);
        static_assert(offsetof(source2sdk::client::DataTeamPlayer_t, m_iGoldSpentOnItems) == 0xf90);
        static_assert(offsetof(source2sdk::client::DataTeamPlayer_t, m_iGoldSpentOnBuybacks) == 0xf94);
        static_assert(offsetof(source2sdk::client::DataTeamPlayer_t, m_iGoldLostToDeath) == 0xf98);
        static_assert(offsetof(source2sdk::client::DataTeamPlayer_t, m_bIsNewPlayer) == 0xf9c);
        static_assert(offsetof(source2sdk::client::DataTeamPlayer_t, m_bIsGuidePlayer) == 0xf9d);
