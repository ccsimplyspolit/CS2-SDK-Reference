...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t damage_reduction_pct; // 0x1a88
            float shard_stun_duration; // 0x1a8c
            ...
            std::int32_t bonus_move_speed_pct; // 0x1aa8
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_BountyHunter_WindWalk) == 0x1ab0);
    };
};
