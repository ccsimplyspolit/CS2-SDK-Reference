...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t m_bitsDotaDamageType; // 0x78            
            std::int32_t m_nDotaDamageCategory; // 0x7c            
            float m_flCombatLogCreditFactor; // 0x80            
            std::int16_t m_iRecord; // 0x84            
            uint8_t _pad0086[0x2]; // 0x86
            source2sdk::client::HitGroup_t m_iHitGroupId; // 0x88            
            uint8_t _pad008c[0x24]; // 0x8c
            ...
            char m_DestructibleHitGroupRequests[0x10]; // 0xb0            
            // metadata: MNotSaved
            bool m_bInTakeDamageFlow; // 0xc0            
        ...
        static_assert(offsetof(source2sdk::client::CTakeDamageInfo, m_bitsDotaDamageType) == 0x78);
        static_assert(offsetof(source2sdk::client::CTakeDamageInfo, m_nDotaDamageCategory) == 0x7c);
        static_assert(offsetof(source2sdk::client::CTakeDamageInfo, m_flCombatLogCreditFactor) == 0x80);
        static_assert(offsetof(source2sdk::client::CTakeDamageInfo, m_iRecord) == 0x84);
        static_assert(offsetof(source2sdk::client::CTakeDamageInfo, m_iHitGroupId) == 0x88);
        static_assert(offsetof(source2sdk::client::CTakeDamageInfo, m_DestructibleHitGroupRequests) == 0xb0);
        static_assert(offsetof(source2sdk::client::CTakeDamageInfo, m_bInTakeDamageFlow) == 0xc0);
