...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            bool m_bStackCountChanged; // 0x1a5c            
            ...
            char m_fStackExpireTimes[0x18]; // 0x1a60            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Necrolyte_Heartstopper_Aura because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Necrolyte_Heartstopper_Aura) == 0x1a78);
    };
};
