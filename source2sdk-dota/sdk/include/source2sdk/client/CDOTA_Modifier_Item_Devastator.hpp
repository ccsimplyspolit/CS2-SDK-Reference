...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t mana_cost; // 0x1a8c
            std::int32_t slow_duration; // 0x1a90
            std::int32_t spell_amp_duration; // 0x1a94
            std::int32_t damage_penalty; // 0x1a98
            std::int32_t passive_cooldown; // 0x1a9c
            ...
            char m_InFlightWitchBladeAttackRecords[0x18]; // 0x1aa0
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Item_Devastator because it is not a standard-layout class

        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Devastator) == 0x1ab8);
    };
};
