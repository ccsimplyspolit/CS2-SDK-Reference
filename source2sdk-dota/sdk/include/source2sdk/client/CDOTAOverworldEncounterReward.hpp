...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            CUtlString m_sRewardTitle; // 0x20            
        };
        #pragma pack(pop)
        ...
        static_assert(offsetof(source2sdk::client::CDOTAOverworldEncounterReward, m_sRewardTitle) == 0x20);
        
        static_assert(sizeof(source2sdk::client::CDOTAOverworldEncounterReward) == 0x28);
    };
};
