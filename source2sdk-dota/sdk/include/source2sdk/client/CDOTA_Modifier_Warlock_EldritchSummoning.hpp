...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float minor_imp_duration; // 0x1a58            
            std::int32_t golem_can_summon; // 0x1a5c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Warlock_EldritchSummoning because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Warlock_EldritchSummoning) == 0x1a60);
    };
};
