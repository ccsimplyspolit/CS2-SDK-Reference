...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float dagger_path_duration; // 0x6a8            
            float hero_path_duration; // 0x6ac            
            float m_fCreateInterval; // 0x6b0            
            source2sdk::entity2::GameTime_t m_fLastCreate; // 0x6b4            
            VectorWS m_vecLastPosition; // 0x6b8            
            bool m_bIsTrackingProjectile; // 0x6c4            
            ...
            char m_hTrackingProjectileHits[0x18]; // 0x6c8            
            ...
            char m_hUnitsHit[0x18]; // 0x6e0            
            bool m_bIsThinkHit; // 0x6f8            
            ...
            char m_hTrackingTarget[0x4]; // 0x6fc            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_DOTA_Ability_Spectre_SpectralDagger because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_Spectre_SpectralDagger) == 0x700);
    };
};
