...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float explosion_delay; // 0x1a78
            float max_mana_pct_as_damage; // 0x1a7c
            float radius; // 0x1a80
            float bonus_mana_as_mana_regen; // 0x1a84
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Techies_MutuallyAssuredDestruction) == 0x1a88);
    };
};
