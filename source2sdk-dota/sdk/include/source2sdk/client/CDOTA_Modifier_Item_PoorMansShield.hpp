...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t damage_block_melee; // 0x1a58            
            std::int32_t damage_block_ranged; // 0x1a5c            
            std::int32_t block_chance; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_PoorMansShield) == 0x1a68);
    };
};
