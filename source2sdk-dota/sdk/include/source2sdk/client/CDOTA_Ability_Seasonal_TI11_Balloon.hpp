...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float charge_use_interval; // 0x6a8            
            float max_usable_charges; // 0x6ac            
            source2sdk::entity2::GameTime_t m_flLastChargeUseTime; // 0x6b0            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Ability_Seasonal_TI11_Balloon) == 0x6d0);
    };
};
