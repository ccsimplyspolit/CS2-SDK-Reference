...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::client::ParticleIndex_t m_nFXSkullIndex; // 0x19b8
            std::int32_t m_nTargetType; // 0x19bc
            std::int32_t m_nTargetFlags; // 0x19c0
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_NPC_WitchDoctor_Ward) == 0x19c8);
    };
};
