...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float m_flCurseDuration; // 0x1a68            
            float m_flTotalBonusTime; // 0x1a6c            
            float m_flCurseStartTime; // 0x1a70            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Winter_Wyvern_Winters_Curse) == 0x1a78);
    };
};
