...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t curse_slow; // 0x1a5c            
            float curse_interval; // 0x1a60            
            std::int32_t curse_dps; // 0x1a64            
            std::int32_t tower_dps_pct; // 0x1a68            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Abaddon_Frostmourne_Debuff_Bonus) == 0x1a70);
    };
};
