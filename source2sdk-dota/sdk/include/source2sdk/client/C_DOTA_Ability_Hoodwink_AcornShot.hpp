...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float bounce_range; // 0x6b4            
            std::int32_t bounce_count; // 0x6b8            
            bool m_bIsAltCastState; // 0x6bc            
            uint8_t _pad06bd[0x3]; // 0x6bd
            std::int32_t can_bounce_off_of_trees; // 0x6c0            
            std::int32_t bounces_after_tree_bounce; // 0x6c4            
            bool bBouncedOffTree; // 0x6c8            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_Hoodwink_AcornShot) == 0x6d0);
    };
};
