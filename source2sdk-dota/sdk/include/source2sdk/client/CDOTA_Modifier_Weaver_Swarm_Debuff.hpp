...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float armor_reduction; // 0x1a58            
            std::int32_t damage; // 0x1a5c            
            std::int32_t experience_gain; // 0x1a60            
            float m_flCurrentArmorReduction; // 0x1a64            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Weaver_Swarm_Debuff) == 0x1a70);
    };
};
