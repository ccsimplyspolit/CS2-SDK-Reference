...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float armor_reduction; // 0x1a78
            std::int32_t damage; // 0x1a7c
            std::int32_t experience_gain; // 0x1a80
            float m_flCurrentArmorReduction; // 0x1a84
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Weaver_Swarm_Debuff) == 0x1a90);
    };
};
