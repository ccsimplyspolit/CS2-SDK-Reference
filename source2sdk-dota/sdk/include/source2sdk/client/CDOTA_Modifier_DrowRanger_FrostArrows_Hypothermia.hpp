...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t shard_regen_reduction_pct_per_stack; // 0x1a78
            float shard_burst_radius; // 0x1a7c
            source2sdk::client::ParticleIndex_t m_nFXStackIndex; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_DrowRanger_FrostArrows_Hypothermia) == 0x1a88);
    };
};
