...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t bonus_all_stats; // 0x1a60            
            std::int32_t bonus_health; // 0x1a64            
            std::int32_t self_movement_speed; // 0x1a68            
            source2sdk::client::ParticleIndex_t nFXIndex; // 0x1a6c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Item_Solar_Crest because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Solar_Crest) == 0x1a70);
    };
};
