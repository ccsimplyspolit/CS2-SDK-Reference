...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            float radius; // 0x1a58            
            std::int32_t bonus_movement_speed; // 0x1a5c            
            std::int32_t bonus_health_regen; // 0x1a60            
            std::int32_t bonus_str; // 0x1a64            
            std::int32_t bonus_int; // 0x1a68            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Boots_Of_Bearing) == 0x1a70);
    };
};
