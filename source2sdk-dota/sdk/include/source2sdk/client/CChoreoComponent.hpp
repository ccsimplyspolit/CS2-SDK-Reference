...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::CChoreoComponent, m_nExernalChoreoGraphCount) == 0x34);
        static_assert(offsetof(source2sdk::client::CChoreoComponent, m_sActiveExternalChoreoGraphSlotID) == 0x38);
        static_assert(offsetof(source2sdk::client::CChoreoComponent, m_nNextSceneEventId) == 0x70);
        static_assert(offsetof(source2sdk::client::CChoreoComponent, m_flAllowResponsesEndTime) == 0x74);
        
        static_assert(sizeof(source2sdk::client::CChoreoComponent) == 0x80);
    };
};
