...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t bonus_intellect; // 0x1a70            
            float bonus_mana_regen; // 0x1a74            
            std::int32_t bonus_damage; // 0x1a78            
            std::int32_t bonus_attack_speed; // 0x1a7c            
            std::int32_t spell_amp; // 0x1a80            
            std::int32_t mana_regen_multiplier; // 0x1a84            
            std::int32_t bonus_magic_resist; // 0x1a88            
            float duration; // 0x1a8c            
            std::int32_t passive_proc_damage; // 0x1a90            
            std::int32_t proc_chance; // 0x1a94            
            float bonus_health_regen; // 0x1a98            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Bloodthorn) == 0x1aa0);
    };
};
