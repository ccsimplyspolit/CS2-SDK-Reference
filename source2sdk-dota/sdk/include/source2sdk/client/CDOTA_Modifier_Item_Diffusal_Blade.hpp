...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float damage_per_burn; // 0x1a80
            std::int32_t feedback_mana_burn; // 0x1a84
            std::int32_t feedback_mana_burn_illusion_melee; // 0x1a88
            std::int32_t feedback_mana_burn_illusion_ranged; // 0x1a8c
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Item_Diffusal_Blade because it is not a standard-layout class

        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Diffusal_Blade) == 0x1a90);
    };
};
