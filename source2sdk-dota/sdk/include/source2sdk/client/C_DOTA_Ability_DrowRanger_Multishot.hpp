...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float arrow_speed; // 0x6bc            
            std::int32_t arrow_spread; // 0x6c0            
            ...
            char m_vHitTargets0[0x18]; // 0x6c8            
            ...
            char m_vHitTargets1[0x18]; // 0x6e0            
            ...
            char m_vHitTargets2[0x18]; // 0x6f8            
            ...
            char m_vHitTargets3[0x18]; // 0x710            
            ...
            char m_vHitTargets4[0x18]; // 0x728            
            ...
            char m_vHitTargets5[0x18]; // 0x740            
