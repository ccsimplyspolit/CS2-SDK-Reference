...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float evasion; // 0x1a58            
            float min_movespeed; // 0x1a5c            
            float bonus_attack_speed; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Lycan_SummonWolves_GeistForm) == 0x1a68);
    };
};
