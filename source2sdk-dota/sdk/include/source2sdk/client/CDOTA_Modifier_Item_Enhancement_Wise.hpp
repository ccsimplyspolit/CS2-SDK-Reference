...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float bonus_xpm; // 0x1a58            
            float max_mana_pct; // 0x1a5c            
            float m_flExperiencePerSecond; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Enhancement_Wise) == 0x1a68);
    };
};
