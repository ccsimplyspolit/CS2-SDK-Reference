...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t shard_width; // 0x6a8            
            std::int32_t shard_count; // 0x6ac            
            float shard_duration; // 0x6b0            
            float shard_angle_step; // 0x6b4            
            std::int32_t shard_distance; // 0x6b8            
            VectorWS m_vSpawnOrigin; // 0x6bc            
            Vector m_vDirection; // 0x6c8            
