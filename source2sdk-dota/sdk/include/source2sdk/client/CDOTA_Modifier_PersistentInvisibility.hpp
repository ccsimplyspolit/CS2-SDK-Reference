...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float fade_delay; // 0x1a58            
            float m_flFadeTime; // 0x1a5c            
            source2sdk::entity2::GameTime_t m_flLastActionTime; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_PersistentInvisibility) == 0x1a68);
    };
};
