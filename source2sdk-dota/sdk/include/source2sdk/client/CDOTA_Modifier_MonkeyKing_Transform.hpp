...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            CUtlString m_strDisguise; // 0x1a58            
            std::int32_t movespeed; // 0x1a60            
            std::int32_t m_nDisguisedSpeed; // 0x1a64            
            std::int32_t reveal_radius; // 0x1a68            
            source2sdk::client::ParticleIndex_t m_nDisguiseEffectIndex; // 0x1a6c            
            ...
            char m_hCourierToClone[0x4]; // 0x1a70            
            ...
            char m_hCreepToClone[0x4]; // 0x1a74            
            ...
            char m_aryBountyRuneSpawners[0x18]; // 0x1a78            
            bool m_bIsFlyingCourier; // 0x1a90            
            bool m_bIsRune; // 0x1a91            
            bool m_bIsBanana; // 0x1a92            
            bool m_bIsFakeAlly; // 0x1a93            
            std::uint32_t m_nMischiefUnitType; // 0x1a94            
            std::int32_t m_nMischiefHealthbarOffset; // 0x1a98            
            float invul_duration; // 0x1a9c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_MonkeyKing_Transform because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_MonkeyKing_Transform) == 0x1aa0);
    };
};
