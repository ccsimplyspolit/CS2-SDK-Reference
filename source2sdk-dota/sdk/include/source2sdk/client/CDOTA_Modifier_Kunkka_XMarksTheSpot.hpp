...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t ally_ms; // 0x1a78
            std::int32_t ally_armor; // 0x1a7c
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Kunkka_XMarksTheSpot) == 0x1a98);
    };
};
