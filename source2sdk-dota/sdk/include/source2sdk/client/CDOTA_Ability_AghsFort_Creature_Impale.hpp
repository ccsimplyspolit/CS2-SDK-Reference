...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t width; // 0x6ac            
            float duration; // 0x6b0            
            std::int32_t length; // 0x6b4            
            std::int32_t speed; // 0x6b8            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Ability_AghsFort_Creature_Impale) == 0x6c0);
    };
};
