...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t leap_speedbonus; // 0x1a78
            std::int32_t leap_speedbonus_as; // 0x1a7c
            std::int32_t quiver_restore; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Mirana_Leap_Buff) == 0x1a88);
    };
};
