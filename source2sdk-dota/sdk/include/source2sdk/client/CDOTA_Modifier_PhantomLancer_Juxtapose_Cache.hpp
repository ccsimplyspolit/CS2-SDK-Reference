...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::client::PlayerID_t m_nControllingPlayer; // 0x1a78
            bool m_bBlocksCreepSpawn; // 0x1a7c
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_PhantomLancer_Juxtapose_Cache) == 0x1a80);
    };
};
