...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::CountdownTimer m_ViewerTimer; // 0x1a90
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_AghsFort_Spectre_ActiveDispersion_Thinker) == 0x1ad0);
    };
};
