...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float pulse_move_slow_pct; // 0x1a78
            float pulse_attack_slow_pct; // 0x1a7c
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Marci_Unleash_FlurryPulse_Debuff) == 0x1a80);
    };
};
