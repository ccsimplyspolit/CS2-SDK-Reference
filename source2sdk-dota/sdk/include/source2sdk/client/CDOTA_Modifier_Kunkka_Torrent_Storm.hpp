...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float torrent_min_distance; // 0x1a58            
            float torrent_max_distance; // 0x1a5c            
            std::int32_t m_iExplosionQuadrant; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Kunkka_Torrent_Storm) == 0x1a78);
    };
};
