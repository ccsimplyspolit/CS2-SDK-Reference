...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float m_flHealth; // 0x1a58            
            float m_flDisseminate_Duration; // 0x1a5c            
            ...
            char m_hDisseminateAbility[0x4]; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Shadow_Demon_Disruption) == 0x1a68);
    };
};
