...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::AttackRecord_t iRecord; // 0x44            
            uint8_t _pad0046[0x2]; // 0x46
            std::int32_t nCost; // 0x48            
            std::int32_t nHealthCost; // 0x4c            
            std::int32_t nOrdertype; // 0x50            
            VectorWS vOldLoc; // 0x54            
            VectorWS vNewLoc; // 0x60            
            VectorWS vCastLocation; // 0x6c            
            bool bCraniumBasherTested; // 0x78            
            bool bMKBTested; // 0x79            
            bool bSpecialistTested; // 0x7a            
            bool bOctarineTested; // 0x7b            
            ...
            bool bBonusIllusion; // 0x86            
            bool bInterrupted; // 0x87            
            bool bDiffusalApplied; // 0x88            
            bool bChainLightningConsidered; // 0x89            
            bool bSuppressDamage; // 0x8a            
            bool bRangedAttack; // 0x8b            
            bool bProcessProcs; // 0x8c            
            bool bWrapsTested; // 0x8d            
            ...
            bool bAllowCopy; // 0xb4            
            uint8_t _pad00b5[0xb]; // 0xb5
            ...
            char inflictor2[0x4]; // 0xd0            
            uint8_t _pad00d4[0x4]; // 0xd4
            source2sdk::client::CDOTA_Buff* pAddedBuff; // 0xd8            
            Vector vAttemptedKnockbackDirection; // 0xe0            
            float flAttemptedKnockbackMagnitude; // 0xec            
        };
        #pragma pack(pop)
        ...
        static_assert(offsetof(source2sdk::client::CModifierParams, bSpecialistTested) == 0x7a);
        static_assert(offsetof(source2sdk::client::CModifierParams, bOctarineTested) == 0x7b);
        ...
        static_assert(offsetof(source2sdk::client::CModifierParams, bBonusIllusion) == 0x86);
        static_assert(offsetof(source2sdk::client::CModifierParams, bInterrupted) == 0x87);
        static_assert(offsetof(source2sdk::client::CModifierParams, bDiffusalApplied) == 0x88);
        static_assert(offsetof(source2sdk::client::CModifierParams, bChainLightningConsidered) == 0x89);
        static_assert(offsetof(source2sdk::client::CModifierParams, bSuppressDamage) == 0x8a);
        static_assert(offsetof(source2sdk::client::CModifierParams, bRangedAttack) == 0x8b);
        static_assert(offsetof(source2sdk::client::CModifierParams, bProcessProcs) == 0x8c);
        static_assert(offsetof(source2sdk::client::CModifierParams, bWrapsTested) == 0x8d);
        ...
        static_assert(offsetof(source2sdk::client::CModifierParams, bAllowCopy) == 0xb4);
        static_assert(offsetof(source2sdk::client::CModifierParams, hattacker) == 0xc0);
        static_assert(offsetof(source2sdk::client::CModifierParams, htarget) == 0xc4);
        static_assert(offsetof(source2sdk::client::CModifierParams, hunit) == 0xc8);
        static_assert(offsetof(source2sdk::client::CModifierParams, inflictor) == 0xcc);
        static_assert(offsetof(source2sdk::client::CModifierParams, inflictor2) == 0xd0);
        static_assert(offsetof(source2sdk::client::CModifierParams, pAddedBuff) == 0xd8);
        static_assert(offsetof(source2sdk::client::CModifierParams, vAttemptedKnockbackDirection) == 0xe0);
        static_assert(offsetof(source2sdk::client::CModifierParams, flAttemptedKnockbackMagnitude) == 0xec);
        
        static_assert(sizeof(source2sdk::client::CModifierParams) == 0xf0);
    };
};
