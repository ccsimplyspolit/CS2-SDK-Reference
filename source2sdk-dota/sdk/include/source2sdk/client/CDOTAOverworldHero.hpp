...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::CDOTAOverworldHero, m_vecOverrides) == 0x58);
        
        static_assert(sizeof(source2sdk::client::CDOTAOverworldHero) == 0x70);
    };
};
