...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t movement_speed_buff_rate; // 0x1a58            
            float slow_resist; // 0x1a5c            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Disperser_Movespeed_Buff) == 0x1a68);
    };
};
