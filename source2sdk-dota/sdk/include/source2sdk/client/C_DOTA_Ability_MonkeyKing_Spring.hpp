...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            VectorWS m_vPos; // 0x6a8            
            source2sdk::entity2::GameTime_t m_fStartChannelTime; // 0x6b4            
            // m_hThinker has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::client::C_BaseEntity> m_hThinker;
            char m_hThinker[0x4]; // 0x6b8            
            source2sdk::client::ParticleIndex_t m_nFxIndex; // 0x6bc            
            std::int32_t m_nRefCount; // 0x6c0            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_MonkeyKing_Spring) == 0x6c8);
    };
};
