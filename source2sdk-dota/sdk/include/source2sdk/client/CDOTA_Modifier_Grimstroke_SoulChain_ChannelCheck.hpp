...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_hAbilities[0x18]; // 0x1a80
            VectorWS m_vLocation; // 0x1a98
            source2sdk::entity2::GameTime_t m_fChannelEnd; // 0x1aa4
            bool m_bInterrupt; // 0x1aa8
            bool m_bExpired; // 0x1aa9
            uint8_t _pad1aaa[0x6];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Grimstroke_SoulChain_ChannelCheck) == 0x1ab0);
    };
};
