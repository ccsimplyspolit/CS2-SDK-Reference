...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_hAbilities[0x18]; // 0x1a60            
            VectorWS m_vLocation; // 0x1a78            
            source2sdk::entity2::GameTime_t m_fChannelEnd; // 0x1a84            
            bool m_bInterrupt; // 0x1a88            
            bool m_bExpired; // 0x1a89            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Grimstroke_SoulChain_ChannelCheck) == 0x1a90);
    };
};
