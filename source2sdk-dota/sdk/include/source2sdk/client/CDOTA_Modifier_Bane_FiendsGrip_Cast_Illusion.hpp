...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t fiend_grip_mana_drain; // 0x1a58            
            float fiend_grip_tick_interval; // 0x1a5c            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Bane_FiendsGrip_Cast_Illusion) == 0x1a60);
    };
};
