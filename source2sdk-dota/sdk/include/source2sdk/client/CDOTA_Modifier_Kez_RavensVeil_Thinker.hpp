...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float blast_radius; // 0x1ab0
            float blast_speed; // 0x1ab4
            std::int32_t apply_parry_bonus; // 0x1ab8
            float blind_duration; // 0x1abc
            float vuln_duration; // 0x1ac0
            VectorWS m_vStartLoc; // 0x1ac4
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Kez_RavensVeil_Thinker because it is not a standard-layout class

        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Kez_RavensVeil_Thinker) == 0x1ad0);
    };
};
