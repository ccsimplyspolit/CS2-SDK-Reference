...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t base_damage; // 0x6ac            
            float strength_damage; // 0x6b0            
            float slow_duration; // 0x6b4            
            float scepter_bonus_duration; // 0x6b8            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Ability_Centaur_Stampede) == 0x6d8);
    };
};
