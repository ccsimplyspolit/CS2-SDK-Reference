...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t bonus_damage_melee; // 0x1a5c            
            std::int32_t bonus_damage_range; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_PhaseBoots) == 0x1a70);
    };
};
