...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t slow_attack_speed_pct; // 0x1a58            
            float damage; // 0x1a5c            
            float pct_health_damage; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Jakiro_LiquidFire_Burn) == 0x1a68);
    };
};
