...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t evasion; // 0x1a58            
            std::int32_t move_speed; // 0x1a5c            
            std::int32_t flight_threshold; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Avianas_Feather) == 0x1a68);
    };
};
