...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float healing_ward_heal_amount; // 0x1a78
            std::int32_t m_nStartingHealthThisInterval; // 0x1a7c
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Juggernaut_Healing_Ward_Heal because it is not a standard-layout class

        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Juggernaut_Healing_Ward_Heal) == 0x1a80);
    };
};
