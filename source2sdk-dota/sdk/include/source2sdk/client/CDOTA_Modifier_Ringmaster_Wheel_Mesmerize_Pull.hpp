...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float think_interval; // 0x1a78
            float mesmerize_radius; // 0x1a7c
            float k_flCloseThreshold; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Ringmaster_Wheel_Mesmerize_Pull) == 0x1a88);
    };
};
