...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float flare_radius; // 0x1a78
            float fire_trail_health_regen; // 0x1a7c
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Dawnbreaker_Converge_Thinker) == 0x1a88);
    };
};
