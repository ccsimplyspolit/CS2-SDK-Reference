...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t mana_steal; // 0x1a58            
            float m_flCurrentMana; // 0x1a5c            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Obsidian_Destroyer_Equilibrium_Debuff) == 0x1a60);
    };
};
