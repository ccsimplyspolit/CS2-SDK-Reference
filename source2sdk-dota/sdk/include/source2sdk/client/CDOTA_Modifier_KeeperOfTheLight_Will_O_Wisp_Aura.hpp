...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            float radius; // 0x1a78
            float wisp_damage; // 0x1a7c
            float off_duration; // 0x1a80
            float off_duration_initial; // 0x1a84
            float on_duration; // 0x1a88
            std::int32_t hit_count; // 0x1a8c
            std::int32_t m_iAttackCount; // 0x1a90
            source2sdk::entity2::GameTime_t m_flNextTimeOn; // 0x1a94
            ...
            source2sdk::entity2::GameTime_t m_flNextTime; // 0x1aa4
            ...
            char m_vecDamagedEntities[0x18]; // 0x1aa8
            float m_flCorrectionTime; // 0x1ac0
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_KeeperOfTheLight_Will_O_Wisp_Aura) == 0x1ac8);
    };
};
