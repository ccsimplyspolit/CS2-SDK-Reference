...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float radius; // 0x1a7c
            source2sdk::entity2::GameTime_t m_flLastDispersionPulseEffectTime; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Shadow_Demon_Disseminate) == 0x1a88);
    };
};
