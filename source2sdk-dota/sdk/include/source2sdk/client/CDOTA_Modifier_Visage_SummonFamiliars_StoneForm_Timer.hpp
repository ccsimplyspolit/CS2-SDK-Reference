...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float stone_duration; // 0x1a58            
            source2sdk::entity2::GameTime_t m_fStartTime; // 0x1a5c            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Visage_SummonFamiliars_StoneForm_Timer) == 0x1a60);
    };
};
