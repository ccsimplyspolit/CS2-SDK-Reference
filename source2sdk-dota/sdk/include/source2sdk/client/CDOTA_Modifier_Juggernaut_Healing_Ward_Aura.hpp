...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t healing_ward_movespeed_tooltip; // 0x1a58            
            uint8_t _pad1a5c[0x14];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Juggernaut_Healing_Ward_Aura because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Juggernaut_Healing_Ward_Aura) == 0x1a70);
    };
};
