...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t mana_removal_pct; // 0x1a70            
            std::int32_t free_pathing_duration; // 0x1a74            
            std::int32_t attack_animation_bonus; // 0x1a78            
            std::int32_t attack_range_bonus; // 0x1a7c            
            std::int32_t free_pathing_movement_speed_bonus; // 0x1a80            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Nyx_Assassin_Vendetta) == 0x1a88);
    };
};
