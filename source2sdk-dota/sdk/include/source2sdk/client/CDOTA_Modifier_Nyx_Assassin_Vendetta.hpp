...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t mana_removal_pct; // 0x1a90
            std::int32_t free_pathing_duration; // 0x1a94
            std::int32_t attack_animation_bonus; // 0x1a98
            std::int32_t attack_range_bonus; // 0x1a9c
            std::int32_t free_pathing_movement_speed_bonus; // 0x1aa0
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Nyx_Assassin_Vendetta) == 0x1aa8);
    };
};
