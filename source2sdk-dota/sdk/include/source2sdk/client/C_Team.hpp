...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_aPlayerControllers[0x18]; // 0x5f0            
            ...
            char m_aPlayers[0x18]; // 0x608            
            std::int32_t m_iScore; // 0x620            
            char m_szTeamname[129]; // 0x624            
        ...
        static_assert(sizeof(source2sdk::client::C_Team) == 0x6a8);
    };
};
