...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float target_crit_multiplier; // 0x1a78
            float silence_damage_percent; // 0x1a7c
            std::int32_t proc_damage_heroes; // 0x1a80
            std::int32_t proc_damage_creeps; // 0x1a84
