...
#include "source2sdk/client/FantasyTeamData_t.hpp"
...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // m_vecTeams has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CUtlVector<source2sdk::client::FantasyTeamData_t> m_vecTeams;
            char m_vecTeams[0x18]; // 0x28            
        ...
        static_assert(offsetof(source2sdk::client::FantasyLeagueData_t, m_vecTeams) == 0x28);
        static_assert(offsetof(source2sdk::client::FantasyLeagueData_t, m_vecPlayers) == 0x40);
        static_assert(offsetof(source2sdk::client::FantasyLeagueData_t, m_vecPeriods) == 0x58);
        
        static_assert(sizeof(source2sdk::client::FantasyLeagueData_t) == 0x70);
    };
};
