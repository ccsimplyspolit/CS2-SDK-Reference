...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float sidegunner_fire_rate; // 0x1a78
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Gyrocopter_Flak_Cannon_Scepter) == 0x1a80);
    };
};
