...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t m_nFXIndex; // 0x1a58            
            bool m_bContractGravestoneComplete; // 0x1a5c            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_PhantomAssassin_Gravestone) == 0x1a60);
    };
};
