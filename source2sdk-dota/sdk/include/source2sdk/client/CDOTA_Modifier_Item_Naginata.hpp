...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t cooldown_reduction_percent; // 0x1a8c
            std::int32_t bonus_chance; // 0x1a90
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Naginata) == 0x1a98);
    };
};
