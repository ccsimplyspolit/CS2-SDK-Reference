...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t illusion_percent_damage; // 0x1a5c            
            float pulse_interval; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Ringmaster_Spotlight_Debuff) == 0x1a68);
    };
};
