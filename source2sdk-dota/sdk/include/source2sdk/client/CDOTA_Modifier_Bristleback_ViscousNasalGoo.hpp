...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float base_armor; // 0x1a58            
            float armor_per_stack; // 0x1a5c            
            std::int32_t base_move_slow; // 0x1a60            
            std::int32_t move_slow_per_stack; // 0x1a64            
            std::int32_t stack_limit; // 0x1a68            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Bristleback_ViscousNasalGoo) == 0x1a70);
    };
};
