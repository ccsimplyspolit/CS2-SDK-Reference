...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::AI_Navigator_DebugSnapshotData_t_Waypoint_t, is_pathcorner) == 0x14);
        
        static_assert(sizeof(source2sdk::client::AI_Navigator_DebugSnapshotData_t_Waypoint_t) == 0x18);
    };
};
