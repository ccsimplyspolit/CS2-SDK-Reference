...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t level; // 0x1a78
            std::int32_t armor; // 0x1a7c
            std::int32_t mana; // 0x1a80
            float attack_range; // 0x1a84
            float armor_per_attack; // 0x1a88
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_ForgedSpirit_Stats) == 0x1a90);
    };
};
