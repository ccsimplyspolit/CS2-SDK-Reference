...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t damage_pct_per_second; // 0x1a58            
            std::int32_t movement_speed; // 0x1a5c            
            float tick_interval; // 0x1a60            
            source2sdk::entity2::GameTime_t m_fNextDamageTick; // 0x1a64            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_AghsFort_Firefly_Burn because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_AghsFort_Firefly_Burn) == 0x1a68);
    };
};
