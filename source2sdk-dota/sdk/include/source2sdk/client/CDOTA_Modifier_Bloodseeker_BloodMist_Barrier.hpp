...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::entity2::GameTime_t flLastGameTime; // 0x1a58            
            float m_flCurrentShield; // 0x1a5c            
            float barrier_decay_pct; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Bloodseeker_BloodMist_Barrier) == 0x1a68);
    };
};
