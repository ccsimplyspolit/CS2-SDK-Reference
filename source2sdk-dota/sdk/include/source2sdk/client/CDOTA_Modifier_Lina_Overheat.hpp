...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float damage_aoe; // 0x1a5c            
            float damage; // 0x1a60            
            float damage_illusions; // 0x1a64            
            std::int32_t damage_threshold; // 0x1a68            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Lina_Overheat) == 0x1a70);
    };
};
