...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float burn_tick_interval; // 0x1a58            
            float blind_duration; // 0x1a5c            
            float blind_per_second; // 0x1a60            
            std::int32_t damage_per_second; // 0x1a64            
            std::int32_t slow_movement_speed_pct; // 0x1a68            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Phoenix_IcarusDiveBurn) == 0x1a70);
    };
};
