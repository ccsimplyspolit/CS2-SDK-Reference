...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float duration_creep; // 0x1a5c            
            float delay; // 0x1a60            
            std::int32_t chance_pct; // 0x1a64            
            std::int32_t bonus_damage; // 0x1a68            
            source2sdk::entity2::GameTime_t last_attack_time; // 0x1a6c            
            ...
            char m_ProcAttackRecords[0x18]; // 0x1a70            
            source2sdk::entity2::GameTime_t apply_activity_modifier_until; // 0x1a88            
            source2sdk::entity2::GameTime_t disable_activity_modifier_until; // 0x1a8c            
