...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::ParticleIndex_t m_iIndex; // 0x6ac            
            float cooldown_reduction_on_kill; // 0x6b0            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_Sniper_Assassinate) == 0x6b8);
    };
};
