...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t radius; // 0x1aa8
            std::int32_t latch_distance; // 0x1aac
            float m_flHealthHealed; // 0x1ab0
            float m_flManaHealed; // 0x1ab4
            float tether_heal_amp; // 0x1ab8
            source2sdk::entity2::GameTime_t m_flHealMessageTime; // 0x1abc
            source2sdk::entity2::GameTime_t m_flManaMessageTime; // 0x1ac0
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Aghsfort_Elemental_Wisp_Tether) == 0x1ac8);
    };
};
