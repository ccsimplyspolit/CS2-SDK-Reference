...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t magic_resist; // 0x1a5c            
            std::int32_t debuff_immunity; // 0x1a60            
            std::int32_t movespeed_bonus; // 0x1a64            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Life_Stealer_Rage because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Life_Stealer_Rage) == 0x1a68);
    };
};
