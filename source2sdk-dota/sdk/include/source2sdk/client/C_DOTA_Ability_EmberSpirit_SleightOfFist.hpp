...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            VectorWS m_vCastLoc; // 0x6a8            
            std::int32_t m_nHeroesKilled; // 0x6b4            
            ...
            char m_hAttackEntities[0x18]; // 0x6b8            
            source2sdk::client::ParticleIndex_t m_nFXMarkerIndex; // 0x6d0            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_EmberSpirit_SleightOfFist) == 0x6d8);
    };
};
