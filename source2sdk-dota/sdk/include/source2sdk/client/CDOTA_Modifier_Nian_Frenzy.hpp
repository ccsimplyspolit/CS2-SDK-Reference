...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t damage_radius; // 0x1a5c            
            std::int32_t stun_radius; // 0x1a60            
            float dive_distance; // 0x1a64            
            float initial_rise_time; // 0x1a68            
            float right_swipe_time; // 0x1a6c            
            float left_swipe_time; // 0x1a70            
            float knockdown_duration; // 0x1a74            
            float stun_duration; // 0x1a78            
            std::int32_t m_nTickCounter; // 0x1a7c            
