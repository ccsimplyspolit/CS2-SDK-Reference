...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t damage_radius; // 0x1a7c
            std::int32_t stun_radius; // 0x1a80
            float dive_distance; // 0x1a84
            float initial_rise_time; // 0x1a88
            float right_swipe_time; // 0x1a8c
            float left_swipe_time; // 0x1a90
            float knockdown_duration; // 0x1a94
            float stun_duration; // 0x1a98
            std::int32_t m_nTickCounter; // 0x1a9c
