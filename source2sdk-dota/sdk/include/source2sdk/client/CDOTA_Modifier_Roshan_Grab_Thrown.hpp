...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            QAngle m_vStartAngle; // 0x1ab0
            QAngle m_vEndAngle; // 0x1abc
            float m_flAngleAnimDuration; // 0x1ac8
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Roshan_Grab_Thrown) == 0x1ad0);
    };
};
