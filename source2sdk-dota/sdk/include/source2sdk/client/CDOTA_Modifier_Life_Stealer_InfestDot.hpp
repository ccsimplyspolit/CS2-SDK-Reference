...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float dot_damage_as_pct_of_damage_dealt; // 0x1a58            
            float dot_tick_interval; // 0x1a5c            
            std::int32_t m_nDamagePerTick; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Life_Stealer_InfestDot) == 0x1a68);
    };
};
