...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t tick_count; // 0x1a58            
            std::int32_t beam_radius; // 0x1a5c            
            std::int32_t m_nTickCount; // 0x1a60            
            std::int32_t n_FXIndex; // 0x1a64            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Nian_EruptionPendingThinker) == 0x1a80);
    };
};
