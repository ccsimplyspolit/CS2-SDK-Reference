...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            float radius; // 0x6a8            
            float bonus_linger_duration; // 0x6ac            
            source2sdk::entity2::GameTime_t m_startDecayTime; // 0x6b0            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Ability_Axe_One_Man_Army) == 0x6b8);
    };
};
