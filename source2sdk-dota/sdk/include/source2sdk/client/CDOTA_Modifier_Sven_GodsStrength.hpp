...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t gods_strength_damage; // 0x1a58            
            std::int32_t bonus_slow_resistance; // 0x1a5c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Sven_GodsStrength because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Sven_GodsStrength) == 0x1a60);
    };
};
