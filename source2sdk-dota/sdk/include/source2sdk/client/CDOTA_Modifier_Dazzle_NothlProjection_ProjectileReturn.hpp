...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t m_nProjectileHandle; // 0x1a78
            ...
            char m_hPhysicalBody[0x4]; // 0x1a7c
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Dazzle_NothlProjection_ProjectileReturn) == 0x1a80);
    };
};
