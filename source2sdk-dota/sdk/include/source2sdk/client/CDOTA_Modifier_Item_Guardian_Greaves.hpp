...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t bonus_movement; // 0x1a78
            std::int32_t bonus_mana; // 0x1a7c
            std::int32_t bonus_mres; // 0x1a80
            std::int32_t bonus_armor; // 0x1a84
            float aura_radius; // 0x1a88
            float mana_regen; // 0x1a8c
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Item_Guardian_Greaves because it is not a standard-layout class

        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Guardian_Greaves) == 0x1a90);
    };
};
