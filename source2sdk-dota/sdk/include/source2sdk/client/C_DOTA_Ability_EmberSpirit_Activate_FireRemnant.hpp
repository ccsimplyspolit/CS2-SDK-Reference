...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t m_nProjectileID; // 0x6a8            
            VectorWS m_vStartLocation; // 0x6ac            
            VectorWS m_vProjectileLocation; // 0x6b8            
            QAngle m_ProjectileAngles; // 0x6c4            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_EmberSpirit_Activate_FireRemnant) == 0x6f0);
    };
};
