...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float shard_width; // 0x6ac            
            float shard_damage; // 0x6b0            
            std::int32_t shard_count; // 0x6b4            
            float shard_speed; // 0x6b8            
            float shard_duration; // 0x6bc            
            float shard_angle_step; // 0x6c0            
            float shard_distance; // 0x6c4            
            VectorWS m_vSpawnOrigin; // 0x6c8            
            Vector m_vDirection; // 0x6d4            
