...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t damage_per_tree; // 0x1a78
            std::int32_t slow_per_tree; // 0x1a7c
            std::int32_t m_nTreeCount; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Furion_CurseOfTheForest) == 0x1a88);
    };
};
