...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float presence_radius; // 0x1a58            
            float kill_buff_duration; // 0x1a5c            
            source2sdk::entity2::GameTime_t m_fLastStackChange; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Nevermore_Presence_Aura) == 0x1a68);
    };
};
