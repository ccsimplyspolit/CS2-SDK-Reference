...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_hVarmint[0x4]; // 0x1a78
            CEntityIndex m_nClientVarmintEntIndex; // 0x1a7c
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_JungleVarmint_Creator because it is not a standard-layout class

        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_JungleVarmint_Creator) == 0x1a80);
    };
};
