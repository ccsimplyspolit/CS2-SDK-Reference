...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t familiar_speed; // 0x1a78
            uint8_t _pad1a7c[0x4]; // 0x1a7c
            source2sdk::client::CountdownTimer m_ctTimer; // 0x1a80
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Visage_SummonFamiliars_DamageCharge) == 0x1a98);
    };
};
