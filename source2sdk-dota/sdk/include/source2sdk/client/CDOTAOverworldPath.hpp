...
#include "source2sdk/client/OverworldSplineInfo_t.hpp"
...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::OverworldSplineInfo_t m_splineInfo; // 0x30            
            // metadata: MPropertyAttributeRange "-180 180"
            float m_flCurveAngle; // 0x40            
            ...
            char m_vecRequiredTokenNames[0x18]; // 0x48            
        };
        #pragma pack(pop)
        ...
        static_assert(offsetof(source2sdk::client::CDOTAOverworldPath, m_splineInfo) == 0x30);
        static_assert(offsetof(source2sdk::client::CDOTAOverworldPath, m_flCurveAngle) == 0x40);
        static_assert(offsetof(source2sdk::client::CDOTAOverworldPath, m_vecRequiredTokenNames) == 0x48);
        
        static_assert(sizeof(source2sdk::client::CDOTAOverworldPath) == 0x60);
    };
};
