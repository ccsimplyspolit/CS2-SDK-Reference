...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::ParticleIndex_t m_nFXIndexB; // 0x6ac            
            float cooldown_reduction_on_hero_hit; // 0x6b0            
            bool m_bReadyToSetCooldown; // 0x6b4            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_Nevermore_Shadowraze) == 0x6b8);
    };
};
