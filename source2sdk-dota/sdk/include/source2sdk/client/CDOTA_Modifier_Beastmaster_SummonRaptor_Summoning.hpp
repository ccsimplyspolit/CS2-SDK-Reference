...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float hawk_spawn_interval; // 0x1a78
            std::int32_t hawk_count; // 0x1a7c
            std::int32_t m_nHawksSpawned; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Beastmaster_SummonRaptor_Summoning) == 0x1a88);
    };
};
