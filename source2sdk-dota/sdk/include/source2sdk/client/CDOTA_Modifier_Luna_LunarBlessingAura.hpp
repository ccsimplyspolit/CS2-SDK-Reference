...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t self_bonus_damage; // 0x1a7c
            std::int32_t bonus_night_vision; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Luna_LunarBlessingAura) == 0x1a88);
    };
};
