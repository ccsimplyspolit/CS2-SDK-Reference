...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t vector_cast_range; // 0x1a80
            float root_delay; // 0x1a84
            float root_duration; // 0x1a88
            float root_damage; // 0x1a8c
            float tick_interval; // 0x1a90
            // m_hThinker has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::client::C_BaseEntity> m_hThinker;
            char m_hThinker[0x4]; // 0x1a94
            source2sdk::entity2::GameTime_t m_NextDPSTime; // 0x1a98
            source2sdk::entity2::GameTime_t m_NextRootTime; // 0x1a9c
            bool m_bRootTriggered; // 0x1aa0
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Invoker_IceWall_SlowDebuff) == 0x1aa8);
    };
};
