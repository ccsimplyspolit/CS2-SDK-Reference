...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            VectorWS m_vPopupLocation; // 0x1a58            
            bool m_bTeleported; // 0x1a64            
            bool m_bPreviouslyBurrowed; // 0x1a65            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Sand_King_BurrowStrike) == 0x1a68);
    };
};
