...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t overload_damage; // 0x1a7c
            std::int32_t shard_attack_speed_bonus; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_StormSpirit_Electric_Rave) == 0x1a88);
    };
};
