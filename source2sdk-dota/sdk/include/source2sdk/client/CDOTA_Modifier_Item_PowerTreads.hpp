...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t bonus_movement_speed_ranged; // 0x1a58            
            std::int32_t bonus_movement_speed_melee; // 0x1a5c            
            std::int32_t bonus_attack_speed; // 0x1a60            
            std::int32_t bonus_stat; // 0x1a64            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_PowerTreads) == 0x1a70);
    };
};
