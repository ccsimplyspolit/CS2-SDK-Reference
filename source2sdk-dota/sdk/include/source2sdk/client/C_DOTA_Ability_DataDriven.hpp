...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float m_fAOERadius; // 0x6ac            
            std::int32_t m_CastAnimation; // 0x6b0            
            ...
            KeyValues* m_pOnUpgradeKV; // 0x6f8            
            KeyValues* m_pOnProjectileHitUnitKV; // 0x700            
            KeyValues* m_pOnProjectileFinishKV; // 0x708            
            KeyValues* m_pOnSpellStartKV; // 0x710            
            KeyValues* m_pOnAbilityPhaseStartKV; // 0x718            
            KeyValues* m_pOnAbilityPhaseInterruptedKV; // 0x720            
            KeyValues* m_pOnToggleOnKV; // 0x728            
            KeyValues* m_pOnToggleOffKV; // 0x730            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_DataDriven) == 0x740);
    };
};
