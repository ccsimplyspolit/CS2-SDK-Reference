...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::DOTASpecialAbilityBonus_t m_PerLevelUpBonus; // 0x60            
            ...
            std::uint8_t m_unLevelUpInterval; // 0x108            
            std::uint8_t m_unLevelUpBonusRequiredLevel; // 0x109            
            bool m_bSpellDamageField; // 0x10a            
            bool m_bRequiresScepterField; // 0x10b            
            bool m_bRequiresShardField; // 0x10c            
            bool m_bAffectedByAoEIncrease; // 0x10d            
            bool m_bDynamicValue; // 0x10e            
            bool m_bAffectedByCurio; // 0x10f            
            bool m_bShowAbsoluteValues; // 0x110            
        ...
        static_assert(offsetof(source2sdk::client::DOTASpecialAbility_t, m_PerLevelUpBonus) == 0x60);
        ...
        static_assert(offsetof(source2sdk::client::DOTASpecialAbility_t, m_unLevelUpInterval) == 0x108);
        static_assert(offsetof(source2sdk::client::DOTASpecialAbility_t, m_unLevelUpBonusRequiredLevel) == 0x109);
        static_assert(offsetof(source2sdk::client::DOTASpecialAbility_t, m_bSpellDamageField) == 0x10a);
        static_assert(offsetof(source2sdk::client::DOTASpecialAbility_t, m_bRequiresScepterField) == 0x10b);
        static_assert(offsetof(source2sdk::client::DOTASpecialAbility_t, m_bRequiresShardField) == 0x10c);
        static_assert(offsetof(source2sdk::client::DOTASpecialAbility_t, m_bAffectedByAoEIncrease) == 0x10d);
        static_assert(offsetof(source2sdk::client::DOTASpecialAbility_t, m_bDynamicValue) == 0x10e);
        static_assert(offsetof(source2sdk::client::DOTASpecialAbility_t, m_bAffectedByCurio) == 0x10f);
        static_assert(offsetof(source2sdk::client::DOTASpecialAbility_t, m_bShowAbsoluteValues) == 0x110);
        
        static_assert(sizeof(source2sdk::client::DOTASpecialAbility_t) == 0x118);
    };
};
