...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float flesh_heap_range; // 0x1a58            
            float flesh_heap_strength_buff_amount; // 0x1a5c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Pudge_GraftFlesh because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Pudge_GraftFlesh) == 0x1a60);
    };
};
