...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t max_steps; // 0x6a8            
            VectorWS m_vTarget; // 0x6ac            
            Vector m_vDir; // 0x6b8            
            std::int32_t m_nSteps; // 0x6c4            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_AghsFort_StonehallGeneral_OverwhelmingOdds) == 0x6d0);
    };
};
