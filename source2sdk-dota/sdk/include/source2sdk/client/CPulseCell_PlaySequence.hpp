...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            CUtlString m_SequenceName; // 0xd8            
            source2sdk::pulse_runtime_lib::PulseNodeDynamicOutflows_t m_PulseAnimEvents; // 0xe0            
        ...
        static_assert(sizeof(source2sdk::client::CPulseCell_PlaySequence) == 0x140);
    };
};
