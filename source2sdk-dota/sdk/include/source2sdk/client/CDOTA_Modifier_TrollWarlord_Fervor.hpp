...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t stack_limit_during_battle_trance; // 0x1a7c
            std::int32_t extra_attack_chance_per_stack; // 0x1a80
            std::int32_t base_chance; // 0x1a84
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_TrollWarlord_Fervor) == 0x1a90);
    };
};
