...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float mana_pct_per_hit; // 0x1a78
            std::int32_t creep_penalty_reduction_pct; // 0x1a7c
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Leshrac_ChronopticNourishment) == 0x1a80);
    };
};
