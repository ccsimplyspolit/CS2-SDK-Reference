...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            VectorWS m_vPullLocation; // 0x6ac            
            float push_radius; // 0x6b8            
            float max_knockback_distance; // 0x6bc            
            float pull_radius; // 0x6c0            
            float flEffectRadius; // 0x6c4            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Ability_Magnataur_ReversePolarity because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Ability_Magnataur_ReversePolarity) == 0x6c8);
    };
};
