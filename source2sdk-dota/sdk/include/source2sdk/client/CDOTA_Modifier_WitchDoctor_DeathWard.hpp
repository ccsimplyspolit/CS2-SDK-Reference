...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t bonus_accuracy; // 0x1a7c
            std::int32_t bonus_attack_range; // 0x1a80
            bool m_bFirstAttack; // 0x1a84
            uint8_t _pad1a85[0x3]; // 0x1a85
            std::int32_t initial_target_count; // 0x1a88
            std::int32_t secondary_attack_damage_pct; // 0x1a8c
            uint8_t _pad1a90[0x38];
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_WitchDoctor_DeathWard because it is not a standard-layout class

        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_WitchDoctor_DeathWard) == 0x1ac8);
    };
};
