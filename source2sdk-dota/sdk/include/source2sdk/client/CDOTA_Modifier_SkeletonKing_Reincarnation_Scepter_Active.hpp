...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t scepter_move_speed_pct; // 0x1a78
            std::int32_t scepter_attack_speed; // 0x1a7c
            // m_hTarget has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::client::C_BaseEntity> m_hTarget;
            char m_hTarget[0x4]; // 0x1a80
            bool m_bPassive; // 0x1a84
            bool m_bKillAtEnd; // 0x1a85
            uint8_t _pad1a86[0x2];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_SkeletonKing_Reincarnation_Scepter_Active) == 0x1a88);
    };
};
