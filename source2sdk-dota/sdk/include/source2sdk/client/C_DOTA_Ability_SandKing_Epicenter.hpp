...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::client::ParticleIndex_t m_nFXEpicenterIndex; // 0x6a8            
            std::int32_t m_iExplosionQuadrant; // 0x6ac            
            std::int32_t m_iExplosionDistance; // 0x6b0            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_SandKing_Epicenter) == 0x6b8);
    };
};
