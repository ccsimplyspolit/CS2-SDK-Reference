...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t m_nAffectedAbilities; // 0x1a5c            
            source2sdk::entity2::GameTime_t m_flLastDamageTime; // 0x1a60            
            std::int32_t slow; // 0x1a64            
            std::int32_t cooldown_percentage; // 0x1a68            
            std::int32_t damage_per_stack; // 0x1a6c            
            std::int32_t base_damage; // 0x1a70            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_FacelessVoid_TimeDilation_Slow) == 0x1a78);
    };
};
