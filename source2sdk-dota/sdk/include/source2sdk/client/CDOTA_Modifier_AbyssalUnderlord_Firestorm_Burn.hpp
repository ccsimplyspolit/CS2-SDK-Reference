...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float burn_damage; // 0x1a78
            float burn_interval; // 0x1a7c
            float building_damage; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_AbyssalUnderlord_Firestorm_Burn) == 0x1a88);
    };
};
