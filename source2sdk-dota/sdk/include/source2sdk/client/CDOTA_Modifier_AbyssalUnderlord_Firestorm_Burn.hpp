...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float burn_damage; // 0x1a58            
            float burn_interval; // 0x1a5c            
            float building_damage; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_AbyssalUnderlord_Firestorm_Burn) == 0x1a68);
    };
};
