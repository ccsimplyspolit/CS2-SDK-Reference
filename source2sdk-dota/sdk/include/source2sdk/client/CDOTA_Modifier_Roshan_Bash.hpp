...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t bash_chance; // 0x1a78
            std::int32_t bonus_damage; // 0x1a7c
            float stun_duration; // 0x1a80
            source2sdk::entity2::GameTime_t last_attack_time; // 0x1a84
            ...
            char m_ProcAttackRecords[0x18]; // 0x1a88
            source2sdk::entity2::GameTime_t apply_activity_modifier_until; // 0x1aa0
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Roshan_Bash) == 0x1aa8);
    };
};
