...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            bool m_bIllusion; // 0x1a7c
            bool m_bArcWardenClone; // 0x1a7d
            bool m_bSpiritBear; // 0x1a7e
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Necrolyte_ReapersScythe) == 0x1a80);
    };
};
