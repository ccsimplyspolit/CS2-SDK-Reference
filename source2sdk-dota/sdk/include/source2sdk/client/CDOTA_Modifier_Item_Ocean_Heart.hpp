...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float water_hp_regen; // 0x1a78
            float water_mp_regen; // 0x1a7c
            std::int32_t all_stats; // 0x1a80
            bool m_bInRiver; // 0x1a84
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Ocean_Heart) == 0x1a88);
    };
};
