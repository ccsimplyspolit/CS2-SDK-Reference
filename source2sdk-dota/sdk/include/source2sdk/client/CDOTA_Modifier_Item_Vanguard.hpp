...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t block_damage_ranged; // 0x1a60            
            std::int32_t block_damage_melee; // 0x1a64            
            std::int32_t block_chance; // 0x1a68            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Vanguard) == 0x1a70);
    };
};
