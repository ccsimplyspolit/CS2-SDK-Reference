...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t pit_damage; // 0x1a58            
            float radius; // 0x1a5c            
            float pit_interval; // 0x1a60            
            float ensnare_duration; // 0x1a64            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_AbyssalUnderlord_PitOfMalice_Thinker) == 0x1a68);
    };
};
