...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t bonus_cast_speed; // 0x1a60            
            std::int32_t bonus_turn_speed; // 0x1a64            
            std::int32_t cooldown_acceleration; // 0x1a68            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_FacelessVoid_TimeZone_Effect) == 0x1a70);
    };
};
