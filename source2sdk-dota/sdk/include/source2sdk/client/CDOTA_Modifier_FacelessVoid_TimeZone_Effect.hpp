...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t bonus_cast_speed; // 0x1a80
            std::int32_t bonus_turn_speed; // 0x1a84
            std::int32_t cooldown_acceleration; // 0x1a88
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_FacelessVoid_TimeZone_Effect) == 0x1a90);
    };
};
