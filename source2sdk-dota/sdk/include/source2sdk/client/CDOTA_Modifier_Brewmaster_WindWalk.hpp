...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t bonus_movement_speeed; // 0x1a68            
            std::int32_t bonus_damage; // 0x1a6c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Brewmaster_WindWalk because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Brewmaster_WindWalk) == 0x1a70);
    };
};
