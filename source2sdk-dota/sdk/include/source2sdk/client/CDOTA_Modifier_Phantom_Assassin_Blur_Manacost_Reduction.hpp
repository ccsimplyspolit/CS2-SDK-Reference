...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t manacost_reduction_after_blur_pct; // 0x1a78
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Phantom_Assassin_Blur_Manacost_Reduction) == 0x1a80);
    };
};
