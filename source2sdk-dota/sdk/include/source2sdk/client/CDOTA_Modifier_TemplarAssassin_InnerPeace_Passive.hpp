...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::CountdownTimer m_StartMeditationTimer; // 0x1a70            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_TemplarAssassin_InnerPeace_Passive) == 0x1aa0);
    };
};
