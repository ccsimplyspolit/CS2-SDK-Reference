...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t slow_melee; // 0x1a58            
            std::int32_t slow_ranged; // 0x1a5c            
            std::int32_t heal_reduction; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Orb_Of_Frost_Debuff) == 0x1a68);
    };
};
