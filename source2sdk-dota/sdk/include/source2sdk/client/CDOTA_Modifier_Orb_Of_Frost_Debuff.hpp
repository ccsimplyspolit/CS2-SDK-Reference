...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t slow_melee; // 0x1a78
            std::int32_t slow_ranged; // 0x1a7c
            std::int32_t heal_reduction; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Orb_Of_Frost_Debuff) == 0x1a88);
    };
};
