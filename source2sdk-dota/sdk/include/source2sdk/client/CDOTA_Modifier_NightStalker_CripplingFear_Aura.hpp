...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            float radius; // 0x1a78
            std::int32_t death_refresh; // 0x1a7c
            float mana_pct_cost; // 0x1a80
            float mana_interval; // 0x1a84
            source2sdk::client::ParticleIndex_t m_nFXIndex; // 0x1a88
            float base_duration; // 0x1a8c
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_NightStalker_CripplingFear_Aura) == 0x1aa8);
    };
};
