...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CDOTA_Item_Tidehunter_Fish : public source2sdk::client::C_DOTA_Item
        {
        public:
            // m_hPickupOwner has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::client::C_BaseEntity> m_hPickupOwner;
            char m_hPickupOwner[0x4]; // 0x758            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Item_Tidehunter_Fish) == 0x760);
    };
};
