...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float multiplier; // 0x1a58            
            std::int32_t movespeed_bonus; // 0x1a5c            
            std::int32_t attackspeed_bonus; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Visage_GraveChill_Buff) == 0x1a68);
    };
};
