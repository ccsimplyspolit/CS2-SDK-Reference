...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float multiplier; // 0x1a78
            std::int32_t movespeed_bonus; // 0x1a7c
            std::int32_t attackspeed_bonus; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Visage_GraveChill_Buff) == 0x1a88);
    };
};
