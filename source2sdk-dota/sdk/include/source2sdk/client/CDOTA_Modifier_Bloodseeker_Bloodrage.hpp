...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t attack_speed; // 0x1a58            
            std::int32_t spell_amp; // 0x1a5c            
            float max_health_dmg_pct; // 0x1a60            
            float damage_pct; // 0x1a64            
            float base_damage_amp; // 0x1a68            
            float flTickRate; // 0x1a6c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Bloodseeker_Bloodrage because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Bloodseeker_Bloodrage) == 0x1a70);
    };
};
