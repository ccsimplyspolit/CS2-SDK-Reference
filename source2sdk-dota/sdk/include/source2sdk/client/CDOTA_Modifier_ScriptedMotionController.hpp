...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            HSCRIPT m_hHorizontalControlFunction; // 0x1a78
            HSCRIPT m_hVerticalControlFunction; // 0x1a80
            HSCRIPT m_hOnDestroyFunction; // 0x1a88
            ...
            char m_parameterTable[0x10]; // 0x1a90
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_ScriptedMotionController because it is not a standard-layout class

        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_ScriptedMotionController) == 0x1aa0);
    };
};
