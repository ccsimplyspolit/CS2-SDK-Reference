...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t multishot_arrow_bonus; // 0x1a78
            std::int32_t end_height; // 0x1a7c
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Drow_Ranger_Glacier_Hilltop) == 0x1a88);
    };
};
