...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float regen; // 0x1a7c
            bool m_bStackCountChanged; // 0x1a80
            ...
            char m_fStackExpireTimes[0x18]; // 0x1a88
            float bonus_aoe; // 0x1aa0
            float bonus_spell_amp; // 0x1aa4
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Necrolyte_Sadist because it is not a standard-layout class

        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Necrolyte_Sadist) == 0x1aa8);
    };
};
