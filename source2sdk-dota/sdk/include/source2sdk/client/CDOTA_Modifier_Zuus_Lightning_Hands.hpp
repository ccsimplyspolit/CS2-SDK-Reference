...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t arc_lightning_damage_pct; // 0x1a94
            std::int32_t arc_lightning_damage_illusion_pct; // 0x1a98
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Zuus_Lightning_Hands) == 0x1aa0);
    };
};
