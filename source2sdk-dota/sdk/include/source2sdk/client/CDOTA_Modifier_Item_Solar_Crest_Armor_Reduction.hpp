...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t target_armor; // 0x1a78
            std::int32_t target_attack_speed; // 0x1a7c
            std::int32_t target_movement_speed; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Solar_Crest_Armor_Reduction) == 0x1a88);
    };
};
