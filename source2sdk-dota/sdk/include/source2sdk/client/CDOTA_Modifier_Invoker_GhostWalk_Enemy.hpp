...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t enemy_slow; // 0x1a78
            std::int32_t apply_ice_wall_debuff; // 0x1a7c
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Invoker_GhostWalk_Enemy because it is not a standard-layout class

        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Invoker_GhostWalk_Enemy) == 0x1a80);
    };
};
