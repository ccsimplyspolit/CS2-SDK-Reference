...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float bounce_radius; // 0x6c0            
            float damage_radius; // 0x6c4            
            std::int32_t damage; // 0x6c8            
            std::int32_t max_targets; // 0x6cc            
            float scepter_heal_pct; // 0x6d0            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_Dazzle_ShadowWave) == 0x6d8);
    };
};
