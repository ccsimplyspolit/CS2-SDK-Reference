...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t m_nDamagePerTick; // 0x1a78
            source2sdk::client::ParticleIndex_t m_nBleedFXIndex; // 0x1a7c
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Kez_Katana_Bleed because it is not a standard-layout class

        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Kez_Katana_Bleed) == 0x1a80);
    };
};
