...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float sigil_radius; // 0x1a78
            source2sdk::client::ParticleIndex_t m_iParticleIndex; // 0x1a7c
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Tusk_FrozenSigil_Aura because it is not a standard-layout class

        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Tusk_FrozenSigil_Aura) == 0x1a80);
    };
};
