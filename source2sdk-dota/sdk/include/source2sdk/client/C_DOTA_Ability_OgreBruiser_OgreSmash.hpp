...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            float radius; // 0x6a8            
            float hero_stun_duration; // 0x6ac            
            float damage; // 0x6b0            
            float damage_pct; // 0x6b4            
            source2sdk::entity2::GameTime_t flCooldown; // 0x6b8            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_OgreBruiser_OgreSmash) == 0x6c0);
    };
};
