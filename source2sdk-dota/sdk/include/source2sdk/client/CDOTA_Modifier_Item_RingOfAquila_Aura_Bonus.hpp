...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t aura_bonus_armor; // 0x1a58            
            float aura_mana_regen; // 0x1a5c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Item_RingOfAquila_Aura_Bonus because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_RingOfAquila_Aura_Bonus) == 0x1a60);
    };
};
