...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t attack_damage; // 0x1a58            
            std::int32_t creep_damage_penalty; // 0x1a5c            
            std::int32_t inner_radius_bonus_damage_pct; // 0x1a60            
            bool m_bIsInnerRadiusHit; // 0x1a64            
            uint8_t _pad1a65[0x3]; // 0x1a65
            float damage_pct; // 0x1a68            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Sand_King_Scorpion_Strike_Attack_Bonus) == 0x1a70);
    };
};
