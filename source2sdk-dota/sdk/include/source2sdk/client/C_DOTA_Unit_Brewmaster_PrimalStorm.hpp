...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::client::ParticleIndex_t m_nFXStormAmbient1; // 0x19c0
            source2sdk::client::ParticleIndex_t m_nFXStormAmbient2; // 0x19c4
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in C_DOTA_Unit_Brewmaster_PrimalStorm because it is not a standard-layout class

        static_assert(sizeof(source2sdk::client::C_DOTA_Unit_Brewmaster_PrimalStorm) == 0x19c8);
    };
};
