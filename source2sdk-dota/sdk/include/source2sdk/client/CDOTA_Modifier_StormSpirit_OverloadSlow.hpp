...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t overload_move_slow; // 0x1a58            
            std::int32_t overload_attack_slow; // 0x1a5c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_StormSpirit_OverloadSlow because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_StormSpirit_OverloadSlow) == 0x1a60);
    };
};
