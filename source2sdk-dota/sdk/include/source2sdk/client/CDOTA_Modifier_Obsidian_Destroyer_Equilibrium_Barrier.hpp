...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float barrier_amt; // 0x1a78
            std::int32_t m_nDamageAbsorbed; // 0x1a7c
            bool undispellable; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Obsidian_Destroyer_Equilibrium_Barrier) == 0x1a88);
    };
};
