...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t cast_range_limit; // 0x1a78
            std::int32_t bonus_spell_amp; // 0x1a7c
            std::int32_t backstab_duration; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Caster_Rapier) == 0x1aa0);
    };
};
