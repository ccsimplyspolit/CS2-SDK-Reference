...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float attrib_bonus; // 0x1a5c            
            float hurt_attrib_bonus; // 0x1a60            
            float hurt_percent; // 0x1a64            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Huskar_Inner_Vitality because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Huskar_Inner_Vitality) == 0x1a68);
    };
};
