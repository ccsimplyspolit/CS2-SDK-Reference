...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t m_iCapturingTeam; // 0x1a78
            float m_flCaptureProgress; // 0x1a7c
            float m_flBonusTime; // 0x1a80
            bool m_bInitialSetupDone; // 0x1a84
            uint8_t _pad1a85[0x3]; // 0x1a85
            std::int32_t m_iOriginalTeam; // 0x1a88
            ...
            char m_hPreviousHero[0x4]; // 0x1a8c
            ...
            char m_vecLastCreditedPlayerIDs[0x18]; // 0x1a90
            float m_flAccumulatedCaptureTime; // 0x1aa8
            std::int32_t m_iBonusCount; // 0x1aac
            source2sdk::client::ParticleIndex_t m_nFxOutpostAmbient; // 0x1ab0
            source2sdk::client::ParticleIndex_t m_nFxOutpostInitialAmbient; // 0x1ab4
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Watch_Tower because it is not a standard-layout class

        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Watch_Tower) == 0x1ab8);
    };
};
