...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t m_iCapturingTeam; // 0x1a58            
            float m_flCaptureProgress; // 0x1a5c            
            float m_flBonusTime; // 0x1a60            
            bool m_bInitialSetupDone; // 0x1a64            
            uint8_t _pad1a65[0x3]; // 0x1a65
            std::int32_t m_iOriginalTeam; // 0x1a68            
            ...
            char m_hPreviousHero[0x4]; // 0x1a6c            
            ...
            char m_vecLastCreditedPlayerIDs[0x18]; // 0x1a70            
            float m_flAccumulatedCaptureTime; // 0x1a88            
            std::int32_t m_iBonusCount; // 0x1a8c            
            source2sdk::client::ParticleIndex_t m_nFxOutpostAmbient; // 0x1a90            
            source2sdk::client::ParticleIndex_t m_nFxOutpostInitialAmbient; // 0x1a94            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Watch_Tower because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Watch_Tower) == 0x1a98);
    };
};
