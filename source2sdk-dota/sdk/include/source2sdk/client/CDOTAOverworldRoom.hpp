...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // metadata: MPropertyDescription "The background image of this room."
            CPanoramaImageName m_strBackgroundImage; // 0x18            
            ...
            source2sdk::client::OverworldNodeID_t m_unUnlockedByNodeID; // 0x40            
            uint8_t _pad0042[0x26];
        };
        #pragma pack(pop)
        ...
        static_assert(offsetof(source2sdk::client::CDOTAOverworldRoom, m_strBackgroundImage) == 0x18);
        static_assert(offsetof(source2sdk::client::CDOTAOverworldRoom, m_vecNodes) == 0x28);
        static_assert(offsetof(source2sdk::client::CDOTAOverworldRoom, m_unUnlockedByNodeID) == 0x40);
        
        static_assert(sizeof(source2sdk::client::CDOTAOverworldRoom) == 0x68);
    };
};
