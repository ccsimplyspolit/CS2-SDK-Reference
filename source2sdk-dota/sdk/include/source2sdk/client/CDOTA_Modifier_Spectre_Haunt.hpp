...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t destroy_if_target_is_dead; // 0x1a58            
            source2sdk::entity2::GameTime_t m_fStartAttackTime; // 0x1a5c            
            // m_hTarget has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::client::C_BaseEntity> m_hTarget;
            char m_hTarget[0x4]; // 0x1a60            
            bool m_bTargetIsAlive; // 0x1a64            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Spectre_Haunt) == 0x1a68);
    };
};
