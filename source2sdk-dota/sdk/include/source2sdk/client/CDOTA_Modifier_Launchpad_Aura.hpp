...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_hNextNode[0x4]; // 0x1a58            
            Vector m_vDirection; // 0x1a5c            
            float m_flDistance; // 0x1a68            
            float radius; // 0x1a6c            
            float vision_cone; // 0x1a70            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Launchpad_Aura) == 0x1a78);
    };
};
