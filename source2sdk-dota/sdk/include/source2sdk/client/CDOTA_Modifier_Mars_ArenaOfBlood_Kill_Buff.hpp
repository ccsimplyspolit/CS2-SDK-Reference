...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t arena_kill_buff_damage_pct; // 0x1a58            
            std::int32_t arena_kill_buff_heal_pct; // 0x1a5c            
            std::int32_t allied_reduction_pct; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Mars_ArenaOfBlood_Kill_Buff) == 0x1a68);
    };
};
