...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float upgrade_rate; // 0x1a58            
            std::int32_t status_resistance_per_upgrade; // 0x1a5c            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Primal_Beast_Innate_Status_Resistance_Per_Time) == 0x1a60);
    };
};
