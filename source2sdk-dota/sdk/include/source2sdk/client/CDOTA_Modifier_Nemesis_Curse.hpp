...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t debuff_self; // 0x1a58            
            float debuff_enemy; // 0x1a5c            
            std::int32_t debuff_enemy_duration; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Nemesis_Curse) == 0x1a68);
    };
};
