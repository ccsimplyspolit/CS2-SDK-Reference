...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float shard_trail_radius; // 0x1a84
            float shard_debuff_linger_duration; // 0x1a88
            float shard_interval; // 0x1a8c
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Special_Mars_Spear_Burning_Trail_Thinker) == 0x1a90);
    };
};
