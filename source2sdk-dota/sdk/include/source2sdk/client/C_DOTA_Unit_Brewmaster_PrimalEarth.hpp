...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::client::ParticleIndex_t m_nFXEarthAmbient1; // 0x19b8            
            source2sdk::client::ParticleIndex_t m_nFXEarthAmbient2; // 0x19bc            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_DOTA_Unit_Brewmaster_PrimalEarth because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_DOTA_Unit_Brewmaster_PrimalEarth) == 0x19c0);
    };
};
