...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::client::ParticleIndex_t m_iRangeFX; // 0x19b8
            bool m_bShowPlacementRadius; // 0x19bc
            uint8_t _pad19bd[0x3];
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in C_DOTA_NPC_TechiesMines because it is not a standard-layout class

        static_assert(sizeof(source2sdk::client::C_DOTA_NPC_TechiesMines) == 0x19c0);
    };
};
