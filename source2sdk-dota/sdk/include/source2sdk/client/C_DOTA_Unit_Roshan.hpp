...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t m_iKillerTeam; // 0x19b8
            std::int32_t m_iLastHealthPercent; // 0x19bc
            source2sdk::client::ParticleIndex_t m_nFXIndex; // 0x19c0
            ...
            char m_hRadiantRoshanPit[0x4]; // 0x19c4
            ...
            char m_hDireRoshanPit[0x4]; // 0x19c8
            ...
            char m_hRiverMidpoint[0x4]; // 0x19cc
            ...
            char m_hAttackingHeroes[0x18]; // 0x19d0
            bool m_bGoldenRoshan; // 0x19e8
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Unit_Roshan) == 0x19f0);
    };
};
