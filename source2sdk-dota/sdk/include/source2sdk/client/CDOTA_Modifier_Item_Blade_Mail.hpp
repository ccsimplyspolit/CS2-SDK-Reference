...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t passive_reflection_constant; // 0x1a84
            std::int32_t passive_reflection_pct; // 0x1a88
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Blade_Mail) == 0x1a90);
    };
};
