...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t aura_damage; // 0x1a8c
            std::int32_t aura_damage_upgrade_bonus; // 0x1a90
            std::int32_t aura_damage_illusions; // 0x1a94
            std::int32_t blind_pct; // 0x1a98
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Radiance_Debuff) == 0x1aa0);
    };
};
