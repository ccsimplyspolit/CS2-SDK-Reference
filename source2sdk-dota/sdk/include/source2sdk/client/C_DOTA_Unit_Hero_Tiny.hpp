...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_hTreeWearable[0x4]; // 0x1d88
            source2sdk::client::ParticleIndex_t m_nFXIndexScepterAmbient; // 0x1d8c
            ...
            char m_hIllusionOwner[0x4]; // 0x1d90
            bool m_bIllusionHasTree; // 0x1d94
            uint8_t _pad1d95[0x3];
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in C_DOTA_Unit_Hero_Tiny because it is not a standard-layout class

        static_assert(sizeof(source2sdk::client::C_DOTA_Unit_Hero_Tiny) == 0x1d98);
    };
};
