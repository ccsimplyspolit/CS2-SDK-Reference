...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            float charge_speed; // 0x1a5c            
            float movement_turn_rate; // 0x1a60            
            float knockback_radius; // 0x1a64            
            float knockback_distance; // 0x1a68            
            std::int32_t knockback_damage; // 0x1a6c            
            std::int32_t m_nEnemyHeroesHit; // 0x1a70            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_PrimalBeast_Onslaught_Movement) == 0x1a98);
    };
};
