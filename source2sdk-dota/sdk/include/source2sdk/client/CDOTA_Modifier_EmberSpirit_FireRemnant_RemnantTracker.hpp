...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_vActiveRemnants[0x18]; // 0x1a78
            ...
            char m_vTrackingDelayedRemnants[0x18]; // 0x1a90
            float shard_charge_radius; // 0x1aa8
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_EmberSpirit_FireRemnant_RemnantTracker) == 0x1ab0);
    };
};
