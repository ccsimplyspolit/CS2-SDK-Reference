...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::client::PlayerID_t m_nVictimPlayerID; // 0x19b0            
            uint8_t _pad19b4[0xa4];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_DOTA_PhantomAssassin_Gravestone because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_DOTA_PhantomAssassin_Gravestone) == 0x1a58);
    };
};
