...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t attack_speed_share_percent; // 0x1a5c            
            std::int32_t m_nAttackSpeed; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_TrollWarlord_BattleTrance_Ally) == 0x1a68);
    };
};
