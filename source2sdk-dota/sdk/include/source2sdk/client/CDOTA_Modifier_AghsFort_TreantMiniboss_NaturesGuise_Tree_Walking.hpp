...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t movement_bonus; // 0x1a58            
            std::int32_t regen_amp; // 0x1a5c            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_AghsFort_TreantMiniboss_NaturesGuise_Tree_Walking) == 0x1a60);
    };
};
