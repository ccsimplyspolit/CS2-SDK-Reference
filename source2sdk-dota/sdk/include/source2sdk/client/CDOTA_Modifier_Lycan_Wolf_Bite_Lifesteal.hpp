...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float creep_penalty; // 0x1a58            
            float lifesteal_percent; // 0x1a5c            
            float lifesteal_range; // 0x1a60            
