...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // metadata: MPropertyDescription "If we should display that this reward is already owned in the user's inventory"
            bool m_bDisplayIfAlreadyOwned; // 0x10            
            uint8_t _pad0011[0x2f];
        };
        #pragma pack(pop)
        ...
        static_assert(offsetof(source2sdk::client::CandyShopRewardOption_t, m_bDisplayIfAlreadyOwned) == 0x10);
