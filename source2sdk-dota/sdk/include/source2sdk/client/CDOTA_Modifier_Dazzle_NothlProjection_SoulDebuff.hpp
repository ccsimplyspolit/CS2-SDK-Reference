...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t ethereal_damage_bonus; // 0x1a58            
            std::int32_t movement_slow; // 0x1a5c            
            ...
            char m_hPhysicalBody[0x4]; // 0x1a60            
            source2sdk::client::ParticleIndex_t m_nTetherFXIndex; // 0x1a64            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Dazzle_NothlProjection_SoulDebuff) == 0x1a68);
    };
};
