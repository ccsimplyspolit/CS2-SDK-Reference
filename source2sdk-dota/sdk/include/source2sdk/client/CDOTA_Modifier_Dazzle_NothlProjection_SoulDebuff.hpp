...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t ethereal_damage_bonus; // 0x1a78
            std::int32_t movement_slow; // 0x1a7c
            ...
            char m_hPhysicalBody[0x4]; // 0x1a80
            source2sdk::client::ParticleIndex_t m_nTetherFXIndex; // 0x1a84
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Dazzle_NothlProjection_SoulDebuff) == 0x1a88);
    };
};
