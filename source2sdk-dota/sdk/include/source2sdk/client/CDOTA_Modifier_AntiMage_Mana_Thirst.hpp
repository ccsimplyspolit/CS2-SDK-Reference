...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t threshold_pct; // 0x1a58            
            float bonus_attack_damage; // 0x1a5c            
            float linger_duration; // 0x1a60            
            std::int32_t min_bonus_pct; // 0x1a64            
            std::int32_t max_bonus_pct; // 0x1a68            
            float thirst_range; // 0x1a6c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_AntiMage_Mana_Thirst because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_AntiMage_Mana_Thirst) == 0x1a70);
    };
};
