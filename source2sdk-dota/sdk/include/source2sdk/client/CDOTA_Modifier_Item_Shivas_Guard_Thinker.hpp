...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            std::int32_t blast_speed; // 0x1ab0
            float blast_radius; // 0x1ab4
            std::int32_t blast_damage; // 0x1ab8
            float blast_debuff_duration; // 0x1abc
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Item_Shivas_Guard_Thinker because it is not a standard-layout class

        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Shivas_Guard_Thinker) == 0x1ac0);
    };
};
