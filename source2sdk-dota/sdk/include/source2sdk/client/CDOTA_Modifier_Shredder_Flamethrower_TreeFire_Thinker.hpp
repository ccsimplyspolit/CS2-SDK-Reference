...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_vecTreeFires[0x18]; // 0x1a78
            bool m_bCleanupWhenEmpty; // 0x1a90
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Shredder_Flamethrower_TreeFire_Thinker) == 0x1a98);
    };
};
