...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t self_slow; // 0x1a78
            source2sdk::client::ParticleIndex_t m_nFXIndex; // 0x1a7c
            // m_hTarget has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::client::C_BaseEntity> m_hTarget;
            char m_hTarget[0x4]; // 0x1a80
            bool m_bFetchingRune; // 0x1a84
            uint8_t _pad1a85[0x3]; // 0x1a85
            VectorWS m_vPreviousLoc; // 0x1a88
            std::int32_t drag_distance; // 0x1a94
            std::int32_t break_distance; // 0x1a98
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_LoneDruid_SpiritBear_Fetch_Self) == 0x1aa0);
    };
};
