...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            VectorWS m_vStartLoc; // 0x1a58            
            bool m_bIsReflection; // 0x1a64            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Kunkka_XMarksTheSpot_Thinker) == 0x1a70);
    };
};
