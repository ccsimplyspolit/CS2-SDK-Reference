...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t pull_distance; // 0x1a78
            std::int32_t damage; // 0x1a7c
            float pull_duration; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Brewmaster_Void_Astral_Pull_Movement) == 0x1a88);
    };
};
