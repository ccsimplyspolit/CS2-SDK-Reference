...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            float radius; // 0x1a58            
            std::int32_t ally_speed; // 0x1a5c            
            float ally_armor; // 0x1a60            
            float ally_healing; // 0x1a64            
            float ally_buff_duration; // 0x1a68            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Invoker_IceWall_AllyBuffAura) == 0x1a70);
    };
};
