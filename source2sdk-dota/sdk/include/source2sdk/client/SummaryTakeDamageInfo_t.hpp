...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::SummaryTakeDamageInfo_t, hTarget) == 0x130);
        
        static_assert(sizeof(source2sdk::client::SummaryTakeDamageInfo_t) == 0x138);
    };
};
