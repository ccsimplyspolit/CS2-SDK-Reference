...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_hTeleportTarget[0x4]; // 0x6b0            
            source2sdk::client::ParticleIndex_t m_nTPFXIndex; // 0x6b4            
            source2sdk::client::ParticleIndex_t m_nAoEFXIndex; // 0x6b8            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_Dawnbreaker_Solar_Guardian) == 0x6c0);
    };
};
