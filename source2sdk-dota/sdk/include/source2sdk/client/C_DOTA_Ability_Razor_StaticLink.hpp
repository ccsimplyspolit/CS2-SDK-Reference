...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t m_iLinkIndex; // 0x6a8            
            uint8_t _pad06ac[0x4]; // 0x6ac
            source2sdk::client::CountdownTimer m_ViewerTimer; // 0x6b0            
            float vision_duration; // 0x6c8            
            bool m_bIsAltCastState; // 0x6cc            
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_Razor_StaticLink) == 0x6d0);
    };
};
