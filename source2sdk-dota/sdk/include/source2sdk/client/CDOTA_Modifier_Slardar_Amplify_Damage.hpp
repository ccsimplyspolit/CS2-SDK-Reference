...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t armor_reduction; // 0x1a78
            float scepter_delay; // 0x1a7c
            std::int32_t undispellable; // 0x1a80
            float puddle_radius; // 0x1a84
            float puddle_duration; // 0x1a88
            VectorWS m_vecLastPuddle; // 0x1a8c
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Slardar_Amplify_Damage) == 0x1aa0);
    };
};
