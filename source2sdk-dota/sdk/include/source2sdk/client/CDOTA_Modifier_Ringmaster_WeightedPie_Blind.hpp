...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float vision_radius; // 0x1a58            
            float max_slow_pct; // 0x1a5c            
            float m_flBaseVision; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Ringmaster_WeightedPie_Blind) == 0x1a68);
    };
};
