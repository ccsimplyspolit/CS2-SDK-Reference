...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // CUtlVector<CHandle<source2sdk::client::C_BaseEntity>> m_hEnemiesHit;
            char m_hEnemiesHit[0x18]; // 0x700
            source2sdk::client::ParticleIndex_t m_nFXIndex; // 0x718
            uint8_t _pad071c[0x4]; // 0x71c
            source2sdk::client::CountdownTimer ctSnowball; // 0x720
            bool m_bSpeakAlly; // 0x738
            bool m_bIsExpired; // 0x739
            bool m_bInWindup; // 0x73a
            uint8_t _pad073b[0x1]; // 0x73b
            ...
            char m_hPrimaryTarget[0x4]; // 0x73c
            std::int32_t m_nContainedValidUnits; // 0x740
            bool m_bEndingSnowball; // 0x744
        ...
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_Tusk_Snowball) == 0x748);
    };
};
