...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t stack_crit_chance_pct; // 0x1a58            
            std::int32_t critical_damage_pct; // 0x1a5c            
            std::int32_t stack_slow_pct; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Hoodwink_HuntersQuiver_Mark) == 0x1a68);
    };
};
