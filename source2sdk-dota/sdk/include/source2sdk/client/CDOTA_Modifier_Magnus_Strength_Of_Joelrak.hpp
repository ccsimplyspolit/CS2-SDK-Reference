...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            std::int32_t strength_per_stack; // 0x1a58            
            std::int32_t max_stacks; // 0x1a5c            
            float stack_duration; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Magnus_Strength_Of_Joelrak) == 0x1a68);
    };
};
