...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float m_flSongDuration; // 0x1a58            
            float m_flSongStartTime; // 0x1a5c            
            float mana_pct; // 0x1a60            
            float animation_rate; // 0x1a64            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_NagaSiren_SongOfTheSiren because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_NagaSiren_SongOfTheSiren) == 0x1a68);
    };
};
