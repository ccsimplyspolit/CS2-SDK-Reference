...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char hNeutralTarget[0x4]; // 0x6a8            
            source2sdk::entity2::GameTime_t m_flTimeBuffer; // 0x6ac            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_DOTA_Ability_SatyrSoulstealer_ManaBurn because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::C_DOTA_Ability_SatyrSoulstealer_ManaBurn) == 0x6b0);
    };
};
