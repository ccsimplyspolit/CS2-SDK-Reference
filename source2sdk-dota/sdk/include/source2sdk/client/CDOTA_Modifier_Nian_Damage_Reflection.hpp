...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            source2sdk::entity2::GameTime_t m_flReflectionStartTime; // 0x1a78
            float m_flReflectionAmount; // 0x1a7c
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Nian_Damage_Reflection because it is not a standard-layout class

        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Nian_Damage_Reflection) == 0x1a80);
    };
};
