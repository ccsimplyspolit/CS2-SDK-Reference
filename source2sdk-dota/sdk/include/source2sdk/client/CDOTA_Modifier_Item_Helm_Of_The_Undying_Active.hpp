...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            bool m_bPassive; // 0x1a7c
            uint8_t _pad1a7d[0x3]; // 0x1a7d
            float bonus_kill_duration; // 0x1a80
            float kill_radius; // 0x1a84
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CDOTA_Modifier_Item_Helm_Of_The_Undying_Active) == 0x1a88);
    };
};
