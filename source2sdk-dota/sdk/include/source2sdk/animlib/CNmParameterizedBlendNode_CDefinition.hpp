...
namespace source2sdk
{
    namespace animlib
    {
        ...
        public:
            ...
            std::int16_t m_nInputParameterValueNodeIdx; // 0x28            
            bool m_bAllowLooping; // 0x2a            
        ...
        static_assert(sizeof(source2sdk::animlib::CNmParameterizedBlendNode_CDefinition) == 0x30);
    };
};
