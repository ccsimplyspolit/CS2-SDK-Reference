...
#include "source2sdk/animlib/CNmTargetWarpNode_TargetUpdateRule_t.hpp"
...
namespace source2sdk
{
    namespace animlib
    {
        ...
        public:
            ...
            source2sdk::animlib::CNmTargetWarpNode_TargetUpdateRule_t m_targetUpdateRule; // 0x15            
            ...
            CGlobalSymbol m_alignmentBoneID; // 0x30            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CNmTargetWarpNode::CDefinition because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::animlib::CNmTargetWarpNode_CDefinition) == 0x38);
    };
};
