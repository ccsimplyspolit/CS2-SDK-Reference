...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            uint8_t _pad2e0c[0x4]; // 0x2e0c
            // metadata: MPropertyFriendlyName "sub-pixel AA scale"
            // metadata: MPropertySuppressExpr "mod != hlx"
            // metadata: MPropertySortPriority "1000"
            source2sdk::particleslib::CParticleCollectionRendererFloatInput m_flSubPixelAAScale; // 0x2e10            
            ...
            source2sdk::particles::ParticleAttributeIndex_t m_nScalarFieldForTextureCoordinate; // 0x3400            
            // metadata: MPropertyFriendlyName "scale value to map attribute to texture coordinate"
            // metadata: MPropertySuppressExpr "!m_bUseScalarForTextureCoordinate"
            float m_flScalarAttributeTextureCoordScale; // 0x3404            
            ...
            uint8_t _pad340a[0x2]; // 0x340a
            // metadata: MPropertyFriendlyName "attribute to use for rope segment id"
            // metadata: MPropertyAttributeChoiceName "particlefield_scalar"
            source2sdk::particles::ParticleAttributeIndex_t m_nSplitField; // 0x340c            
            ...
            source2sdk::particles::ParticleOrientationChoiceList_t m_nOrientationType; // 0x3414            
            ...
            source2sdk::particles::ParticleAttributeIndex_t m_nVectorFieldForOrientation; // 0x3418            
