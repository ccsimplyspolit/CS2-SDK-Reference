...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            char m_pTextureDetail2[0x8]; // 0x230            
            ...
            char m_pTextureDiffuseWarp[0x8]; // 0x238            
            ...
            char m_pTextureFresnelColorWarp[0x8]; // 0x240            
            ...
            char m_pTextureFresnelWarp[0x8]; // 0x248            
            ...
            char m_pTextureSpecularWarp[0x8]; // 0x250            
            ...
            char m_pTextureEnvMap[0x8]; // 0x258            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_OP_RenderStatusEffect because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_OP_RenderStatusEffect) == 0x260);
    };
};
