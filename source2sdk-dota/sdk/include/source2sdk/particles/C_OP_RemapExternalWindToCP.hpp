...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CParticleCollectionVecInput m_vecScale; // 0x1e8            
            // metadata: MPropertyFriendlyName "set magnitude instead of vector"
            bool m_bSetMagnitude; // 0x8a0            
            ...
            std::int32_t m_nOutVectorField; // 0x8a4            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_OP_RemapExternalWindToCP because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_OP_RemapExternalWindToCP) == 0x8a8);
    };
};
