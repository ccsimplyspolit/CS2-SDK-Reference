...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CPerParticleFloatInput m_flParentRadiusScale; // 0x1d8            
            // metadata: MPropertyFriendlyName "particle radius scale"
            source2sdk::particleslib::CPerParticleFloatInput m_flRadiusScale; // 0x348            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_OP_CollideWithParentParticles because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_OP_CollideWithParentParticles) == 0x4b8);
    };
};
