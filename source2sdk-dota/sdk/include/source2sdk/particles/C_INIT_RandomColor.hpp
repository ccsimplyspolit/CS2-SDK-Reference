...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::ParticleColorBlendMode_t m_nTintBlendMode; // 0x21c            
        ...
        static_assert(sizeof(source2sdk::particles::C_INIT_RandomColor) == 0x228);
    };
};
