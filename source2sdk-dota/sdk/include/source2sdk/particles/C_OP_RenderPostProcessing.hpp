...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CPerParticleFloatInput m_flPostProcessStrength; // 0x228            
            ...
            char m_hPostTexture[0x8]; // 0x398            
            // metadata: MPropertyFriendlyName "Post Processing Priority Group"
            source2sdk::particles::ParticlePostProcessPriorityGroup_t m_nPriority; // 0x3a0            
        ...
        static_assert(sizeof(source2sdk::particles::C_OP_RenderPostProcessing) == 0x3a8);
    };
};
