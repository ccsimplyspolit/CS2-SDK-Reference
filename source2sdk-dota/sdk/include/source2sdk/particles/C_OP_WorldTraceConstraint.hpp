...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            // metadata: MPropertyFriendlyName "calculate bounce on killed particles (for child events)"
            // metadata: MPropertySuppressExpr "m_bKillonContact == false"
            bool m_bKillonContactBounce; // 0x858            
            // metadata: MPropertyFriendlyName "Set Normal"
            bool m_bSetNormal; // 0x859            
