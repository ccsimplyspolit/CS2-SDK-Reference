...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CParticleCollectionFloatInput m_flRadiusScale; // 0x1e8            
            // metadata: MPropertyFriendlyName "Parent radius scale for distance calc"
            // metadata: MPropertySuppressExpr "!m_bUseRadius"
            source2sdk::particleslib::CParticleCollectionFloatInput m_flParentRadiusScale; // 0x358            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_OP_ConnectParentParticleToNearest because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_OP_ConnectParentParticleToNearest) == 0x4c8);
    };
};
