...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            // metadata: MPropertySuppressExpr "mod != csgo && mod != hlx"
            ...
            // metadata: MPropertyFriendlyName "Disable Cloth Ground Collision"
            bool m_bDisableClothGroundCollision; // 0x1a19            
            // metadata: MPropertyFriendlyName "With Cloth Effect"
            // metadata: MPropertySortPriority "500"
            char m_ClothEffectName[64]; // 0x1a1a            
            uint8_t _pad1a5a[0x6]; // 0x1a5a
            ...
            // metadata: MPropertySortPriority "700"
            source2sdk::particleslib::ParticleColorBlendType_t m_nColorBlendType; // 0x2c60            
            uint8_t _pad2c64[0x4]; // 0x2c64
            ...
            // metadata: MPropertySortPriority "700"
            source2sdk::particleslib::CPerParticleFloatInput m_flLightStyleTime; // 0x2c70            
            uint8_t _pad2de0[0x40];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in C_OP_RenderModels because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::particles::C_OP_RenderModels) == 0x2e20);
    };
};
