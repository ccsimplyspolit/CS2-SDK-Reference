...
namespace source2sdk
{
    namespace server
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CDOTA_Modifier_Foragers_Kit : public source2sdk::server::CDOTA_Buff_Item
        {
        public:
            ...
            source2sdk::server::CDOTA_Tree* m_pForagingTree; // 0x1a88            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Foragers_Kit) == 0x1a98);
    };
};
