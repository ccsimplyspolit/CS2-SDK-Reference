...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float root_duration; // 0x1a58            
            std::int32_t damage_boost_stacks; // 0x1a5c            
            float damage_boost_duration; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Lycan_SummonWolves_Hamstring) == 0x1a80);
    };
};
