...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t slow_melee; // 0x1a5c            
            std::int32_t slow_range; // 0x1a60            
            bool bCasterRanged; // 0x1a64            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Orb_Of_Destruction_Debuff) == 0x1a68);
    };
};
