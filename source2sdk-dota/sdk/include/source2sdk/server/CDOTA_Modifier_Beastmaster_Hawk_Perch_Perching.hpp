...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t perching_tree_height; // 0x1a58            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Beastmaster_Hawk_Perch_Perching) == 0x1a60);
    };
};
