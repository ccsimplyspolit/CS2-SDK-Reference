...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            bool m_bHidden; // 0x1a78
            uint8_t _pad1a79[0x3]; // 0x1a79
            float creep_penalty; // 0x1a7c
            float lifesteal_percent; // 0x1a80
            float lifesteal_range; // 0x1a84
