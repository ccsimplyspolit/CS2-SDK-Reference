...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float enchantment_bonus_growth; // 0x1a78
            float enchantment_bonus_base; // 0x1a7c
            bool m_bRecursionGuard; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Enchanters_Bauble) == 0x1a88);
    };
};
