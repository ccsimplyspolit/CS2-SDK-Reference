...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t num_first_soldiers; // 0x588            
            std::int32_t num_second_soldiers; // 0x58c            
            bool m_bCreateMonkeys; // 0x590            
            uint8_t _pad0591[0x3]; // 0x591
            source2sdk::entity2::GameTime_t m_flNextCreationTime; // 0x594            
            source2sdk::entity2::GameTime_t m_flScepterTime; // 0x598            
