...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t m_nHighestLevelInCurrentGame; // 0x7f0            
            uint8_t _pad07f4[0x34]; // 0x7f4
            ...
            std::int32_t m_nExtraGoldPerWave; // 0x870            
            std::int32_t m_nExtraXPPerWave; // 0x874            
            float m_flNextRewardDistributionTime; // 0x878            
            float m_flNextWaveRecalculationTime; // 0x87c            
            bool m_bInOvertime; // 0x880            
            bool m_bDistributingPassiveGoldAndXp; // 0x881            
            uint8_t _pad0882[0x6];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTATurboGameMode because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTATurboGameMode) == 0x888);
    };
};
