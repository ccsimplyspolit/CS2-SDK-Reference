...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float attrib_bonus; // 0x1a7c
            float hurt_attrib_bonus; // 0x1a80
            float hurt_percent; // 0x1a84
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Huskar_Inner_Vitality because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Huskar_Inner_Vitality) == 0x1a88);
    };
};
