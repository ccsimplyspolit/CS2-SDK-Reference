...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::server::CountdownTimer m_OverheatTimer; // 0x1aa0
            uint8_t _pad1ab8[0x28];
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Item_Conjurers_Catalyst because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Conjurers_Catalyst) == 0x1ae0);
    };
};
