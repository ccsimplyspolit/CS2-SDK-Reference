...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::entity2::GameTime_t flLastGameTime; // 0x1a78
            float m_flCurrentShield; // 0x1a7c
            float barrier_decay_pct; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Bloodseeker_BloodMist_Barrier) == 0x1a88);
    };
};
