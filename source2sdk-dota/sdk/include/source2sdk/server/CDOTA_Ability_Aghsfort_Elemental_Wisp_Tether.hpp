...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            bool m_bProjectileActive; // 0x5a0            
            uint8_t _pad05a1[0x3]; // 0x5a1
            std::int32_t latch_distance; // 0x5a4            
            std::int32_t m_iProjectileIndex; // 0x5a8            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Aghsfort_Elemental_Wisp_Tether) == 0x5b0);
    };
};
