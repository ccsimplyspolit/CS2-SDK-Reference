...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float bonus_attack_speed; // 0x1a78
            float bonus_armor_creeps; // 0x1a7c
            float bonus_armor_heroes; // 0x1a80
            float m_flBonusArmor; // 0x1a84
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Legion_Commander_OverwhelmingOdds) == 0x1a88);
    };
};
