...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float sidegunner_radius; // 0x1a78
            float sidegunner_fire_rate; // 0x1a7c
            ...
            char m_hIdealTarget[0x4]; // 0x1a84
            ...
            char m_hSecondaryTarget[0x4]; // 0x1a88
            float m_flLastFireTime; // 0x1a8c
            ...
            char m_hOwningAbility[0x4]; // 0x1a94
            source2sdk::client::AttackRecord_t m_iAttackRecord; // 0x1a98
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Gyrocopter_Side_Gunner) == 0x1aa0);
    };
};
