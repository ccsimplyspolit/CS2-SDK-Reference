...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float sidegunner_radius; // 0x1a58            
            float sidegunner_fire_rate; // 0x1a5c            
            float m_flRotation; // 0x1a60            
            ...
            char m_hIdealTarget[0x4]; // 0x1a64            
            ...
            char m_hSecondaryTarget[0x4]; // 0x1a68            
            float m_flLastFireTime; // 0x1a6c            
            ...
            char m_hOwningAbility[0x4]; // 0x1a74            
            source2sdk::client::AttackRecord_t m_iAttackRecord; // 0x1a78            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Gyrocopter_Side_Gunner) == 0x1a80);
    };
};
