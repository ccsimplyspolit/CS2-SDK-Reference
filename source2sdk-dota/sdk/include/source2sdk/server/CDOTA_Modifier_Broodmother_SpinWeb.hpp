...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t break_move_cap; // 0x1a7c
            float bonus_movespeed; // 0x1a80
            float bonus_turn_rate; // 0x1a84
            float flLastDamageTime; // 0x1a88
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Broodmother_SpinWeb) == 0x1a90);
    };
};
