...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            VectorWS m_vStartPos; // 0x1a7c
            float m_flCurTime; // 0x1a88
            float m_flHeightT; // 0x1a8c
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Aghsfort_Wildwing_Tornado_Blast_Debuff) == 0x1a90);
    };
};
