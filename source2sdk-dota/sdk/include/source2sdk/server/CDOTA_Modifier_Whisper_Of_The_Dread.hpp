...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t bonus_spell_damage; // 0x1a7c
            std::int32_t vision_penalty; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Whisper_Of_The_Dread) == 0x1a88);
    };
};
