...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t attack_speed_factor; // 0x1a5c            
            float move_speed_factor; // 0x1a60            
            std::int32_t drain_rate; // 0x1a64            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Razor_StaticLink_Debuff) == 0x1a70);
    };
};
