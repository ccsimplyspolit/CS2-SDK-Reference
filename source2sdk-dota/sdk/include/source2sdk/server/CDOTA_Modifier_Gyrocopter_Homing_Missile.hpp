...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::server::CountdownTimer m_EnemyVision; // 0x1ad0
            source2sdk::server::CountdownTimer m_MoveTime; // 0x1ae8
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Gyrocopter_Homing_Missile because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Gyrocopter_Homing_Missile) == 0x1b00);
    };
};
