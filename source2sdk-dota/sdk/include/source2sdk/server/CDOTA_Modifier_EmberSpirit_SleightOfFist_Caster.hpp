...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t bonus_hero_damage; // 0x1a58            
            std::int32_t creep_damage_penalty; // 0x1a5c            
            float radius; // 0x1a60            
            float attack_interval; // 0x1a64            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_EmberSpirit_SleightOfFist_Caster) == 0x1a68);
    };
};
