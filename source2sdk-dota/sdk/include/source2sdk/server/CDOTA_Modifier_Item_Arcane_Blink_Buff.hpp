...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t cast_pct_improvement; // 0x1a78
            std::int32_t manacost_reduction; // 0x1a7c
            std::int32_t debuff_amp; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Arcane_Blink_Buff) == 0x1a88);
    };
};
