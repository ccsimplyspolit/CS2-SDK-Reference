...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t m_TriggerHitPoints; // 0x4a8            
            float m_flTimeToTrigger; // 0x4ac            
            source2sdk::entity2::GameTime_t m_flStartTime; // 0x4b0            
        ...
        static_assert(sizeof(source2sdk::server::CLogicActiveAutosave) == 0x4b8);
    };
};
