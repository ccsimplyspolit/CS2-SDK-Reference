...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::client::AttackRecord_t m_nAttackRecord; // 0x1ab4
            uint8_t _pad1ab6[0x2];
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Tusk_WalrusPunch because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Tusk_WalrusPunch) == 0x1ab8);
    };
};
