...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float chain_duration; // 0x580            
            float chain_latch_radius; // 0x584            
            float creep_duration_pct; // 0x588            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Grimstroke_SoulChain) == 0x590);
    };
};
