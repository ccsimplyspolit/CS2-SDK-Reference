...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t damage_min; // 0x1aa8            
            std::int32_t damage_max; // 0x1aac            
            std::int32_t slow_min; // 0x1ab0            
            std::int32_t slow_max; // 0x1ab4            
            float slow_duration; // 0x1ab8            
            float windup_time; // 0x1abc            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_AghsFort_Ascension_PlasmaField_Thinker) == 0x1ac0);
    };
};
