...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t allow_multiple; // 0x1a7c
            std::int32_t m_nAttributes; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_ForestTrollHighPriest_ManaAura_Bonus) == 0x1a88);
    };
};
