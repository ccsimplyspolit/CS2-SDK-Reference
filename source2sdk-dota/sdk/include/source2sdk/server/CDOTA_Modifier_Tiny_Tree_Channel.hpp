...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float tree_grab_radius; // 0x1a78
            float splash_radius; // 0x1a7c
            float speed; // 0x1a80
            float interval; // 0x1a84
            VectorWS m_vPos; // 0x1a88
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Tiny_Tree_Channel) == 0x1a98);
    };
};
