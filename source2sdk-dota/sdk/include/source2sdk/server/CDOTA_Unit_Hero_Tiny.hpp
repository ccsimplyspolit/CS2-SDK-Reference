...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hTreeWearable[0x4]; // 0x1f08
            source2sdk::client::ParticleIndex_t m_nFXIndexScepterAmbient; // 0x1f0c
            ...
            char m_hIllusionOwner[0x4]; // 0x1f10
            bool m_bIllusionHasTree; // 0x1f14
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Unit_Hero_Tiny) == 0x1f18);
    };
};
