...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hTreeWearable[0x4]; // 0x1f00            
            source2sdk::client::ParticleIndex_t m_nFXIndexScepterAmbient; // 0x1f04            
            ...
            char m_hIllusionOwner[0x4]; // 0x1f08            
            bool m_bIllusionHasTree; // 0x1f0c            
            uint8_t _pad1f0d[0x3];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Unit_Hero_Tiny because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Unit_Hero_Tiny) == 0x1f10);
    };
};
