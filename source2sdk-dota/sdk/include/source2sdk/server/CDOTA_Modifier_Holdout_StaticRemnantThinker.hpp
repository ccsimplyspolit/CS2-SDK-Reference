...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t static_remnant_radius; // 0x1a58            
            std::int32_t static_remnant_damage_radius; // 0x1a5c            
            std::int32_t static_remnant_damage; // 0x1a60            
            float static_remnant_delay; // 0x1a64            
            float overload_duration; // 0x1a68            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Holdout_StaticRemnantThinker) == 0x1a70);
    };
};
