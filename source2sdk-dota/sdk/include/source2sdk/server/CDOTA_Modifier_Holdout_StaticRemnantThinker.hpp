...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t static_remnant_radius; // 0x1a78
            std::int32_t static_remnant_damage_radius; // 0x1a7c
            std::int32_t static_remnant_damage; // 0x1a80
            float static_remnant_delay; // 0x1a84
            float overload_duration; // 0x1a88
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Holdout_StaticRemnantThinker) == 0x1a90);
    };
};
