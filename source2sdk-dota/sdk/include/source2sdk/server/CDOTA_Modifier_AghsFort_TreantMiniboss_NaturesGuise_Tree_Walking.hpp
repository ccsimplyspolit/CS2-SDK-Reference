...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t movement_bonus; // 0x1a78
            std::int32_t regen_amp; // 0x1a7c
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_AghsFort_TreantMiniboss_NaturesGuise_Tree_Walking) == 0x1a80);
    };
};
