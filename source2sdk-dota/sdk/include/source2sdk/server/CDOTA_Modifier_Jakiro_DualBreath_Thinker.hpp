...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float start_radius; // 0x1a78
            float end_radius; // 0x1a7c
            source2sdk::entity2::GameTime_t m_fStartTime; // 0x1a80
            float m_fTotalTime; // 0x1a84
            VectorWS m_vCastPosition; // 0x1a88
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Jakiro_DualBreath_Thinker) == 0x1a98);
    };
};
