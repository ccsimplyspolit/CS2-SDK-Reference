...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float start_radius; // 0x1a58            
            float end_radius; // 0x1a5c            
            source2sdk::entity2::GameTime_t m_fStartTime; // 0x1a60            
            float m_fTotalTime; // 0x1a64            
            VectorWS m_vCastPosition; // 0x1a68            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Jakiro_DualBreath_Thinker) == 0x1a78);
    };
};
