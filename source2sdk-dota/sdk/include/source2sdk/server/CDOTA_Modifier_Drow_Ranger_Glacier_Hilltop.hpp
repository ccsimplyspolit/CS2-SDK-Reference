...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t multishot_arrow_bonus; // 0x1a58            
            std::int32_t end_height; // 0x1a5c            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Drow_Ranger_Glacier_Hilltop) == 0x1a68);
    };
};
