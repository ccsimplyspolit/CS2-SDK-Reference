...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_EntitiesHit[0x18]; // 0x1a68            
            float scepter_speed; // 0x1a80            
            float scepter_radius; // 0x1a84            
            float damage; // 0x1a88            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Terrorblade_Metamorphosis_Fear_Thinker) == 0x1a90);
    };
};
