...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float scepter_speed; // 0x1aa0
            float scepter_radius; // 0x1aa4
            float damage; // 0x1aa8
            bool m_bFirstThink; // 0x1aac
            uint8_t _pad1aad[0x3];
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Terrorblade_Metamorphosis_Fear_Thinker) == 0x1ab0);
    };
};
