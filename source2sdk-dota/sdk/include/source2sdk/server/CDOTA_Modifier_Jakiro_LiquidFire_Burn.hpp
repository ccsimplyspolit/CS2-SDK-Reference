...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t slow_attack_speed_pct; // 0x1a78
            float damage; // 0x1a7c
            float pct_health_damage; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Jakiro_LiquidFire_Burn) == 0x1a88);
    };
};
