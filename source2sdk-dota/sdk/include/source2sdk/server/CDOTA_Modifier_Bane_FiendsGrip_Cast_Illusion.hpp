...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t fiend_grip_mana_drain; // 0x1a78
            float fiend_grip_tick_interval; // 0x1a7c
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Bane_FiendsGrip_Cast_Illusion) == 0x1a80);
    };
};
