...
namespace source2sdk
{
    namespace server
    {
        ...
        // Cannot assert offsets of fields in CDOTA_Modifier_Huskar_Life_Break_Charge because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Huskar_Life_Break_Charge) == 0x1a60);
    };
};
