...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t stack_limit_during_battle_trance; // 0x1a5c            
            std::int32_t extra_attack_chance_per_stack; // 0x1a60            
            std::int32_t base_chance; // 0x1a64            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_TrollWarlord_Fervor) == 0x1a70);
    };
};
