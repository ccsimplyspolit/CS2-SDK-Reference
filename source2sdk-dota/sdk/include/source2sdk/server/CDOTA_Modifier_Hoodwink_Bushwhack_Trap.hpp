...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::entity2::GameTime_t m_flLastTick; // 0x1a98
            ...
            char m_hTree[0x4]; // 0x1a9c
            source2sdk::server::CDOTA_Tree* m_pTree; // 0x1aa0
            VectorWS m_vPullPosition; // 0x1aa8
            Vector m_vDir; // 0x1ab4
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Hoodwink_Bushwhack_Trap because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Hoodwink_Bushwhack_Trap) == 0x1ac0);
    };
};
