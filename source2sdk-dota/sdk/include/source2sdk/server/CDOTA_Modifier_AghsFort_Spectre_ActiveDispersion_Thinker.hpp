...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::server::CountdownTimer m_ViewerTimer; // 0x1a70            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_AghsFort_Spectre_ActiveDispersion_Thinker) == 0x1ab0);
    };
};
