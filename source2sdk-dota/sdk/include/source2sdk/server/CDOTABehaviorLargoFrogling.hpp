...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hEmoteTarget[0x4]; // 0x2c4            
            source2sdk::server::CountdownTimer m_EmoteTimer; // 0x2c8            
            std::int32_t m_nEmoteActivity; // 0x2e0            
            ...
            char m_tempGoalEntity[0x4]; // 0x2e4            
            bool m_bFollowingTempGoal; // 0x2e8            
            uint8_t _pad02e9[0x3]; // 0x2e9
            std::int32_t m_event_dota_illusions_created; // 0x2ec            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTABehaviorLargoFrogling because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTABehaviorLargoFrogling) == 0x2f0);
    };
};
