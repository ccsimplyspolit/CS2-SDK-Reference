...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float shard_buff_duration; // 0x1a78
            ...
            char m_vecStackExpirationTimes[0x18]; // 0x1a80
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Undying_Decay_Shard because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Undying_Decay_Shard) == 0x1a98);
    };
};
