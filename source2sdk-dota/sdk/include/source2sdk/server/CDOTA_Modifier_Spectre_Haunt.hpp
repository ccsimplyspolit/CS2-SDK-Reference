...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            bool m_bRealityApplied; // 0x1a78
            uint8_t _pad1a79[0x3]; // 0x1a79
            std::int32_t destroy_if_target_is_dead; // 0x1a7c
            source2sdk::entity2::GameTime_t m_fStartAttackTime; // 0x1a80
            // m_hTarget has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::server::CBaseEntity> m_hTarget;
            char m_hTarget[0x4]; // 0x1a84
            bool m_bTargetIsAlive; // 0x1a88
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Spectre_Haunt) == 0x1a90);
    };
};
