...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_vActiveRemnants[0x18]; // 0x1a58            
            ...
            char m_vTrackingDelayedRemnants[0x18]; // 0x1a70            
            float shard_charge_radius; // 0x1a88            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_EmberSpirit_FireRemnant_RemnantTracker) == 0x1a90);
    };
};
