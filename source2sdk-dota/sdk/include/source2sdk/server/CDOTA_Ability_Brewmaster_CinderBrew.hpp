...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hUnitsHit[0x18]; // 0x580            
            float duration; // 0x598            
            float barrel_impact_damage; // 0x59c            
            float barrel_width; // 0x5a0            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Brewmaster_CinderBrew) == 0x5b8);
    };
};
