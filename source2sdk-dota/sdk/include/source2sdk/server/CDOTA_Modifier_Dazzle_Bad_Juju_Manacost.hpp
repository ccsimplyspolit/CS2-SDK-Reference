...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float mana_cost_increase_duration; // 0x1a78
            ...
            char m_vecExpirationTimes[0x18]; // 0x1a80
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Dazzle_Bad_Juju_Manacost because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Dazzle_Bad_Juju_Manacost) == 0x1a98);
    };
};
