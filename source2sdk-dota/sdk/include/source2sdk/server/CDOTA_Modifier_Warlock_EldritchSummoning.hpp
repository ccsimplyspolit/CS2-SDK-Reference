...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float minor_imp_duration; // 0x1a78
            std::int32_t golem_can_summon; // 0x1a7c
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Warlock_EldritchSummoning because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Warlock_EldritchSummoning) == 0x1a80);
    };
};
