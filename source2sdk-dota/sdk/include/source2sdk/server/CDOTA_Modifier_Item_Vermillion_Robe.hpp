...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t mana_regen_pct; // 0x1a58            
            std::int32_t move_speed_bonus; // 0x1a5c            
            std::int32_t bonus_stats; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Vermillion_Robe) == 0x1a68);
    };
};
