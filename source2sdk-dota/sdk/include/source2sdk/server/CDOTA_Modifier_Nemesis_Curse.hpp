...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t debuff_self; // 0x1a78
            float debuff_enemy; // 0x1a7c
            std::int32_t debuff_enemy_duration; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Nemesis_Curse) == 0x1a88);
    };
};
