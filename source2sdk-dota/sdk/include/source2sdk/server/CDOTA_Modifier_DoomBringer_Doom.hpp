...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t deniable_pct; // 0x1a80
            float flElapsedTime; // 0x1a84
            std::int32_t damage_amp; // 0x1a88
            bool m_bDoesBreak; // 0x1a8c
            bool m_bDoesMute; // 0x1a8d
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_DoomBringer_Doom) == 0x1a90);
    };
};
