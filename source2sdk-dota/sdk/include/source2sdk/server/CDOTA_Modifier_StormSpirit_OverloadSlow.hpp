...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t overload_move_slow; // 0x1a78
            std::int32_t overload_attack_slow; // 0x1a7c
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_StormSpirit_OverloadSlow because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_StormSpirit_OverloadSlow) == 0x1a80);
    };
};
