...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float m_fLastRadius; // 0x1a78
            float m_fCurRadius; // 0x1a7c
            source2sdk::entity2::GameTime_t m_fLastThink; // 0x1a80
            bool m_bContracting; // 0x1a84
            uint8_t _pad1a85[0x3]; // 0x1a85
            source2sdk::server::CountdownTimer m_ViewerTimer; // 0x1a88
            ...
            float radius; // 0x1ac4
            float damage_min; // 0x1ac8
            float damage_max; // 0x1acc
            std::int32_t slow_min; // 0x1ad0
            std::int32_t slow_max; // 0x1ad4
            float slow_duration; // 0x1ad8
            bool m_bHasCreatedFx; // 0x1adc
            uint8_t _pad1add[0x3]; // 0x1add
            float total_ability_time; // 0x1ae0
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Razor_PlasmaField_Thinker) == 0x1ae8);
    };
};
