...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float healing_ward_heal_amount; // 0x1a58            
            std::int32_t m_nStartingHealthThisInterval; // 0x1a5c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Juggernaut_Healing_Ward_Heal because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Juggernaut_Healing_Ward_Heal) == 0x1a60);
    };
};
