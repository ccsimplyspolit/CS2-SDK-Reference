...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            float radius; // 0x580            
            float hero_stun_duration; // 0x584            
            float damage; // 0x588            
            float damage_pct; // 0x58c            
            source2sdk::entity2::GameTime_t flCooldown; // 0x590            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_OgreBruiser_OgreSmash) == 0x598);
    };
};
