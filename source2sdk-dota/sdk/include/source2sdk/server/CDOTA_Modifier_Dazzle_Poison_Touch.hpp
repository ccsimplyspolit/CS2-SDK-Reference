...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float bonus_slow; // 0x1a5c            
            std::int32_t bonus_damage; // 0x1a60            
            float flAccummulatedBonusSlow; // 0x1a64            
            std::int32_t iAccummulatedBonusDamage; // 0x1a68            
            std::int32_t attack_range_bonus; // 0x1a6c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Dazzle_Poison_Touch because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Dazzle_Poison_Touch) == 0x1a70);
    };
};
