...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t attack_speed_reduction; // 0x1a7c
            std::int32_t bonus_damage; // 0x1a80
            float tree_bonus_damage_pct; // 0x1a84
            float move_speed; // 0x1a88
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Tiny_Grow) == 0x1a90);
    };
};
