...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::client::ParticleIndex_t m_nFXDeath; // 0x1f0c
            source2sdk::client::ParticleIndex_t m_nTempestFX; // 0x1f10
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Unit_Hero_ArcWarden) == 0x1f18);
    };
};
