...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            bool m_bUntargetableAllies; // 0x1a78
            bool m_bUntargetableEnemies; // 0x1a79
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Book_Of_Shadows_Buff) == 0x1a80);
    };
};
