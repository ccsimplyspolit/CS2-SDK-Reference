...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            bool m_bUntargetableAllies; // 0x1a58            
            bool m_bUntargetableEnemies; // 0x1a59            
            uint8_t _pad1a5a[0x6];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Item_Book_Of_Shadows_Buff because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Book_Of_Shadows_Buff) == 0x1a60);
    };
};
