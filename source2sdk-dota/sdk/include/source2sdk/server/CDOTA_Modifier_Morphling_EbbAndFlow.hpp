...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::server::CountdownTimer m_SwellUpTimer; // 0x1a78            
            source2sdk::server::CountdownTimer m_SwellDownTimer; // 0x1a90            
            source2sdk::server::CountdownTimer m_MaxSwellTimer; // 0x1aa8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Morphling_EbbAndFlow because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Morphling_EbbAndFlow) == 0x1ac0);
    };
};
