...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t bonus_chance; // 0x1a78
            std::int32_t bonus_chance_damage; // 0x1a7c
            std::int32_t bonus_strength; // 0x1a80
            std::int32_t bonus_agility; // 0x1a84
            std::int32_t bonus_intellect; // 0x1a88
            float bonus_mana_regen; // 0x1a8c
            std::int32_t bonus_damage; // 0x1a90
            std::int32_t bonus_speed; // 0x1a94
            ...
            char m_InFlightProcAttackRecords[0x18]; // 0x1a98
            source2sdk::client::AttackRecord_t m_nBonusProcAttackRecord; // 0x1ab0
            uint8_t _pad1ab2[0x6];
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Item_Harpoon because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Harpoon) == 0x1ab8);
    };
};
