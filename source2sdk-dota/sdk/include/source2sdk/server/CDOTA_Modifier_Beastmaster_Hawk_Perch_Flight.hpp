...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t perch_flight_height; // 0x1a78
            std::int32_t perch_tree_height; // 0x1a7c
            std::int32_t flight_speed; // 0x1a80
            float m_flZDelta; // 0x1a84
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Beastmaster_Hawk_Perch_Flight) == 0x1a98);
    };
};
