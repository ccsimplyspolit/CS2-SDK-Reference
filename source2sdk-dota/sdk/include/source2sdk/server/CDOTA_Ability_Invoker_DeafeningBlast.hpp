...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float end_vision_duration; // 0x590            
            float damage; // 0x594            
            float knockback_duration; // 0x598            
            float disarm_duration; // 0x59c            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Invoker_DeafeningBlast) == 0x5c0);
    };
};
