...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::server::CountdownTimer m_StartMeditationTimer; // 0x1a90
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_TemplarAssassin_InnerPeace_Passive) == 0x1ac0);
    };
};
