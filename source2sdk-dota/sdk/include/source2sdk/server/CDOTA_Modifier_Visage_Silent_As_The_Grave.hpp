...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t invis; // 0x1a88
            std::int32_t movespeed_bonus; // 0x1a8c
            std::int32_t bonus_damage; // 0x1a90
            float bonus_duration; // 0x1a94
            bool m_bHasMadeAttack; // 0x1a98
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Visage_Silent_As_The_Grave) == 0x1aa0);
    };
};
