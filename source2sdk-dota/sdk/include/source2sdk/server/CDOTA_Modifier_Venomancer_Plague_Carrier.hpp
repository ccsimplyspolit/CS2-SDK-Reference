...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t m_nWardIndex; // 0x1a7c
            float m_flPositioningAngle; // 0x1a80
            float m_flTargetPreviousYaw; // 0x1a84
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Venomancer_Plague_Carrier) == 0x1a90);
    };
};
