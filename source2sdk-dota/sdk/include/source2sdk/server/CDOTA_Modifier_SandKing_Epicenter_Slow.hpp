...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t epicenter_slow; // 0x1a58            
            std::int32_t epicenter_slow_as; // 0x1a5c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_SandKing_Epicenter_Slow because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_SandKing_Epicenter_Slow) == 0x1a60);
    };
};
