...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float decay_to_zero_seconds; // 0x1a78
            float aura_radius; // 0x1a7c
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Miniboss_Minion_Deflecting_Shield_Aura) == 0x1a88);
    };
};
