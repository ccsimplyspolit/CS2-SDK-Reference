...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hHeroHandle[0x4]; // 0x18a8
            float m_flPetThreatLevel; // 0x18ac
            bool m_bReadyToPerformCoopTeleport; // 0x18b0
            bool m_bSupportsCoopTeleport; // 0x18b1
            uint8_t _pad18b2[0x2]; // 0x18b2
            source2sdk::server::PetCoopStates_t m_nCoopState; // 0x18b4
            CUtlString m_strPickupItemModel; // 0x18b8
            ...
            char m_hCarriedItem[0x4]; // 0x18c0
            std::int32_t m_nPetLevel; // 0x18c4
            source2sdk::client::PetLevelup_Rule_t m_nLevelupRule; // 0x18c8
            uint8_t _pad18cc[0x4]; // 0x18cc
            std::int32_t m_nXPCompendiumEventID; // 0x18d0
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_BaseNPC_Pet) == 0x18d8);
    };
};
