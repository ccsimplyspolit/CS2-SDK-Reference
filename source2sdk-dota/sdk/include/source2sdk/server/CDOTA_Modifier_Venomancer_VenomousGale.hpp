...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float explosion_stun_duration; // 0x1a58            
            std::int32_t explosion_damage; // 0x1a5c            
            std::int32_t movement_slow; // 0x1a60            
            std::int32_t tick_damage; // 0x1a64            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Venomancer_VenomousGale) == 0x1a70);
    };
};
