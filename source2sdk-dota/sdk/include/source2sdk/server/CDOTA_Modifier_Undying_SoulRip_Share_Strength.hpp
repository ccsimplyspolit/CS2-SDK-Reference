...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float str_gain; // 0x1a58            
            std::int32_t strength_share_model_scale; // 0x1a5c            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Undying_SoulRip_Share_Strength) == 0x1a60);
    };
};
