...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            bool m_bHasPostedEvent; // 0x1a78
            uint8_t _pad1a79[0x3]; // 0x1a79
            source2sdk::client::ParticleIndex_t m_nFXIndex; // 0x1a7c
            float fx_halo_height; // 0x1a80
            float m_flExpirationHeal; // 0x1a84
            std::int32_t heal_amplify; // 0x1a88
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Dazzle_Shallow_Grave) == 0x1a90);
    };
};
