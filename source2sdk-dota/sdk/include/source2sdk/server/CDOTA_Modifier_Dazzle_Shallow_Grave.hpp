...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            bool m_bHasPostedEvent; // 0x1a58            
            uint8_t _pad1a59[0x3]; // 0x1a59
            source2sdk::client::ParticleIndex_t m_nFXIndex; // 0x1a5c            
            float fx_halo_height; // 0x1a60            
            float m_flExpirationHeal; // 0x1a64            
            std::int32_t heal_amplify; // 0x1a68            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Dazzle_Shallow_Grave) == 0x1a70);
    };
};
