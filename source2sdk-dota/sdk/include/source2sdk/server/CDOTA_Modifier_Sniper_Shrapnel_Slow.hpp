...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float shrapnel_damage; // 0x1a7c
            std::int32_t fast_tick; // 0x1a80
            std::int32_t m_nTracker; // 0x1a84
            bool bFirst; // 0x1a88
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Sniper_Shrapnel_Slow) == 0x1a90);
    };
};
