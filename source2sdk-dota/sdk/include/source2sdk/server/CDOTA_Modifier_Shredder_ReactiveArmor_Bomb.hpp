...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float initial_shield; // 0x1a58            
            float max_shield; // 0x1a5c            
            float shield_per_sec; // 0x1a60            
            float shield_per_sec_per_enemy; // 0x1a64            
            float duration; // 0x1a68            
            float base_explosion; // 0x1a6c            
            float radius; // 0x1a70            
            float explosion_radius; // 0x1a74            
            std::int32_t m_nDamageAbsorbed; // 0x1a78            
            source2sdk::entity2::GameTime_t m_timeLastTick; // 0x1a7c            
            source2sdk::entity2::GameTime_t m_StartTime; // 0x1a80            
            std::int32_t m_nLastParticleTime; // 0x1a84            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Shredder_ReactiveArmor_Bomb because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Shredder_ReactiveArmor_Bomb) == 0x1a88);
    };
};
