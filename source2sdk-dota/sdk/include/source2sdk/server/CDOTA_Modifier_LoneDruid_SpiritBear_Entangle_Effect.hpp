...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t m_iEntangleDamage; // 0x1a78
            float interval_rate; // 0x1a7c
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_LoneDruid_SpiritBear_Entangle_Effect) == 0x1a88);
    };
};
