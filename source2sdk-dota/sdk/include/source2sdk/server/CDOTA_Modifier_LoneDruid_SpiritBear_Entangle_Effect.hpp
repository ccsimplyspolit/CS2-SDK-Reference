...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t m_iEntangleDamage; // 0x1a58            
            float interval_rate; // 0x1a5c            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_LoneDruid_SpiritBear_Entangle_Effect) == 0x1a68);
    };
};
