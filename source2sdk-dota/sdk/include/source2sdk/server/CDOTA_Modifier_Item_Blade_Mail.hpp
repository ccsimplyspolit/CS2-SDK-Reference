...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t passive_reflection_constant; // 0x1a64            
            std::int32_t passive_reflection_pct; // 0x1a68            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Blade_Mail) == 0x1a70);
    };
};
