...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            bool m_bInterrupted; // 0x1a9c
            bool m_bHasBeenDestroyed; // 0x1a9d
            bool m_bDoingThrow; // 0x1a9e
            uint8_t _pad1a9f[0x1];
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Roshan_Grab because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Roshan_Grab) == 0x1aa0);
    };
};
