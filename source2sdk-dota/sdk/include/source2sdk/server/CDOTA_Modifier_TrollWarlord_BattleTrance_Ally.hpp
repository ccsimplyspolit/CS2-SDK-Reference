...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t attack_speed_share_percent; // 0x1a7c
            std::int32_t m_nAttackSpeed; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_TrollWarlord_BattleTrance_Ally) == 0x1a88);
    };
};
