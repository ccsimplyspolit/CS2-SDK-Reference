...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float m_flEndTime; // 0x1a8c
            // m_hThinker has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::server::CBaseEntity> m_hThinker;
            char m_hThinker[0x4]; // 0x1a90
            VectorWS m_vCurrentTargetPosition; // 0x1a94
            VectorWS m_vDesiredTargetPosition; // 0x1aa0
            VectorWS m_vStartPosition; // 0x1aac
            std::int32_t airtime_scepter_movement_speed; // 0x1ab8
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Dawnbreaker_Solar_Guardian_AirTime) == 0x1ac0);
    };
};
