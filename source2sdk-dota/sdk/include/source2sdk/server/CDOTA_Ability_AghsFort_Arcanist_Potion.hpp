...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t cooldown_reduction_pct; // 0x658            
            std::int32_t manacost_reduction_pct; // 0x65c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Ability_AghsFort_Arcanist_Potion because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_AghsFort_Arcanist_Potion) == 0x660);
    };
};
