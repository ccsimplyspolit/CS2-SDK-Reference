...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t trueshot_agi_bonus; // 0x1a58            
            float trueshot_agi_bonus_allies_pct; // 0x1a5c            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_DrowRanger_Marksmanship_Aura_Bonus) == 0x1a60);
    };
};
