...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float radius_increase; // 0x1a78
            float m_flCurrentRadius; // 0x1a7c
            ...
            char m_vParticleList[0x18]; // 0x1a80
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Viper_Nethertoxin_Thinker because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Viper_Nethertoxin_Thinker) == 0x1a98);
    };
};
