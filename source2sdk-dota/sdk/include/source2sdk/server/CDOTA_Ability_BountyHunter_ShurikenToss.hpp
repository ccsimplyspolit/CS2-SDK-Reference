...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hSourceCaster[0x4]; // 0x584            
            // m_hHitEntities has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CUtlVector<CHandle<source2sdk::server::CBaseEntity>> m_hHitEntities;
            char m_hHitEntities[0x18]; // 0x588            
            bool passthrough_damage; // 0x5a0            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_BountyHunter_ShurikenToss) == 0x5a8);
    };
};
