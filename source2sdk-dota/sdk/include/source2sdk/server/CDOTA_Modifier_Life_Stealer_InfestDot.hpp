...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float dot_damage_as_pct_of_damage_dealt; // 0x1a78
            float dot_tick_interval; // 0x1a7c
            std::int32_t m_nDamagePerTick; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Life_Stealer_InfestDot) == 0x1a88);
    };
};
