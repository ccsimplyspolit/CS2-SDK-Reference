...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t m_event_dota_player_team_changed; // 0x19d0
            uint8_t _pad19d4[0x4]; // 0x19d4
            source2sdk::server::CountdownTimer m_glowThinkTimer; // 0x19d8
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_BaseNPC_HallofFame because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_BaseNPC_HallofFame) == 0x19f0);
    };
};
