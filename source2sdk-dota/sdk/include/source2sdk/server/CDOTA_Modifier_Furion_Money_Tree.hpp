...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float gold_per_bag; // 0x1a58            
            float tick_interval; // 0x1a5c            
            float tree_duration; // 0x1a60            
            std::int32_t min_throw_range; // 0x1a64            
            std::int32_t max_throw_range; // 0x1a68            
            float gold_bag_duration; // 0x1a6c            
            std::int32_t bags_per_tick; // 0x1a70            
            float hero_level_gold_multiplier; // 0x1a74            
            ...
            std::int32_t nTargetHeroLevel; // 0x1a7c            
            bool m_bInitialized; // 0x1a80            
            ...
            char m_hObstruction[0x4]; // 0x1a84            
            source2sdk::entity2::GameTime_t m_timeLastGoldBagSpawn; // 0x1a88            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Furion_Money_Tree) == 0x1a90);
    };
};
