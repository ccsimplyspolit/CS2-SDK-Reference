...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t chance_pct; // 0x1a58            
            std::int32_t bonus_chance_pct; // 0x1a5c            
            float bonus_chance_duration; // 0x1a60            
            float damage; // 0x1a64            
            float movespeed_duration; // 0x1a68            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_SpiritBreaker_GreaterBash) == 0x1a70);
    };
};
