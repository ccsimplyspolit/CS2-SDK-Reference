...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t chance_pct; // 0x1a78
            std::int32_t bonus_chance_pct; // 0x1a7c
            float bonus_chance_duration; // 0x1a80
            float damage; // 0x1a84
            float movespeed_duration; // 0x1a88
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_SpiritBreaker_GreaterBash) == 0x1a90);
    };
};
