...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t nDamageInstances; // 0x1a58            
            source2sdk::entity2::GameTime_t m_flLastAttackTime; // 0x1a5c            
            source2sdk::entity2::GameTime_t m_flLastMoveTime; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Seasonal_TI9_Shovel_Ghost_Haunt) == 0x1a68);
    };
};
