...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t projectile_vision_radius; // 0x1a8c
            float projectile_vision_duration; // 0x1a90
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Rattletrap_RocketFlare) == 0x1a98);
    };
};
