...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float barrier_amt; // 0x1a58            
            std::int32_t m_nDamageAbsorbed; // 0x1a5c            
            bool undispellable; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Obsidian_Destroyer_Equilibrium_Barrier) == 0x1a68);
    };
};
