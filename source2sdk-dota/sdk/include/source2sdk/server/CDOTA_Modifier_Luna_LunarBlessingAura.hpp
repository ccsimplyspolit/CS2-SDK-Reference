...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t self_bonus_damage; // 0x1a5c            
            std::int32_t bonus_night_vision; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Luna_LunarBlessingAura) == 0x1a68);
    };
};
