...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::entity2::CEntityIOOutput m_OnEventFired; // 0x4a8            
            CUtlSymbolLarge m_iszGameEventName; // 0x4c0            
            CUtlSymbolLarge m_iszGameEventItem; // 0x4c8            
            bool m_bEnabled; // 0x4d0            
            bool m_bStartDisabled; // 0x4d1            
        ...
        static_assert(sizeof(source2sdk::server::CLogicGameEventListener) == 0x4d8);
    };
};
