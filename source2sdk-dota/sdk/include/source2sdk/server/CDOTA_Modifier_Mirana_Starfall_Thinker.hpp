...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float starfall_secondary_radius; // 0x1a78
            float starstruck_duration; // 0x1a7c
            // m_hTarget has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::server::CBaseEntity> m_hTarget;
            char m_hTarget[0x4]; // 0x1a80
            float m_flDamage; // 0x1a84
            bool m_bStarDropped; // 0x1a88
            bool m_bSecondStar; // 0x1a89
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Mirana_Starfall_Thinker) == 0x1a90);
    };
};
