...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            bool m_bGroundToTree; // 0x1a7c
            bool m_bTreeToGround; // 0x1a7d
            bool m_bTreeToTree; // 0x1a7e
            uint8_t _pad1a7f[0x1]; // 0x1a7f
            float perched_day_vision; // 0x1a80
            float perched_night_vision; // 0x1a84
            bool m_bAbilityIsStolen; // 0x1a88
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_MonkeyKing_BouncePerch) == 0x1a90);
    };
};
