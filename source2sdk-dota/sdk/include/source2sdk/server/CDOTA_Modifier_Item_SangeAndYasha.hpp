...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t bonus_strength; // 0x1a88
            std::int32_t hp_regen_amp; // 0x1a8c
            std::int32_t status_resistance; // 0x1a90
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_SangeAndYasha) == 0x1a98);
    };
};
