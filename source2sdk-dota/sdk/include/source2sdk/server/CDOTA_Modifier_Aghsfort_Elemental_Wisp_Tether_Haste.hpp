...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t attack_speed; // 0x1a7c
            std::int32_t health_regen; // 0x1a80
            std::int32_t status_resist; // 0x1a84
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Aghsfort_Elemental_Wisp_Tether_Haste) == 0x1a88);
    };
};
