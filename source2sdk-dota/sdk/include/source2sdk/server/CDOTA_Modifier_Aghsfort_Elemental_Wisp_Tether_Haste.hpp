...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t attack_speed; // 0x1a5c            
            std::int32_t health_regen; // 0x1a60            
            std::int32_t status_resist; // 0x1a64            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Aghsfort_Elemental_Wisp_Tether_Haste) == 0x1a68);
    };
};
