...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            float radius; // 0x1a78
            std::int32_t movement_speed_pct; // 0x1a7c
            std::int32_t spell_resist_pct; // 0x1a80
            ...
            char m_hChilledEntities[0x18]; // 0x1a88
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Greevil_Miniboss_Blue_IceVortexThinker) == 0x1aa0);
    };
};
