...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::entity2::GameTime_t m_flNextHit; // 0x1a58            
            std::int32_t passive_movement_bonus; // 0x1a5c            
            float range; // 0x1a60            
            std::int32_t damage; // 0x1a64            
            float slow_duration; // 0x1a68            
            float bonus_mana_regen; // 0x1a6c            
            std::int32_t max_targets; // 0x1a70            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Stormcrafter) == 0x1a78);
    };
};
