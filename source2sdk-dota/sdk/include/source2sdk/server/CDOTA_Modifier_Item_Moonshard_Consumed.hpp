...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t consumed_bonus; // 0x1a58            
            std::int32_t consumed_bonus_night_vision; // 0x1a5c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Item_Moonshard_Consumed because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Moonshard_Consumed) == 0x1a60);
    };
};
