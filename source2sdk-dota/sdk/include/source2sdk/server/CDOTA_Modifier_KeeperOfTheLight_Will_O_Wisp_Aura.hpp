...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            float radius; // 0x1a58            
            float wisp_damage; // 0x1a5c            
            float off_duration; // 0x1a60            
            float off_duration_initial; // 0x1a64            
            float on_duration; // 0x1a68            
            std::int32_t hit_count; // 0x1a6c            
            std::int32_t m_iAttackCount; // 0x1a70            
            source2sdk::entity2::GameTime_t m_flNextTimeOn; // 0x1a74            
            ...
            source2sdk::entity2::GameTime_t m_flNextTime; // 0x1a84            
            ...
            char m_vecDamagedEntities[0x18]; // 0x1a88            
            float m_flCorrectionTime; // 0x1aa0            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_KeeperOfTheLight_Will_O_Wisp_Aura) == 0x1aa8);
    };
};
