...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float intellect_damage_pct; // 0x1a78
            ...
            char m_InFlightSilenceAttackRecords[0x18]; // 0x1a98
            source2sdk::client::CDOTA_Buff* m_pAttackCounterBuff; // 0x1ab0
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Silencer_GlaivesOfWisdom because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Silencer_GlaivesOfWisdom) == 0x1ab8);
    };
};
