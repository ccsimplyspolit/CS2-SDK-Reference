...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t m_nDamageToHeroes; // 0x1a58            
            std::int32_t m_nHeroesKilled; // 0x1a5c            
            std::int32_t m_nJumps; // 0x1a60            
            bool m_bFirstJump; // 0x1a64            
