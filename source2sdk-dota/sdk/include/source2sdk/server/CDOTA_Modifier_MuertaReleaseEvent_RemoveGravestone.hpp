...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::client::ParticleIndex_t m_nParticleIndex; // 0x1a78
            ...
            char m_pActiveGravestones[0x8]; // 0x1a80
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_MuertaReleaseEvent_RemoveGravestone) == 0x1a88);
    };
};
