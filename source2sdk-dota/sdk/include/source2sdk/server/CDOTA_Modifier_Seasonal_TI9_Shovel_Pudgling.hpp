...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t m_nActionCount; // 0x1a7c
            VectorWS m_vecStartingPos; // 0x1a80
            Vector m_vecDestinationOffset; // 0x1a8c
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Seasonal_TI9_Shovel_Pudgling) == 0x1ab0);
    };
};
