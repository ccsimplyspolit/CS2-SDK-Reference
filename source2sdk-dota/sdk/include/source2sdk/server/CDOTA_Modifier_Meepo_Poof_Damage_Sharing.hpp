...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t damage_share_percentage; // 0x1a58            
            std::int32_t damage_share_radius; // 0x1a5c            
            ...
            char m_BondedEntities[0x18]; // 0x1a60            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Meepo_Poof_Damage_Sharing because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Meepo_Poof_Damage_Sharing) == 0x1a78);
    };
};
