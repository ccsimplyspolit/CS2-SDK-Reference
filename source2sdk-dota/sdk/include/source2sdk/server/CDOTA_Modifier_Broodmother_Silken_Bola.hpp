...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t miss_chance; // 0x1a80
            std::int32_t shard_miss_chance; // 0x1a84
            std::int32_t roots; // 0x1a88
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Broodmother_Silken_Bola) == 0x1a90);
    };
};
