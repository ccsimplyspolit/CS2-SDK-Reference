...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t effect_radius; // 0x1a78
            std::int32_t caltrops_damage; // 0x1a7c
            std::int32_t activation_radius; // 0x1a80
            float debuff_duration; // 0x1a84
            float activation_delay; // 0x1a88
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Hoodwink_Caltrops) == 0x1a90);
    };
};
