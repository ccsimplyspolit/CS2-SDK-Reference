...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t effect_radius; // 0x1a58            
            std::int32_t caltrops_damage; // 0x1a5c            
            std::int32_t activation_radius; // 0x1a60            
            float debuff_duration; // 0x1a64            
            float activation_delay; // 0x1a68            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Hoodwink_Caltrops) == 0x1a70);
    };
};
