...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hSecondaryTarget[0x4]; // 0x1a7c
            ...
            char m_hTertiaryTarget[0x4]; // 0x1a80
            ...
            char m_hReturnBrewling[0x4]; // 0x1a84
            std::int32_t primal_split_cancel; // 0x1a88
            std::int32_t m_nFXIndex; // 0x1a8c
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Brewmaster_PrimalSplit because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Brewmaster_PrimalSplit) == 0x1a90);
    };
};
