...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t m_iDuration; // 0x18a8
            bool m_bPlacedInSpawnBox; // 0x18ac
            uint8_t _pad18ad[0x3]; // 0x18ad
            source2sdk::entity2::GameTime_t m_flSpawnTime; // 0x18b0
            source2sdk::client::FowCustomTeams_t m_nFoWTeam; // 0x18b4
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_NPC_Observer_Ward because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_NPC_Observer_Ward) == 0x18b8);
    };
};
