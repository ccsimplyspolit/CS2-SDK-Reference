...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::client::soundlevel_t m_iSoundLevel; // 0x4a0            
            source2sdk::server::dynpitchvol_t m_dpv; // 0x4a4            
            bool m_fActive; // 0x508            
            bool m_fLooping; // 0x509            
            uint8_t _pad050a[0x6]; // 0x50a
            CGameSoundEventName m_iszSound; // 0x510            
            ...
            char m_hSoundSource[0x4]; // 0x520            
            // metadata: MNotSaved
            CEntityIndex m_nSoundSourceEntIndex; // 0x524            
            uint8_t _pad0528[0x18];
        ...
        static_assert(sizeof(source2sdk::server::CAmbientGeneric) == 0x540);
    };
};
