...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::uint32_t m_nGiveItemIndicatorID; // 0x16c
            CPlayerSlot nGiverPlayerSlot; // 0x170
            CPlayerSlot nReceiverPlayerSlot; // 0x174
        };
        #pragma pack(pop)
        ...
        static_assert(offsetof(source2sdk::server::CDOTABehaviorCommandMoveToTargetToCast, m_nGiveItemIndicatorID) == 0x16c);
        static_assert(offsetof(source2sdk::server::CDOTABehaviorCommandMoveToTargetToCast, nGiverPlayerSlot) == 0x170);
        static_assert(offsetof(source2sdk::server::CDOTABehaviorCommandMoveToTargetToCast, nReceiverPlayerSlot) == 0x174);

        static_assert(sizeof(source2sdk::server::CDOTABehaviorCommandMoveToTargetToCast) == 0x178);
    };
};
