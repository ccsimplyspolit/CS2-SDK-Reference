...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hLoadedUnit[0x4]; // 0x1a84
            source2sdk::client::ParticleIndex_t m_nBunkerEnterFXIndex; // 0x1a88
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Undying_Tombstone_Bunker) == 0x1a90);
    };
};
