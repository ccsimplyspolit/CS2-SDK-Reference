...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t NUM_SOUNDS; // 0x1a58            
            float dance_interval; // 0x1a5c            
            float gesture_duration; // 0x1a60            
            float catch_up_distance; // 0x1a64            
            float slow_duration; // 0x1a68            
            float slow_amount; // 0x1a6c            
            std::int32_t m_nGesture; // 0x1a70            
            ...
            char m_vecDancers[0x18]; // 0x1a78            
            uint8_t _pad1a90[0x30]; // 0x1a90
            bool m_bIsGesturing; // 0x1ac0            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Seasonal_TI11_CongaLine) == 0x1ac8);
    };
};
