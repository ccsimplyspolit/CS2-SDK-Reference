...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t NUM_SOUNDS; // 0x1a78
            float dance_interval; // 0x1a7c
            float gesture_duration; // 0x1a80
            float catch_up_distance; // 0x1a84
            float slow_duration; // 0x1a88
            float slow_amount; // 0x1a8c
            std::int32_t m_nGesture; // 0x1a90
            ...
            char m_vecDancers[0x18]; // 0x1a98
            uint8_t _pad1ab0[0x30]; // 0x1ab0
            bool m_bIsGesturing; // 0x1ae0
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Seasonal_TI11_CongaLine) == 0x1ae8);
    };
};
