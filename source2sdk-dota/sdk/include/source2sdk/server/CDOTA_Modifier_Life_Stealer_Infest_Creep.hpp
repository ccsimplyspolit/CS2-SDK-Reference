...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            bool m_bChangedTeams; // 0x1a58            
            uint8_t _pad1a59[0x3]; // 0x1a59
            float creep_max_hp_drain_pct_per_second; // 0x1a5c            
            float m_flTickInterval; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Life_Stealer_Infest_Creep) == 0x1a68);
    };
};
