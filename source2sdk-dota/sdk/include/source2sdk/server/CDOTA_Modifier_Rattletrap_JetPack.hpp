...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t m_nMovementSpeed; // 0x1a58            
            std::int32_t bonus_speed; // 0x1a5c            
            float turn_rate; // 0x1a60            
            source2sdk::entity2::GameTime_t m_flStartTime; // 0x1a64            
            float tick_interval; // 0x1a68            
            float m_flFacingTarget; // 0x1a6c            
            ...
            char m_flTurnHistory[0x18]; // 0x1a78            
            ...
            char m_vecHeroesHitLastRicochet[0x18]; // 0x1a90            
            ...
            char m_vecHeroesCredited[0x18]; // 0x1aa8            
            ...
            char m_vecHeroesHitCurrentRicochet[0x18]; // 0x1ac0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Rattletrap_JetPack because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Rattletrap_JetPack) == 0x1ad8);
    };
};
