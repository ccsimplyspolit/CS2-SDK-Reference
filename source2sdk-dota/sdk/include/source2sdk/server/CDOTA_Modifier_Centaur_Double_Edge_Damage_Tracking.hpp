...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float stack_duration; // 0x1a78
            std::int32_t pct_of_incoming_damage_as_bonus; // 0x1a7c
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Centaur_Double_Edge_Damage_Tracking) == 0x1aa0);
    };
};
