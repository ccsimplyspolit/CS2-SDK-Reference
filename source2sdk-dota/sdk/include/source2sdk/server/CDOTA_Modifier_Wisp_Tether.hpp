...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float radius; // 0x1a88            
            float latch_distance; // 0x1a8c            
            std::int32_t damage_absorb; // 0x1a90            
            float m_flHealthHealed; // 0x1a94            
            float m_flManaHealed; // 0x1a98            
            float tether_heal_amp; // 0x1a9c            
            float tether_mana_amp; // 0x1aa0            
            source2sdk::entity2::GameTime_t m_flHealMessageTime; // 0x1aa4            
            source2sdk::entity2::GameTime_t m_flManaMessageTime; // 0x1aa8            
            source2sdk::client::ParticleIndex_t m_nTetherParticle; // 0x1aac            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Wisp_Tether because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Wisp_Tether) == 0x1ab0);
    };
};
