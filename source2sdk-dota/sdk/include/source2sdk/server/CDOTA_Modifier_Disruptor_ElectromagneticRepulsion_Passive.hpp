...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float damage_threshold; // 0x1a78
            float effect_radius; // 0x1a7c
            float knockback_duration; // 0x1a80
            float damage_reset_interval; // 0x1a84
            float m_flAccumulatedDamage; // 0x1a88
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Disruptor_ElectromagneticRepulsion_Passive) == 0x1a90);
    };
};
