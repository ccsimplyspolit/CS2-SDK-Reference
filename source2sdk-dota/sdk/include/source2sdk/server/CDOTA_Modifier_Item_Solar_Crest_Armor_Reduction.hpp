...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t target_armor; // 0x1a58            
            std::int32_t target_attack_speed; // 0x1a5c            
            std::int32_t target_movement_speed; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Solar_Crest_Armor_Reduction) == 0x1a68);
    };
};
