...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t m_nStacksSeenByTeam[2]; // 0x558
            ...
            source2sdk::entity2::CEntityIOOutput m_OnSpawnerExhausted; // 0x580
            std::int32_t m_Type; // 0x598
            std::int32_t m_PullType; // 0x59c
            std::int32_t m_AggroType; // 0x5a0
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_NeutralSpawner) == 0x5a8);
    };
};
