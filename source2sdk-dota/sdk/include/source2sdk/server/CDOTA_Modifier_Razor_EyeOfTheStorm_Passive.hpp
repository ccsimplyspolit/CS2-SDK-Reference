...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t passive_area_damage; // 0x1a78
            float passive_area_interval; // 0x1a7c
            std::int32_t radius; // 0x1a80
            bool m_bHitNext; // 0x1a84
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Razor_EyeOfTheStorm_Passive) == 0x1a88);
    };
};
