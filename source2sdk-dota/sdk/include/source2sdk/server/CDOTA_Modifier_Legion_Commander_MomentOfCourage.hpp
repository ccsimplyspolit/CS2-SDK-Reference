...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t trigger_attacks; // 0x1a78
            float buff_duration; // 0x1a7c
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Legion_Commander_MomentOfCourage) == 0x1a80);
    };
};
