...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            VectorWS m_vStartLoc; // 0x1a78
            bool m_bIsReflection; // 0x1a84
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Kunkka_XMarksTheSpot_Thinker) == 0x1a90);
    };
};
