...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t armor_penalty_aura; // 0x1a78
            std::int32_t damage_penalty_aura; // 0x1a7c
            float aura_dps; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_WraithPact_DeathAura) == 0x1a88);
    };
};
