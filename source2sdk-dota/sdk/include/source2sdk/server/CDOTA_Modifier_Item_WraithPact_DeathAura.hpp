...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t armor_penalty_aura; // 0x1a58            
            std::int32_t damage_penalty_aura; // 0x1a5c            
            float aura_dps; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_WraithPact_DeathAura) == 0x1a68);
    };
};
