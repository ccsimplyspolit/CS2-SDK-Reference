...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t m_iParticleMouthIndex; // 0x1f08
            std::int32_t m_iParticleHandRIndex; // 0x1f0c
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Unit_Hero_CrystalMaiden because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_Unit_Hero_CrystalMaiden) == 0x1f10);
    };
};
