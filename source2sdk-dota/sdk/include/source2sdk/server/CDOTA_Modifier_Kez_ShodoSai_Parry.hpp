...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t speed_penalty; // 0x1a78
            std::int32_t forward_angle; // 0x1a7c
            float vuln_duration; // 0x1a80
            float parry_window_duration; // 0x1a84
            float parry_stun_duration; // 0x1a88
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Kez_ShodoSai_Parry) == 0x1ad0);
    };
};
