...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hRune[0x4]; // 0x150            
            uint8_t _pad0154[0x4];
        };
        #pragma pack(pop)
        
        static_assert(offsetof(source2sdk::server::CDOTABehaviorCommandMoveToRuneToTake, m_MoveTo) == 0x68);
        static_assert(offsetof(source2sdk::server::CDOTABehaviorCommandMoveToRuneToTake, m_hRune) == 0x150);
        
        static_assert(sizeof(source2sdk::server::CDOTABehaviorCommandMoveToRuneToTake) == 0x158);
    };
};
