...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            bool m_bInsideRadius; // 0x1a58            
            uint8_t _pad1a59[0x3]; // 0x1a59
            float radius; // 0x1a5c            
            std::int32_t inside_radius_bonus_damage_pct; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Terrorblade_Dark_Unity) == 0x1a68);
    };
};
