...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float mana_multiplier; // 0x1a78
            float barrier_duration; // 0x1a7c
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Crystal_Maiden_GlacialGuard_Passive) == 0x1a80);
    };
};
