...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t m_nHighestLevelInCurrentGame; // 0x7d8            
            uint8_t _pad07dc[0x4c]; // 0x7dc
