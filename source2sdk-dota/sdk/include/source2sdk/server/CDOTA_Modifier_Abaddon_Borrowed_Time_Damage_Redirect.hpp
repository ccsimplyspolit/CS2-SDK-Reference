...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float m_fDamageTaken; // 0x1a58            
            std::int32_t ally_threshold_scepter; // 0x1a5c            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Abaddon_Borrowed_Time_Damage_Redirect) == 0x1a60);
    };
};
