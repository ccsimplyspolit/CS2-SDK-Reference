...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::CDOTABehaviorMoveTo, m_nIdleActivity) == 0xd4);
        static_assert(offsetof(source2sdk::server::CDOTABehaviorMoveTo, m_nRunActivity) == 0xd8);
