...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t bonus_hp_per_creep; // 0x1a58            
            std::int32_t bonus_hp_per_hero; // 0x1a5c            
            std::int32_t m_nTotalBonusHP; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Lifestealer_CorpseEater) == 0x1a68);
    };
};
