...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            Vector m_vDirection; // 0x1a5c            
            float m_flEndTime; // 0x1a68            
            float m_flCurTime; // 0x1a6c            
            float push_length; // 0x1a70            
            float push_duration; // 0x1a74            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Rattletrap_CogPush because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Rattletrap_CogPush) == 0x1a78);
    };
};
