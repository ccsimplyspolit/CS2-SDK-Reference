...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            CUtlString m_strActivityModifier; // 0x1a58            
            ...
            char m_vecAbilities[0x18]; // 0x1a60            
            bool m_bUsesTwoSlots; // 0x1a78            
            uint8_t _pad1a79[0x3]; // 0x1a79
            std::int32_t stolen_debuff_amp; // 0x1a7c            
            float stolen_mana_reduction; // 0x1a80            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Rubick_SpellSteal) == 0x1a88);
    };
};
