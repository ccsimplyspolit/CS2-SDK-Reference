...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t damage_per_tree; // 0x1a58            
            std::int32_t slow_per_tree; // 0x1a5c            
            std::int32_t m_nTreeCount; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Furion_CurseOfTheForest) == 0x1a68);
    };
};
