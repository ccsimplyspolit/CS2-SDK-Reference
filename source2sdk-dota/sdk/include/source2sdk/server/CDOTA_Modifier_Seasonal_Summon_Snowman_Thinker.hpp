...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float grace_period; // 0x1a58            
            std::int32_t search_distance; // 0x1a5c            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Seasonal_Summon_Snowman_Thinker) == 0x1a68);
    };
};
