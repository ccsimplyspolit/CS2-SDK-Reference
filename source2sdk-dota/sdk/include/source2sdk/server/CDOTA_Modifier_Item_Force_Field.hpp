...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float bonus_aoe_radius; // 0x1a7c
            std::int32_t self_armor; // 0x1a80
            std::int32_t self_mres; // 0x1a84
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Item_Force_Field because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Force_Field) == 0x1a88);
    };
};
