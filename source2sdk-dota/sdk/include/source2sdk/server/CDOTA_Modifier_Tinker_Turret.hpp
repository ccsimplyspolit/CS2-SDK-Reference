...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hTarget[0x4]; // 0x1ab8
            source2sdk::entity2::GameTime_t m_flLastMissileFiredTime; // 0x1abc
            bool m_bFixedDirection; // 0x1ac0
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Tinker_Turret) == 0x1ac8);
    };
};
