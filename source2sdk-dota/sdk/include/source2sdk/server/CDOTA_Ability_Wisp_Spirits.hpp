...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_SpiritDefs[0x18]; // 0x580            
            std::int32_t m_nWispDirection; // 0x598            
            std::int32_t spirit_amount; // 0x59c            
            float m_flStartSpiritRadius; // 0x5a0            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Wisp_Spirits) == 0x5a8);
    };
};
