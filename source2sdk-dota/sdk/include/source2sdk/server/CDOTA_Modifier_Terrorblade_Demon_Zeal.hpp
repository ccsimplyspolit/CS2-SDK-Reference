...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t berserk_bonus_armor; // 0x1a80
            std::int32_t hp_regen; // 0x1a84
            std::int32_t reflection_pct; // 0x1a88
            std::int32_t melee_bonus; // 0x1a8c
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Terrorblade_Demon_Zeal because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Terrorblade_Demon_Zeal) == 0x1a90);
    };
};
