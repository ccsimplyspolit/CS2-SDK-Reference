...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hLinkedEntities[0x18]; // 0x1a78
            float coil_radius; // 0x1a90
            float coil_break_radius; // 0x1a94
            float coil_initial_damage; // 0x1a98
            float coil_stun_duration; // 0x1a9c
            float coil_duration; // 0x1aa0
            float coil_break_damage; // 0x1aa4
            bool pierces_debuff_immunity; // 0x1aa8
            uint8_t _pad1aa9[0x7]; // 0x1aa9
