...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hLinkedEntities[0x18]; // 0x1a58            
            float coil_radius; // 0x1a70            
            float coil_break_radius; // 0x1a74            
            float coil_initial_damage; // 0x1a78            
            float coil_stun_duration; // 0x1a7c            
            float coil_duration; // 0x1a80            
            float coil_break_damage; // 0x1a84            
            bool pierces_debuff_immunity; // 0x1a88            
