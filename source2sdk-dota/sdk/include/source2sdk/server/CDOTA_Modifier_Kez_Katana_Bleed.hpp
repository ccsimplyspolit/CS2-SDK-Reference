...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t m_nDamagePerTick; // 0x1a58            
            source2sdk::client::ParticleIndex_t m_nBleedFXIndex; // 0x1a5c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Kez_Katana_Bleed because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Kez_Katana_Bleed) == 0x1a60);
    };
};
