...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t level; // 0x1a58            
            std::int32_t armor; // 0x1a5c            
            std::int32_t mana; // 0x1a60            
            float attack_range; // 0x1a64            
            float armor_per_attack; // 0x1a68            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_ForgedSpirit_Stats) == 0x1a70);
    };
};
