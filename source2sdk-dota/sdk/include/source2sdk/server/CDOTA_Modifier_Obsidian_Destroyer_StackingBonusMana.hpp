...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float mana_increase; // 0x1a78
            float mana_increase_duration; // 0x1a7c
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Obsidian_Destroyer_StackingBonusMana) == 0x1a98);
    };
};
