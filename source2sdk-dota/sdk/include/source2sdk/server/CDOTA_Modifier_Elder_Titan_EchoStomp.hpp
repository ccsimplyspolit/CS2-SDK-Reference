...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t wake_damage_limit; // 0x1a58            
            float animation_rate; // 0x1a5c            
            float initial_stun_duration; // 0x1a60            
            uint8_t _pad1a64[0x4]; // 0x1a64
            source2sdk::server::CountdownTimer ctStunTimer; // 0x1a68            
            float m_flDamageTaken; // 0x1a80            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Elder_Titan_EchoStomp) == 0x1a88);
    };
};
