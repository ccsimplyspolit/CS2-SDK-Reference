...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float ground_duration; // 0x1a78
            float poison_duration; // 0x1a7c
            float damage; // 0x1a80
            float radius; // 0x1a84
            bool m_bDelayed; // 0x1a88
            bool m_bAttackLanded; // 0x1a89
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_HydrasBreath_Thinker) == 0x1a90);
    };
};
