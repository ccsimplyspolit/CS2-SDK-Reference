...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float aura_damage; // 0x1a58            
            std::int32_t heal_reduction_pct; // 0x1a5c            
            float heal_regen_to_damage; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Necrolyte_Heartstopper_Aura_Effect) == 0x1a68);
    };
};
