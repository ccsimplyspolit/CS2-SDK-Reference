...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t backstab_damage; // 0x1a60            
            std::int32_t backstab_angle; // 0x1a64            
            float slow_duration; // 0x1a68            
            bool m_bBackstab; // 0x1a6c            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_LanceOfPursuit) == 0x1a70);
    };
};
