...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t bonus_chance; // 0x1a5c            
            std::int32_t bonus_chance_damage; // 0x1a60            
            std::int32_t bonus_damage; // 0x1a64            
            std::int32_t melee_attack_range; // 0x1a68            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_MonkeyKingBar) == 0x1a88);
    };
};
