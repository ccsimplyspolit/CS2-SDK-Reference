...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t health_per_upgrade; // 0x1a5c            
            std::int32_t iCurrentCount; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Centaur_Innate_Rawhide) == 0x1a68);
    };
};
