...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float freeze_radius; // 0x1a78
            std::int32_t freeze_damage; // 0x1a7c
            float freeze_debuff_duration; // 0x1a80
            float freeze_delay; // 0x1a84
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_AghsFort_BossWinterWyvern_Cold_Embrace_Thinker) == 0x1a90);
    };
};
