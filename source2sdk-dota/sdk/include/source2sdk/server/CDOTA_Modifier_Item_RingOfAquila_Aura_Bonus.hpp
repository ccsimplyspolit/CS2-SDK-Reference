...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t aura_bonus_armor; // 0x1a78
            float aura_mana_regen; // 0x1a7c
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Item_RingOfAquila_Aura_Bonus because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_RingOfAquila_Aura_Bonus) == 0x1a80);
    };
};
