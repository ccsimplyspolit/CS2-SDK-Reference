...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float remnant_watch_radius; // 0x1a58            
            source2sdk::entity2::GameTime_t m_flLastDamageTick; // 0x1a5c            
            float damage_tick_rate; // 0x1a60            
            float m_flDamage; // 0x1a64            
            bool m_bPiercesCreeps; // 0x1a68            
            bool bIsArtifice; // 0x1a69            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_VoidSpirit_AetherRemnant_WatchThinker) == 0x1a70);
    };
};
