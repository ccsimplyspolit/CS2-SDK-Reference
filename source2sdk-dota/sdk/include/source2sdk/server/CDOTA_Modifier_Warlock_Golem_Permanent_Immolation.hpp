...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t share_damage; // 0x1a5c            
            float manahealthboost; // 0x1a60            
            float manaboost_scale_mult; // 0x1a64            
            float m_flAdditionalDamage; // 0x1a68            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Warlock_Golem_Permanent_Immolation) == 0x1a70);
    };
};
