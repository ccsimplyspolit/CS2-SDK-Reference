...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float path_radius; // 0x1a68            
            float cast_range; // 0x1a6c            
            float linger_duration; // 0x1a70            
            bool m_bTestedGem; // 0x1a74            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Jakiro_Macropyre_Thinker) == 0x1a78);
    };
};
