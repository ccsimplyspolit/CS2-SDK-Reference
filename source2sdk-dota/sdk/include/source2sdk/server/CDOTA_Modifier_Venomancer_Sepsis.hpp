...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float bonus_dmg_per_debuff_pct; // 0x1a58            
            bool apply_from_ward_attacks; // 0x1a5c            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Venomancer_Sepsis) == 0x1a60);
    };
};
