...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float bonus_dmg_per_debuff_pct; // 0x1a78
            bool apply_from_ward_attacks; // 0x1a7c
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Venomancer_Sepsis) == 0x1a80);
    };
};
