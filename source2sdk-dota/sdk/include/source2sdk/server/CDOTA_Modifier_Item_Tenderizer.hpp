...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t bash_chance_melee; // 0x1a60            
            std::int32_t bash_chance_ranged; // 0x1a64            
            float bash_duration; // 0x1a68            
            float bash_cooldown; // 0x1a6c            
            std::int32_t bonus_chance_damage; // 0x1a70            
            std::int32_t bonus_damage; // 0x1a74            
            std::int32_t weaken_per_hit; // 0x1a78            
            float weaken_duration; // 0x1a7c            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Tenderizer) == 0x1a98);
    };
};
