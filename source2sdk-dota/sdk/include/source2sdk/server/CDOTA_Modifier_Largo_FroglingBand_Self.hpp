...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t max_froglings; // 0x1a78
            std::int32_t m_nNumFroglings; // 0x1a7c
            ...
            char m_vecFroglings[0x18]; // 0x1a80
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Largo_FroglingBand_Self because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Largo_FroglingBand_Self) == 0x1a98);
    };
};
