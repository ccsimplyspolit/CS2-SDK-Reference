...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float latch_range; // 0x1a58            
            float initial_latch_delay; // 0x1a5c            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Treant_NaturesGrasp_Latch_Thinker) == 0x1a78);
    };
};
