...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            HSCRIPT m_hHorizontalControlFunction; // 0x1a58            
            HSCRIPT m_hVerticalControlFunction; // 0x1a60            
            HSCRIPT m_hOnDestroyFunction; // 0x1a68            
            ...
            char m_parameterTable[0x10]; // 0x1a70            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_ScriptedMotionController because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_ScriptedMotionController) == 0x1a80);
    };
};
