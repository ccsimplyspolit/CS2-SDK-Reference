...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // CUtlVector<source2sdk::server::CDOTA_Modifier_Visage_GravekeepersCloak_Stack*> m_vecStacks;
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Visage_GravekeepersCloak) == 0x1aa8);
    };
};
