...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t slow_movement_speed_pct; // 0x1a78
            std::int32_t slow_attack_speed_pct; // 0x1a7c
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Beastmaster_PrimalRoar_Slow because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Beastmaster_PrimalRoar_Slow) == 0x1a80);
    };
};
