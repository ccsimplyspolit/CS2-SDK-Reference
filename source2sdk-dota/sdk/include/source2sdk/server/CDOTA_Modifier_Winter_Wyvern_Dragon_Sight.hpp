...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t attack_range_per_damage; // 0x1a58            
            std::int32_t attack_range_min; // 0x1a5c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Winter_Wyvern_Dragon_Sight because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Winter_Wyvern_Dragon_Sight) == 0x1a60);
    };
};
