...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t hop_height; // 0x1a7c
            std::int32_t hop_distance; // 0x1a80
            float m_flStartZ; // 0x1a84
            float m_flCurTime; // 0x1a88
            float m_flJumpDuration; // 0x1a8c
            float m_flJumpHeight; // 0x1a90
            ...
            char hUnitsToHit[0x18]; // 0x1aa0
            bool m_bLaunched; // 0x1ab8
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Enchantress_Bunny_Hop) == 0x1ac0);
    };
};
