...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t illusion_outgoing_damage; // 0x1a5c            
            std::int32_t illusion_incoming_damage; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Shadow_Demon_Shadow_Servant) == 0x1a68);
    };
};
