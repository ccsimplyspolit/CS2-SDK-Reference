...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t jump_range; // 0x1a78
            std::int32_t max_targets; // 0x1a7c
            float damage_percent_loss; // 0x1a80
            float m_flCurDamage; // 0x1a84
            VectorWS m_vJumpPosition; // 0x1a88
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_HarpyStorm_ChainLightning) == 0x1ab0);
    };
};
