...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t max_targets; // 0x1a7c
            std::int32_t damage_percent_add; // 0x1a80
            float jump_delay; // 0x1a84
            std::int32_t m_iFixedDamage; // 0x1a88
            source2sdk::entity2::GameTime_t m_flLastTickTime; // 0x1a8c
            float m_flTimeAccumulator; // 0x1a90
            ...
            char m_hHitTargets[0x18]; // 0x1a98
            std::int32_t m_nBaseDamage; // 0x1ab0
            std::int32_t m_nMaxTargets; // 0x1ab4
            float m_flJumpDelay; // 0x1ab8
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Furion_WrathOfNature_Thinker) == 0x1ac0);
    };
};
