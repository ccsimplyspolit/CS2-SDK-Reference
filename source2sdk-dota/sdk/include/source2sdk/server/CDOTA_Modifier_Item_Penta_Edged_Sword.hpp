...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t maim_chance; // 0x1a7c
            float maim_duration; // 0x1a80
            std::int32_t melee_attack_range; // 0x1a84
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Item_Penta_Edged_Sword because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Penta_Edged_Sword) == 0x1a88);
    };
};
