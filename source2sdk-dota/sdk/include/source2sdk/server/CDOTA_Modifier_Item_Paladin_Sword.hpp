...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t bonus_lifesteal; // 0x1a7c
            std::int32_t bonus_spell_lifesteal; // 0x1a80
            std::int32_t bonus_amp; // 0x1a84
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Paladin_Sword) == 0x1a90);
    };
};
