...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t creep_lifesteal_reduction_pct; // 0x1a80
            std::int32_t shared_healing_percent; // 0x1a84
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Marci_Bodyguard_Self) == 0x1a90);
    };
};
