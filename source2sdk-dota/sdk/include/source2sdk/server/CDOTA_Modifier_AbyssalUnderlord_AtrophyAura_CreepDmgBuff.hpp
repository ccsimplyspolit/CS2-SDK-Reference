...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float bonus_damage_from_creep; // 0x1a58            
            float bonus_shared_by_allies_pct; // 0x1a5c            
            float m_flModifier; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_AbyssalUnderlord_AtrophyAura_CreepDmgBuff) == 0x1a68);
    };
};
