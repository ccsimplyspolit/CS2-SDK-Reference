...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t speed; // 0x1a98
            std::int32_t radius; // 0x1a9c
            std::int32_t start_radius; // 0x1aa0
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_AghsFort_PoisonNova_Creature_Thinker) == 0x1aa8);
    };
};
