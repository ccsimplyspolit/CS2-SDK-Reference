...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t attack_range_bonus; // 0x1a78
            std::int32_t bonus_health; // 0x1a7c
            std::int32_t bonus_attackspeed; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Enchantress_Enchant_Intrinsic) == 0x1a90);
    };
};
