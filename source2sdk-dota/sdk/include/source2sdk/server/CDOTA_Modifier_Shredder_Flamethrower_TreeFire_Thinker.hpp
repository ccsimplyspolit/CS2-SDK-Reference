...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_vecTreeFires[0x18]; // 0x1a58            
            bool m_bCleanupWhenEmpty; // 0x1a70            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Shredder_Flamethrower_TreeFire_Thinker) == 0x1a78);
    };
};
