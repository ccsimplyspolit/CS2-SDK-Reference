...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float recoil_duration; // 0x1a78
            std::int32_t recoil_height; // 0x1a7c
            std::int32_t recoil_distance; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Hoodwink_Sharpshooter_Recoil) == 0x1aa0);
    };
};
