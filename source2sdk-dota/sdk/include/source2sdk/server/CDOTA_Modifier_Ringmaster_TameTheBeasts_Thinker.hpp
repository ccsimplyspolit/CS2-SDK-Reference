...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float m_flRadiusChannelPct; // 0x1a78
            float m_flDamageChannelPct; // 0x1a7c
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Ringmaster_TameTheBeasts_Thinker) == 0x1a80);
    };
};
