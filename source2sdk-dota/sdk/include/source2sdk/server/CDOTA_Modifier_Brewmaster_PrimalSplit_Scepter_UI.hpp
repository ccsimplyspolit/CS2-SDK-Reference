...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t hp_per_attribute; // 0x1a78
            std::int32_t dmg_per_attribute; // 0x1a7c
            std::int32_t attribute_share_pct; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Brewmaster_PrimalSplit_Scepter_UI) == 0x1a88);
    };
};
