...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            Vector m_vecStart; // 0x1a58            
            Vector m_vecEnd; // 0x1a64            
            float m_flRadius; // 0x1a70            
            bool m_bHidden; // 0x1a74            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_TutorialNPCBlocker_Thinker) == 0x1a78);
    };
};
