...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            Vector m_vecStart; // 0x1a78
            Vector m_vecEnd; // 0x1a84
            float m_flRadius; // 0x1a90
            bool m_bHidden; // 0x1a94
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_TutorialNPCBlocker_Thinker) == 0x1a98);
    };
};
