...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t percent_damage_per_burn; // 0x1a78
            std::int32_t mana_per_hit; // 0x1a7c
            float mana_per_hit_pct; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_AntiMage_ManaBreak) == 0x1a88);
    };
};
