...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t percent_damage_per_burn; // 0x1a58            
            std::int32_t mana_per_hit; // 0x1a5c            
            float mana_per_hit_pct; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_AntiMage_ManaBreak) == 0x1a68);
    };
};
