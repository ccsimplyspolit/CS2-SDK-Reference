...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t max_armor_piercing_pct; // 0x1a78
            std::int32_t allowed_particle_arrows; // 0x1a7c
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Clinkz_Infernal_Shred_ArmorPiercing) == 0x1a88);
    };
};
