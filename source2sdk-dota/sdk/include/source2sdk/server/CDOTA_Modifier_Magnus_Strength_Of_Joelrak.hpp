...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t strength_per_stack; // 0x1a78
            std::int32_t max_stacks; // 0x1a7c
            float stack_duration; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Magnus_Strength_Of_Joelrak) == 0x1a88);
    };
};
