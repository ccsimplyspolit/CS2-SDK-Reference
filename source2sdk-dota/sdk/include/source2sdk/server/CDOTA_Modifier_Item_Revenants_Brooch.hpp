...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float spell_lifesteal; // 0x1a7c
            std::int32_t crit_chance; // 0x1a80
            float crit_multiplier; // 0x1a84
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Item_Revenants_Brooch because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Revenants_Brooch) == 0x1a88);
    };
};
