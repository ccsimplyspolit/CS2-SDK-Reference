...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float pulse_move_slow_pct; // 0x1a58            
            float pulse_attack_slow_pct; // 0x1a5c            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Marci_Unleash_FlurryPulse_Debuff) == 0x1a60);
    };
};
