...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float explosion_radius; // 0x1a78
            float explosion_nonhero_reduce; // 0x1a7c
            float imp_explode; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Warlock_Imp_ExplodeThinker) == 0x1a88);
    };
};
