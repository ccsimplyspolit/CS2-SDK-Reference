...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float explosion_radius; // 0x1a58            
            float explosion_nonhero_reduce; // 0x1a5c            
            float imp_explode; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Warlock_Imp_ExplodeThinker) == 0x1a68);
    };
};
