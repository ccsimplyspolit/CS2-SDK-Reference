...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            bool m_bForceSetToPudgePosition; // 0x5c9            
            uint8_t _pad05ca[0x2]; // 0x5ca
            source2sdk::client::ParticleIndex_t m_iChainParticle; // 0x5cc            
            source2sdk::client::ParticleIndex_t m_iSecondaryChainParticle; // 0x5d0            
            std::int32_t m_hHookProjectile; // 0x5d4            
            std::int32_t m_nManaCost; // 0x5d8            
            ...
            char m_hSourceCaster[0x4]; // 0x5dc            
            std::int32_t m_nNextConsecutiveHitCount; // 0x5e0            
            VectorWS m_vEndpoint; // 0x5e4            
            std::int32_t m_nConsecutiveHits; // 0x5f0            
            bool m_bIsVectorTargeted; // 0x5f4            
            uint8_t _pad05f5[0x3]; // 0x5f5
            VectorWS m_vTurnLocation; // 0x5f8            
            Vector m_vDirectionAfterTurn; // 0x604            
            bool m_bHasTurned; // 0x610            
            uint8_t _pad0611[0x3]; // 0x611
            float m_flDistanceAfterTurn; // 0x614            
            VectorWS m_vFinalPosition; // 0x618            
            float reveal_duration; // 0x624            
            std::int32_t curve_hook; // 0x628            
            float curve_hook_turn_rate; // 0x62c            
            std::int32_t curve_hook_debug; // 0x630            
            float m_fTimeRemaining; // 0x634            
            float m_flFacingTarget; // 0x638            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Pudge_MeatHook) == 0x640);
    };
};
