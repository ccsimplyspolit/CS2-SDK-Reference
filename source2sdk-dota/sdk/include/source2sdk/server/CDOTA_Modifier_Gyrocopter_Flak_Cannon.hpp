...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Gyrocopter_Flak_Cannon) == 0x1a70);
    };
};
