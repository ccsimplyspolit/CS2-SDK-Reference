...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t m_iWisdomShrinesTaken; // 0xf54
            float m_flDamageByTypeReceivedPreReduction[3]; // 0xf58
            float m_flDamageByTypeReceivedPostReduction[3]; // 0xf64
            float m_flOutgoingDamageByTypePreReduction[3]; // 0xf70
            float m_flOutgoingDamageByTypePostReduction[3]; // 0xf7c
            source2sdk::client::OverworldID_t m_uSelectedOverworldID; // 0xf88
            source2sdk::client::OverworldTokenID_t m_uSelectedOverworldTokenRewards[3]; // 0xf89
            source2sdk::client::OverworldTarotCardID_t m_uOverworldFortune[3]; // 0xf8c
            uint8_t _pad0f8f[0x1]; // 0xf8f
            std::int32_t m_iCommandsIssued; // 0xf90
            std::int32_t m_iGoldSpentOnConsumables; // 0xf94
            std::int32_t m_iGoldSpentOnItems; // 0xf98
            std::int32_t m_iGoldSpentOnBuybacks; // 0xf9c
            std::int32_t m_iGoldLostToDeath; // 0xfa0
            bool m_bIsNewPlayer; // 0xfa4
            bool m_bIsGuidePlayer; // 0xfa5
            uint8_t _pad0fa6[0x2]; // 0xfa6
        ...
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iWisdomShrinesTaken) == 0xf54);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_flDamageByTypeReceivedPreReduction) == 0xf58);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_flDamageByTypeReceivedPostReduction) == 0xf64);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_flOutgoingDamageByTypePreReduction) == 0xf70);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_flOutgoingDamageByTypePostReduction) == 0xf7c);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_uSelectedOverworldID) == 0xf88);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_uSelectedOverworldTokenRewards) == 0xf89);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_uOverworldFortune) == 0xf8c);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iCommandsIssued) == 0xf90);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iGoldSpentOnConsumables) == 0xf94);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iGoldSpentOnItems) == 0xf98);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iGoldSpentOnBuybacks) == 0xf9c);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_iGoldLostToDeath) == 0xfa0);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_bIsNewPlayer) == 0xfa4);
        static_assert(offsetof(source2sdk::server::DataTeamPlayer_t, m_bIsGuidePlayer) == 0xfa5);
