...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            VectorWS m_vecReturnPosition; // 0x1a7c
            float return_time; // 0x1a88
            source2sdk::client::ParticleIndex_t m_nFXTimeRemaining; // 0x1a8c
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Wisp_Relocate_Return because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Wisp_Relocate_Return) == 0x1a90);
    };
};
