...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float hp_regen; // 0x1a7c
            bool m_bOverrideArmor; // 0x1a80
            bool m_bOverrideRegen; // 0x1a81
            bool m_bSentFirstRefresh; // 0x1a82
            uint8_t _pad1a83[0x5];
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Tower_Aura_Bonus because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Tower_Aura_Bonus) == 0x1a88);
    };
};
