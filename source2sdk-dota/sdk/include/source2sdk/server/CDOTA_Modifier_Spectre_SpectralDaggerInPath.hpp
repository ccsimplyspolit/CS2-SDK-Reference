...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t bonus_movespeed; // 0x1a58            
            ...
            char m_hTrackingTarget[0x4]; // 0x1a5c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Spectre_SpectralDaggerInPath because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Spectre_SpectralDaggerInPath) == 0x1a60);
    };
};
