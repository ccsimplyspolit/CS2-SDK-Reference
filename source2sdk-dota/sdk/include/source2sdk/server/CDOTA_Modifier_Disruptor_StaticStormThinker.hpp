...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t m_nCurrentPulse; // 0x1a78
            float radius; // 0x1a7c
            std::int32_t damage_max; // 0x1a80
            std::int32_t pulses; // 0x1a84
            float duration; // 0x1a88
            bool m_bHasGrantedThreeHeroKillEater; // 0x1a8c
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Disruptor_StaticStormThinker) == 0x1a90);
    };
};
