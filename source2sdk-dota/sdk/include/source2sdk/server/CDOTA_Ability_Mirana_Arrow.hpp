...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float scepter_radius; // 0x584            
            VectorWS m_vStartPos; // 0x588            
            ...
            char hAlreadyHitList[0x30]; // 0x598            
            ...
            char hStarfallList[0x30]; // 0x5c8            
            std::int32_t m_nActiveArrow; // 0x5f8            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Mirana_Arrow) == 0x600);
    };
};
