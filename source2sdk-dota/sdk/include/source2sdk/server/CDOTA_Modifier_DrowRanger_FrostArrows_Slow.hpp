...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t frost_arrows_movement_speed; // 0x1a78
            std::int32_t shard_max_stacks; // 0x1a7c
            float shard_stack_duration; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_DrowRanger_FrostArrows_Slow) == 0x1a88);
    };
};
