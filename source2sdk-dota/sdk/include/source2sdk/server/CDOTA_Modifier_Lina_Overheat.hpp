...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float damage_aoe; // 0x1a7c
            float damage; // 0x1a80
            float damage_illusions; // 0x1a84
            std::int32_t damage_threshold; // 0x1a88
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Lina_Overheat) == 0x1a90);
    };
};
