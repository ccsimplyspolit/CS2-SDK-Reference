...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float time_between_flurries; // 0x1a78
            std::int32_t charges_per_flurry; // 0x1a7c
            std::int32_t flurry_charge_increment; // 0x1a80
            std::int32_t bonus_movespeed; // 0x1a84
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Marci_Unleash) == 0x1aa0);
    };
};
