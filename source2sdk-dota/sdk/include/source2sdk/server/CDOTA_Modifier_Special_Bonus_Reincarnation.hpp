...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            float value; // 0x1a78
            float reincarnate_time; // 0x1a7c
            source2sdk::entity2::GameTime_t m_fLastReincarnationTime; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Special_Bonus_Reincarnation) == 0x1a88);
    };
};
