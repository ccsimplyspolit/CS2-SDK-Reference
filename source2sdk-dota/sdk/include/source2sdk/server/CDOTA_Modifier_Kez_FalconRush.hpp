...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t slow_resist; // 0x1a5c            
            float rush_speed; // 0x1a60            
            float rush_range; // 0x1a64            
            float break_range; // 0x1a68            
            bool m_bInRush; // 0x1a6c            
            ...
            source2sdk::client::ParticleIndex_t m_nFXStackIndex; // 0x1a78            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Kez_FalconRush) == 0x1a80);
    };
};
