...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t slow_resist; // 0x1a7c
            float rush_speed; // 0x1a80
            float rush_range; // 0x1a84
            float break_range; // 0x1a88
            bool m_bInRush; // 0x1a8c
            ...
            source2sdk::client::ParticleIndex_t m_nFXStackIndex; // 0x1a98
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Kez_FalconRush) == 0x1aa0);
    };
};
