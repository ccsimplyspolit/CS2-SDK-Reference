...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            bool m_bChargeFinished; // 0x590            
            bool m_bPlayedChargeAnimation; // 0x591            
            bool m_bPinning; // 0x592            
            uint8_t _pad0593[0x1]; // 0x593
            source2sdk::entity2::GameTime_t m_flPinStartTime; // 0x594            
            VectorWS m_vProjectileLocation; // 0x598            
            VectorWS m_vTargetLocation; // 0x5a4            
            ...
            char m_hTrackingProjectileHits[0x18]; // 0x5b8            
            ...
            char m_hTrackingProjectileTrees[0x18]; // 0x5d0            
            std::int32_t nFXIndex; // 0x5e8            
            std::int32_t m_iCurProjectileIndex; // 0x5ec            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Ability_NianCharge because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_NianCharge) == 0x5f0);
    };
};
