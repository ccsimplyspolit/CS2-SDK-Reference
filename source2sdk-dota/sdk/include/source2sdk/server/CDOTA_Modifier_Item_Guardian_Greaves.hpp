...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t bonus_movement; // 0x1a58            
            std::int32_t bonus_mana; // 0x1a5c            
            std::int32_t bonus_mres; // 0x1a60            
            std::int32_t bonus_armor; // 0x1a64            
            float aura_radius; // 0x1a68            
            float mana_regen; // 0x1a6c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Item_Guardian_Greaves because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Guardian_Greaves) == 0x1a70);
    };
};
