...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // metadata: MNotSaved
            std::int32_t m_nPushEnumCount; // 0x3c8            
            uint8_t _pad03cc[0x4]; // 0x3cc
            // metadata: MNotSaved
            source2sdk::server::CCollisionProperty* m_pCollision; // 0x3d0            
            ...
            source2sdk::client::BloodType m_nBloodType; // 0x494            
        ...
        static_assert(sizeof(source2sdk::server::CBaseEntity) == 0x498);
    };
};
