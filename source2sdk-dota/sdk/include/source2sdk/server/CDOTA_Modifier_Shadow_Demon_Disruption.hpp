...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float m_flHealth; // 0x1a78
            float m_flDisseminate_Duration; // 0x1a7c
            ...
            char m_hDisseminateAbility[0x4]; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Shadow_Demon_Disruption) == 0x1a88);
    };
};
