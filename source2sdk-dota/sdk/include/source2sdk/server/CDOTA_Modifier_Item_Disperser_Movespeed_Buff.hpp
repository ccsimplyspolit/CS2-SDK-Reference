...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t movement_speed_buff_rate; // 0x1a78
            float slow_resist; // 0x1a7c
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Disperser_Movespeed_Buff) == 0x1a88);
    };
};
