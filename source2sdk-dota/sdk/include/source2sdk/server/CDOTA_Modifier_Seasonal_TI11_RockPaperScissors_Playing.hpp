...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float input_duration; // 0x1a78
            float think_interval; // 0x1a7c
            bool m_bChoseOption; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Seasonal_TI11_RockPaperScissors_Playing) == 0x1a88);
    };
};
