...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t mana_steal; // 0x1a78
            float m_flCurrentMana; // 0x1a7c
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Obsidian_Destroyer_Equilibrium_Debuff) == 0x1a80);
    };
};
