...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float burn_tick_interval; // 0x1a78
            float blind_duration; // 0x1a7c
            float blind_per_second; // 0x1a80
            std::int32_t damage_per_second; // 0x1a84
            std::int32_t slow_movement_speed_pct; // 0x1a88
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Phoenix_IcarusDiveBurn) == 0x1a90);
    };
};
