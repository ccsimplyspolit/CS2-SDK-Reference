...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hThinker[0x4]; // 0x1a58            
            source2sdk::client::ParticleIndex_t m_nFissureEffectIndex; // 0x1a5c            
            std::int32_t m_nViewerID; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Earthshaker_Spirit_Cairn) == 0x1a68);
    };
};
