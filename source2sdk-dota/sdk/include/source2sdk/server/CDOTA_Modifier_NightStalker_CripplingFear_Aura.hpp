...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            float radius; // 0x1a58            
            std::int32_t death_refresh; // 0x1a5c            
            float mana_pct_cost; // 0x1a60            
            float mana_interval; // 0x1a64            
            source2sdk::client::ParticleIndex_t m_nFXIndex; // 0x1a68            
            float base_duration; // 0x1a6c            
            source2sdk::entity2::GameTime_t m_flStartTime; // 0x1a70            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_NightStalker_CripplingFear_Aura) == 0x1a88);
    };
};
