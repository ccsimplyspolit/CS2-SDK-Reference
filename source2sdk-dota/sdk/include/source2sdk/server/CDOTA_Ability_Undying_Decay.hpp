...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t decay_damage; // 0x580            
            float radius; // 0x584            
            float decay_duration; // 0x588            
            std::int32_t str_steal; // 0x58c            
            float creep_damage_multiplier; // 0x590            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Undying_Decay) == 0x598);
    };
};
