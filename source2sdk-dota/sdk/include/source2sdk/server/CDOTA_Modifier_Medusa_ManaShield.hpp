...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float absorption_pct; // 0x1a5c            
            float damage_per_mana; // 0x1a60            
            float illusion_percentage; // 0x1a64            
            float m_flDamageAccumulator; // 0x1a68            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Medusa_ManaShield) == 0x1a70);
    };
};
