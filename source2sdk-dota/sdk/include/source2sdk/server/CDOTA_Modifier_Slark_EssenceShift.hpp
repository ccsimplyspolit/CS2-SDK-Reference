...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t agi_gain; // 0x1a98
            float duration; // 0x1a9c
            std::int32_t max_stacks_per_hero; // 0x1aa0
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Slark_EssenceShift) == 0x1aa8);
    };
};
