...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t armor_reduction_pct; // 0x1a78
            float m_flArmorReduction; // 0x1a7c
            float armor_per_tick; // 0x1a80
            float tick_rate; // 0x1a84
            std::int32_t max_stacks; // 0x1a88
            std::int32_t m_nTickCount; // 0x1a8c
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Elder_Titan_NaturalOrder_Armor) == 0x1a90);
    };
};
