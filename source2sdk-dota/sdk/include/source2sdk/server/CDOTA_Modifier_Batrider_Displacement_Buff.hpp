...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float movement_speed_pct_total; // 0x1a58            
            float hp_cost_per_second; // 0x1a5c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Batrider_Displacement_Buff because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Batrider_Displacement_Buff) == 0x1a60);
    };
};
