...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t shard_regen_reduction_pct_per_stack; // 0x1a58            
            float shard_burst_radius; // 0x1a5c            
            source2sdk::client::ParticleIndex_t m_nFXStackIndex; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_DrowRanger_FrostArrows_Hypothermia) == 0x1a68);
    };
};
