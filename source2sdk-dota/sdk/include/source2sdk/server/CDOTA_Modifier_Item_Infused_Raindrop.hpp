...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float bonus_armor; // 0x1a5c            
            std::int32_t bonus_magical_armor; // 0x1a60            
            std::int32_t magic_damage_block; // 0x1a64            
            std::int32_t min_damage; // 0x1a68            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Infused_Raindrop) == 0x1a70);
    };
};
