...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float m_flMoveSpeed; // 0x1a80
            bool m_bVisuallyDestroyed; // 0x1a84
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_TemplarAssassin_Meditation_Illusion) == 0x1a88);
    };
};
