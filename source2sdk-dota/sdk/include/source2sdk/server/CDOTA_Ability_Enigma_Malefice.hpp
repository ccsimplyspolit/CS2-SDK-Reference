...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float tick_rate; // 0x580            
            std::int32_t stun_instances; // 0x584            
            float m_flDuration; // 0x588            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Enigma_Malefice) == 0x590);
    };
};
