...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t model_scale; // 0x1a60            
            float damage_radius; // 0x1a64            
            std::int32_t pct_str_damage_per_second; // 0x1a68            
            float tick_rate; // 0x1a6c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Item_Giants_Ring because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Giants_Ring) == 0x1a70);
    };
};
