...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float damage_radius; // 0x1a84
            std::int32_t pct_str_damage_per_second; // 0x1a88
            float tick_rate; // 0x1a8c
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Item_Giants_Ring because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Giants_Ring) == 0x1a90);
    };
};
