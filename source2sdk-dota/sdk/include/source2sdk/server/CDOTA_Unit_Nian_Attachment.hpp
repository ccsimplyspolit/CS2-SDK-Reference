...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            bool m_bAttachmentBroken; // 0x18a0            
            uint8_t _pad18a1[0x3]; // 0x18a1
            source2sdk::client::ParticleIndex_t m_nfxIndex_tailgrow; // 0x18a4            
            ...
            char m_vecRecentDamage[0x18]; // 0x18a8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Unit_Nian_Attachment because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Unit_Nian_Attachment) == 0x18c0);
    };
};
