...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float dispel_hp_regen; // 0x1a78
            std::int32_t num_purged; // 0x1a7c
            ...
            char m_hDispelTarget[0x4]; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Largo_CatchyLick_Buff) == 0x1a88);
    };
};
