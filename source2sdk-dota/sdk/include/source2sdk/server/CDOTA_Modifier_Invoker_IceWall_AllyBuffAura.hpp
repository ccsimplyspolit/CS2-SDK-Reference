...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            float radius; // 0x1a78
            std::int32_t ally_speed; // 0x1a7c
            float ally_armor; // 0x1a80
            float ally_healing; // 0x1a84
            float ally_buff_duration; // 0x1a88
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Invoker_IceWall_AllyBuffAura) == 0x1a90);
    };
};
