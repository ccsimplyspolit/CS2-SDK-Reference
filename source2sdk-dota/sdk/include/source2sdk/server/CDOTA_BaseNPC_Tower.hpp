...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::entity2::CEntityIOOutput m_OnTowerKilled; // 0x19c0
            ...
            char m_hTowerAttackTarget[0x4]; // 0x19d8
            ...
            char m_hTowerHighFiveTarget[0x4]; // 0x19dc
            uint8_t _pad19e0[0x8];
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_BaseNPC_Tower because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_BaseNPC_Tower) == 0x19e8);
    };
};
