...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t ticks_to_revive; // 0x1a5c            
            ...
            char m_pReviveTarget[0x4]; // 0x1a64            
            std::int32_t m_nCurrentTicks; // 0x1a68            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Corpselord_Revive) == 0x1a70);
    };
};
