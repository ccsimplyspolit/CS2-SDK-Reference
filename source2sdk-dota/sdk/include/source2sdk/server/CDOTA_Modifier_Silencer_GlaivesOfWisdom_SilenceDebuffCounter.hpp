...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::client::ParticleIndex_t m_nFXStackIndex; // 0x1a5c            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Silencer_GlaivesOfWisdom_SilenceDebuffCounter) == 0x1a60);
    };
};
