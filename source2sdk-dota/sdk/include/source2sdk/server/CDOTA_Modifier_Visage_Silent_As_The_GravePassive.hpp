...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t movespeed_bonus; // 0x1a78
            float fly_timer; // 0x1a7c
            bool m_bFlying; // 0x1a80
            uint8_t _pad1a81[0x3]; // 0x1a81
            source2sdk::entity2::GameTime_t m_FlyAvailableTime; // 0x1a84
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Visage_Silent_As_The_GravePassive) == 0x1a88);
    };
};
