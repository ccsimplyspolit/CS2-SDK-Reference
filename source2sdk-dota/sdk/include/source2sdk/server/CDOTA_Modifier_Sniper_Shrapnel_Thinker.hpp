...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            float radius; // 0x1a58            
            bool m_bExploded; // 0x1a5c            
            uint8_t _pad1a5d[0x17]; // 0x1a5d
            bool m_bGrantedGem; // 0x1a74            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Sniper_Shrapnel_Thinker) == 0x1a78);
    };
};
