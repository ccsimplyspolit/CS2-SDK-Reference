...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int8_t m_iCurrentMaxRagdollCount; // 0x498            
            uint8_t _pad0499[0x3]; // 0x499
            std::int32_t m_iMaxRagdollCount; // 0x49c            
            bool m_bSaveImportant; // 0x4a0            
            bool m_bCanTakeDamage; // 0x4a1            
            uint8_t _pad04a2[0x6];
        ...
        static_assert(sizeof(source2sdk::server::CRagdollManager) == 0x4a8);
    };
};
