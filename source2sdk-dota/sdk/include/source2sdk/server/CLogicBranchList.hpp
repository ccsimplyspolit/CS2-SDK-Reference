...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_LogicBranchList[0x18]; // 0x518            
            source2sdk::server::CLogicBranchList_LogicBranchListenerLastState_t m_eLastState; // 0x530            
            uint8_t _pad0534[0x4]; // 0x534
            source2sdk::entity2::CEntityIOOutput m_OnAllTrue; // 0x538            
            source2sdk::entity2::CEntityIOOutput m_OnAllFalse; // 0x550            
            source2sdk::entity2::CEntityIOOutput m_OnMixed; // 0x568            
        ...
        static_assert(sizeof(source2sdk::server::CLogicBranchList) == 0x580);
    };
};
