...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float radius; // 0x1a9c
            float corrosive_radius; // 0x1aa0
            float effect_duration; // 0x1aa4
            float dive_speed; // 0x1aa8
            float start_height; // 0x1aac
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_Viper_Nose_Dive because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Viper_Nose_Dive) == 0x1ab0);
    };
};
