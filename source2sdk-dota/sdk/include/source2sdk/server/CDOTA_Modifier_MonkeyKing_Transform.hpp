...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            CUtlString m_strDisguise; // 0x1a78
            std::int32_t movespeed; // 0x1a80
            std::int32_t m_nDisguisedSpeed; // 0x1a84
            std::int32_t reveal_radius; // 0x1a88
            source2sdk::client::ParticleIndex_t m_nDisguiseEffectIndex; // 0x1a8c
            ...
            char m_hCourierToClone[0x4]; // 0x1a90
            ...
            char m_hCreepToClone[0x4]; // 0x1a94
            ...
            char m_aryBountyRuneSpawners[0x18]; // 0x1a98
            bool m_bIsFlyingCourier; // 0x1ab0
            bool m_bIsRune; // 0x1ab1
            bool m_bIsBanana; // 0x1ab2
            bool m_bIsFakeAlly; // 0x1ab3
            std::uint32_t m_nMischiefUnitType; // 0x1ab4
            std::int32_t m_nMischiefHealthbarOffset; // 0x1ab8
            float invul_duration; // 0x1abc
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Modifier_MonkeyKing_Transform because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_MonkeyKing_Transform) == 0x1ac0);
    };
};
