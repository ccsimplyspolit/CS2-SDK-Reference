...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float mana_pct_per_hit; // 0x1a58            
            std::int32_t creep_penalty_reduction_pct; // 0x1a5c            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Leshrac_ChronopticNourishment) == 0x1a60);
    };
};
