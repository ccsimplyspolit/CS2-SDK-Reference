...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float presence_radius; // 0x1a78
            float kill_buff_duration; // 0x1a7c
            source2sdk::entity2::GameTime_t m_fLastStackChange; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Nevermore_Presence_Aura) == 0x1a88);
    };
};
