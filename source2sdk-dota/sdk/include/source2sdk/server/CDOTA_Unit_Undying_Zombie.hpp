...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::server::CountdownTimer m_ctRespawn; // 0x18d0            
            source2sdk::server::CDOTA_BaseNPC* m_pTombstone; // 0x18e8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Unit_Undying_Zombie because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Unit_Undying_Zombie) == 0x18f0);
    };
};
