...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t summon_count; // 0x1a84
            float wave_interval; // 0x1a88
            float burn_duration; // 0x1a8c
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Aghsfort_Aziyog_Underlord_Firestorm_Thinker) == 0x1a98);
    };
};
