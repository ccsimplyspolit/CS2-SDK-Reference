...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float torrent_min_distance; // 0x1a78
            float torrent_max_distance; // 0x1a7c
            std::int32_t m_iExplosionQuadrant; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Kunkka_Torrent_Storm) == 0x1a98);
    };
};
