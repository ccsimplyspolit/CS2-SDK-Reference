...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t arena_kill_buff_damage_pct; // 0x1a78
            std::int32_t arena_kill_buff_heal_pct; // 0x1a7c
            std::int32_t allied_reduction_pct; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Mars_ArenaOfBlood_Kill_Buff) == 0x1a88);
    };
};
