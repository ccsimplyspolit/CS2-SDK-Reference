...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::entity2::CEntityIOOutput m_PlayerHasAmmo; // 0x498            
            source2sdk::entity2::CEntityIOOutput m_PlayerHasNoAmmo; // 0x4b0            
            source2sdk::entity2::CEntityIOOutput m_PlayerDied; // 0x4c8            
            ...
            char m_RequestedPlayerHealth[0x20]; // 0x4e0            
        ...
        static_assert(sizeof(source2sdk::server::CLogicPlayerProxy) == 0x508);
    };
};
