...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hSecondaryTarget[0x4]; // 0x1a90
            std::int32_t m_iAttackCount; // 0x1a94
            std::int32_t creep_attacks_count; // 0x1a98
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_AghsFort_Creature_Phoenix_Sun) == 0x1aa0);
    };
};
