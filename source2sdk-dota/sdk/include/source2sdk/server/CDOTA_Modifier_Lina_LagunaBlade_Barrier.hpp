...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t barrier_pct; // 0x1a5c            
            std::int32_t applied_damage; // 0x1a60            
            std::int32_t barrier; // 0x1a64            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Lina_LagunaBlade_Barrier because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Lina_LagunaBlade_Barrier) == 0x1a68);
    };
};
