...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float m_flDamagePerTick; // 0x1a58            
            std::int32_t m_nCurrentTick; // 0x1a5c            
            std::int32_t m_nTotalTicks; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_QueenOfPain_SonicWave_Damage) == 0x1a68);
    };
};
