...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hHitEntities[0x18]; // 0x580            
            float bounce_radius; // 0x598            
            float damage_radius; // 0x59c            
            std::int32_t damage; // 0x5a0            
            std::int32_t max_targets; // 0x5a4            
            float scepter_heal_pct; // 0x5a8            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Dazzle_ShadowWave) == 0x5b0);
    };
};
