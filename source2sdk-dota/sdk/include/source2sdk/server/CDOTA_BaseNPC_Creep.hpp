...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::server::CDOTA_CreepKillInfo m_KillInfo; // 0x18a8
            source2sdk::client::DOTA_LANE m_Lane; // 0x18c8
            bool m_bPushback; // 0x18cc
            uint8_t _pad18cd[0x3]; // 0x18cd
            float m_flAim; // 0x18d0
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_BaseNPC_Creep) == 0x18d8);
    };
};
