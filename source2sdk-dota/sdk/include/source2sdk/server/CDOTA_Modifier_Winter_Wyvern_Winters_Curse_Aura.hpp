...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float radius; // 0x1a84
            std::int32_t damage_reduction; // 0x1a88
            source2sdk::entity2::GameTime_t m_flLastSeen; // 0x1a8c
            bool transfer_on_death; // 0x1a90
            ...
            char m_vhAffectedEnemyHeroes[0x18]; // 0x1a98
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Winter_Wyvern_Winters_Curse_Aura) == 0x1ab0);
    };
};
