...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t blast_speed; // 0x1a90            
            float blast_radius; // 0x1a94            
            std::int32_t blast_damage; // 0x1a98            
            float blast_debuff_duration; // 0x1a9c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Item_Shivas_Guard_Thinker because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Item_Shivas_Guard_Thinker) == 0x1aa0);
    };
};
