...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float vision_radius; // 0x1a78
            float max_slow_pct; // 0x1a7c
            float m_flBaseVision; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Ringmaster_WeightedPie_Blind) == 0x1a88);
    };
};
