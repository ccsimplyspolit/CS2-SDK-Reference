...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            bool m_bIsMovable; // 0x18a8
            uint8_t _pad18a9[0x3]; // 0x18a9
            QAngle m_angle; // 0x18ac
            std::int32_t m_iPoseParameterAim; // 0x18b8
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_BaseNPC_Venomancer_PlagueWard) == 0x18c0);
    };
};
