...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t m_nVampiricAura; // 0x1a7c            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_SkeletonKing_BoneGuard_Summon) == 0x1a80);
    };
};
