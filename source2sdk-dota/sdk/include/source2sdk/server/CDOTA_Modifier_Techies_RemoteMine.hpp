...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t radius_scepter; // 0x1a90
            std::int32_t damage_scepter; // 0x1a94
            std::int32_t vision_radius; // 0x1a98
            float vision_duration; // 0x1a9c
            std::int32_t model_scale; // 0x1aa0
            bool bExploding; // 0x1aa4
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Techies_RemoteMine) == 0x1aa8);
    };
};
