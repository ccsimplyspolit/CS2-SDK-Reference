...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t ally_ms; // 0x1a58            
            std::int32_t ally_armor; // 0x1a5c            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Kunkka_XMarksTheSpot) == 0x1a78);
    };
};
