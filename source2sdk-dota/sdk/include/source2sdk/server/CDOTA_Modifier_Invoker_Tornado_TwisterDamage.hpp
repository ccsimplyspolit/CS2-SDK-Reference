...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t twister_damage; // 0x1a78
            float twister_tick_rate; // 0x1a7c
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Invoker_Tornado_TwisterDamage) == 0x1a80);
    };
};
