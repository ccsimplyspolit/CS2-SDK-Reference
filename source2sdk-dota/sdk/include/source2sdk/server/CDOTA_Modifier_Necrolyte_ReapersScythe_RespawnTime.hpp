...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float hp_per_kill; // 0x1a58            
            float mana_per_kill; // 0x1a5c            
            float hp_regen; // 0x1a60            
            float mp_regen; // 0x1a64            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Necrolyte_ReapersScythe_RespawnTime) == 0x1a68);
    };
};
