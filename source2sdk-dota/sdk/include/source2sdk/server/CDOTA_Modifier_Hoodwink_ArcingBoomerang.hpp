...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            bool m_bGroundTargeted; // 0x1ab4
            uint8_t _pad1ab5[0x3]; // 0x1ab5
            float m_flTravelDuration; // 0x1ab8
            source2sdk::entity2::GameTime_t m_flBoomerangDieTime; // 0x1abc
            bool m_bReturning; // 0x1ac0
            bool m_bCatchingBoomerang; // 0x1ac1
            bool m_bDisjointed; // 0x1ac2
            uint8_t _pad1ac3[0x1]; // 0x1ac3
            std::int32_t m_nFramesToWait; // 0x1ac4
            ...
            char m_hBoomerang[0x4]; // 0x1ac8
            // m_hTarget has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CHandle<source2sdk::server::CBaseEntity> m_hTarget;
            char m_hTarget[0x4]; // 0x1acc
            source2sdk::client::ParticleIndex_t m_nBoomerangFXIndex; // 0x1ad0
            source2sdk::client::ParticleIndex_t m_nOldBoomerangFXindex; // 0x1ad4
            ...
            char m_vecUniqueHitList[0x18]; // 0x1ad8
            float radius; // 0x1af0
            float spread; // 0x1af4
            float damage; // 0x1af8
            float mark_duration; // 0x1afc
            float min_throw_duration; // 0x1b00
            float max_throw_duration; // 0x1b04
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Hoodwink_ArcingBoomerang) == 0x1b20);
    };
};
