...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char hUnitsToHit[0x18]; // 0x1aa8
            bool m_bLaunched; // 0x1ac0
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Zuus_Heavenly_Jump) == 0x1ac8);
    };
};
