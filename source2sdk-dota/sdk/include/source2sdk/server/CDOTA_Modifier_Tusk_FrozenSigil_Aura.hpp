...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float sigil_radius; // 0x1a58            
            source2sdk::client::ParticleIndex_t m_iParticleIndex; // 0x1a5c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Tusk_FrozenSigil_Aura because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Tusk_FrozenSigil_Aura) == 0x1a60);
    };
};
