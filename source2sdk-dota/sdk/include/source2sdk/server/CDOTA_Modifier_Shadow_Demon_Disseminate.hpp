...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float radius; // 0x1a5c            
            source2sdk::entity2::GameTime_t m_flLastDispersionPulseEffectTime; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Shadow_Demon_Disseminate) == 0x1a68);
    };
};
