...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float interval_scepter; // 0x1a58            
            bool bInBufferTime; // 0x1a5c            
            uint8_t _pad1a5d[0x3]; // 0x1a5d
            std::int32_t damage; // 0x1a60            
            source2sdk::entity2::GameTime_t m_flLastApplyTime; // 0x1a64            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Mirana_Starfall_Scepter_Thinker) == 0x1a68);
    };
};
