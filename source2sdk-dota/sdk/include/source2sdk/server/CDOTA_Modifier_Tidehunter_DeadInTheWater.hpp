...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t max_movement_speed; // 0x1a78
            std::int32_t chain_length; // 0x1a7c
            ...
            char m_hAnchor[0x4]; // 0x1a80
            bool m_bDragging; // 0x1a84
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Tidehunter_DeadInTheWater) == 0x1a88);
    };
};
