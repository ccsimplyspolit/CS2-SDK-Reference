...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t max_movement_speed; // 0x1a58            
            std::int32_t chain_length; // 0x1a5c            
            ...
            char m_hAnchor[0x4]; // 0x1a60            
            bool m_bDragging; // 0x1a64            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Tidehunter_DeadInTheWater) == 0x1a68);
    };
};
