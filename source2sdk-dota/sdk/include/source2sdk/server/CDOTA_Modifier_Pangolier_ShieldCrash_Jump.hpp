...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            float jump_duration_gyroshell; // 0x1a5c            
            std::int32_t jump_height; // 0x1a60            
            std::int32_t jump_height_gyroshell; // 0x1a64            
            float m_flStartZ; // 0x1a68            
            float m_flCurTime; // 0x1a6c            
            float m_flJumpDuration; // 0x1a70            
            float m_flJumpHeight; // 0x1a74            
            std::int32_t jump_horizontal_distance; // 0x1a78            
            Vector m_vTargetHorizontalDirection; // 0x1a7c            
            float m_flPreviousElapsedTime; // 0x1a88            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Pangolier_ShieldCrash_Jump) == 0x1a90);
    };
};
