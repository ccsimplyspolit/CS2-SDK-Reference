...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t light_strike_array_aoe; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Greevil_Miniboss_Orange_LightStrikeArray_Thinker) == 0x1a68);
    };
};
