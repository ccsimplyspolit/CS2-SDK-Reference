...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t skeleton_damage_pct; // 0x1a7c
            float skeleton_range; // 0x1a80
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Clinkz_SearingArrows) == 0x1aa8);
    };
};
