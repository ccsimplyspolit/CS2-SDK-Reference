...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t enchant_health; // 0x1a7c
            std::int32_t enchant_armor; // 0x1a80
            float enchant_damage; // 0x1a84
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Enchantress_Enchant_Controlled) == 0x1a90);
    };
};
