...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t enchant_health; // 0x1a5c            
            std::int32_t enchant_armor; // 0x1a60            
            float enchant_damage; // 0x1a64            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Enchantress_Enchant_Controlled) == 0x1a70);
    };
};
