...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t bonus_spell_amp; // 0x1a7c
            std::int32_t bonus_armor; // 0x1a80
            std::int32_t bonus_mres; // 0x1a84
            float hp_regen; // 0x1a88
            float spell_lifesteal; // 0x1a8c
            bool unslowable; // 0x1a90
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Wisp_Overcharge) == 0x1a98);
    };
};
