...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::client::ParticleIndex_t m_nFXIndexAoE; // 0x1a5c            
            float effect_radius; // 0x1a60            
            bool bActive; // 0x1a64            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Muerta_Ofrenda_Invulnerable) == 0x1a68);
    };
};
