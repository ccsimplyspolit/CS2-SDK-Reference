...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::client::ParticleIndex_t m_nFXEarthAmbient1; // 0x18d8
            source2sdk::client::ParticleIndex_t m_nFXEarthAmbient2; // 0x18dc
        };
        #pragma pack(pop)

        // Cannot assert offsets of fields in CDOTA_Unit_Brewmaster_PrimalEarth because it is not a standard-layout class

        static_assert(sizeof(source2sdk::server::CDOTA_Unit_Brewmaster_PrimalEarth) == 0x18e0);
    };
};
