...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            CUtlSymbolLarge m_associatedRelayTargetName; // 0x4a8            
            bool m_fixupNames; // 0x4b0            
            bool m_bLoadDynamic; // 0x4b1            
            uint8_t _pad04b2[0x2]; // 0x4b2
            ...
            char m_associatedRelayEntity[0x4]; // 0x4b4            
            ...
            char m_ProceduralRelaySources[0x18]; // 0x4b8            
            uint8_t _pad04d0[0x50];
        };
        #pragma pack(pop)
