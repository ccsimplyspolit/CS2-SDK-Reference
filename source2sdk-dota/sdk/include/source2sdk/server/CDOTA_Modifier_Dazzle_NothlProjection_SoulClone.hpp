...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float shadow_wave_cdr; // 0x1a58            
            float healing_amp; // 0x1a5c            
            source2sdk::entity2::GameTime_t m_flLastThinkTime; // 0x1a60            
            float leash_start; // 0x1a64            
            float base_leash_pull; // 0x1a68            
            float leash_increase; // 0x1a6c            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Dazzle_NothlProjection_SoulClone) == 0x1a78);
    };
};
