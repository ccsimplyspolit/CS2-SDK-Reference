...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            float shadow_wave_cdr; // 0x1a78
            float healing_amp; // 0x1a7c
            source2sdk::entity2::GameTime_t m_flLastThinkTime; // 0x1a80
            float leash_start; // 0x1a84
            float base_leash_pull; // 0x1a88
            float leash_increase; // 0x1a8c
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Dazzle_NothlProjection_SoulClone) == 0x1a98);
    };
};
