...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::entity2::CEntityIOOutput m_OnPass; // 0x4a0            
            source2sdk::entity2::CEntityIOOutput m_OnFail; // 0x4b8            
        ...
        static_assert(sizeof(source2sdk::server::CBaseFilter) == 0x4d0);
    };
};
