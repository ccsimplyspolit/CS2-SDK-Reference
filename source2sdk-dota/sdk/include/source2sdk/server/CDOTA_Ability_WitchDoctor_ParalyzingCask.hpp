...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t m_iBounces; // 0x580            
            std::int32_t bounces; // 0x584            
            std::int32_t bounce_bonus_damage; // 0x588            
