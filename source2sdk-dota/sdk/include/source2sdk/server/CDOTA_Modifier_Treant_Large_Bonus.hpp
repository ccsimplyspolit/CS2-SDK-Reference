...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t treant_large_hp_bonus; // 0x1a58            
            std::int32_t treant_large_damage_bonus; // 0x1a5c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CDOTA_Modifier_Treant_Large_Bonus because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Treant_Large_Bonus) == 0x1a60);
    };
};
