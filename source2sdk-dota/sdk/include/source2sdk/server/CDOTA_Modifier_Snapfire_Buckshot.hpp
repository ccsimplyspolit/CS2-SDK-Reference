...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            std::int32_t miss_chance; // 0x1a78
            std::int32_t damage_amp; // 0x1a7c
            std::int32_t split_shot; // 0x1a80
            std::int32_t glancing_shot_damage_pct; // 0x1a84
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Snapfire_Buckshot) == 0x1aa0);
    };
};
