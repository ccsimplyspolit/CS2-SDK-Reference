...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char hIllusion[0x18]; // 0x580            
            float decoy_stun_duration; // 0x598            
            float decoy_detonate_radius; // 0x59c            
            float projectile_speed; // 0x5a0            
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Ability_Hoodwink_Decoy) == 0x5c0);
    };
};
