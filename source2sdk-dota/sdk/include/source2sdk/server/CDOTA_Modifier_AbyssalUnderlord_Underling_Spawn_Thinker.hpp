...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_vecAttackedEnemies[0x18]; // 0x1a78            
            bool m_bSpawnsStarted; // 0x1a90            
            uint8_t _pad1a91[0x3]; // 0x1a91
            std::int32_t nSpawnsCompleted; // 0x1a94            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_AbyssalUnderlord_Underling_Spawn_Thinker) == 0x1a98);
    };
};
