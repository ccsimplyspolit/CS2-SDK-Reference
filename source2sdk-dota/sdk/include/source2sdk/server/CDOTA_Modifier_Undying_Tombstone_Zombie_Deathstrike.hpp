...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            float radius; // 0x1a78
            float health_threshold_pct; // 0x1a7c
            ...
            char m_hTombstoneSourceAbility[0x4]; // 0x1a84
        ...
        static_assert(sizeof(source2sdk::server::CDOTA_Modifier_Undying_Tombstone_Zombie_Deathstrike) == 0x1a90);
    };
};
