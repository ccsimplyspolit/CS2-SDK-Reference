...
namespace source2sdk
{
    namespace physicslib
    {
        ...
        public:
            ...
            char m_VertexPositions[0x18]; // 0x70            
            ...
            char m_FacePlanes[0x18]; // 0x88            
            std::uint32_t m_nFlags; // 0xa0            
            uint8_t _pad00a4[0x4]; // 0xa4
            source2sdk::physicslib::CRegionSVM* m_pRegionSVM; // 0xa8            
        ...
        static_assert(offsetof(source2sdk::physicslib::RnHull_t, m_VertexPositions) == 0x70);
        static_assert(offsetof(source2sdk::physicslib::RnHull_t, m_FacePlanes) == 0x88);
        static_assert(offsetof(source2sdk::physicslib::RnHull_t, m_nFlags) == 0xa0);
        static_assert(offsetof(source2sdk::physicslib::RnHull_t, m_pRegionSVM) == 0xa8);
        static_assert(offsetof(source2sdk::physicslib::RnHull_t, m_Vertices) == 0xb0);
        static_assert(offsetof(source2sdk::physicslib::RnHull_t, m_Edges) == 0xc8);
        static_assert(offsetof(source2sdk::physicslib::RnHull_t, m_Faces) == 0xe0);
