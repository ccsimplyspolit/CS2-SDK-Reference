...
| [`patterns/`](patterns/) | 141 byte-signatures for CS2's hookable functions + C++ net-message layouts — all verified against the game |
...
| [`source2sdk-dota/`](source2sdk-dota/) | Dota 2 SDK (ClientVersion 6888) — 17229 headers across 32 modules |
| [`source2sdk-deadlock/`](source2sdk-deadlock/) | Deadlock SDK (Steam buildid 24599046) — 9035 headers across 32 modules |
...
Current values (a2x/cs2-dumper HEAD, build 14174 / 2026-08-04; verified against the installed CS2 binaries):

| Field | Decimal | Hex | Points at |
|---|---:|---|---|
| `dwLocalPlayerController` | 37223296 | `0x237FB80` | follow ptr → `CCSPlayerController*` |
...
| [`patterns/`](patterns/) | 141 байт-сигнатуры хукабельных функций CS2 + C++-layout сетевых сообщений — все сверены с игрой |
...
| [`source2sdk-dota/`](source2sdk-dota/) | Dota 2 SDK (ClientVersion 6888) — 17229 заголовков в 32 модулях |
| [`source2sdk-deadlock/`](source2sdk-deadlock/) | Deadlock SDK (Steam buildid 24599046) — 9035 заголовков в 32 модулях |
...
Актуальные значения (`a2x/cs2-dumper` HEAD, билд 14174 / 2026-08-04; сверено с установленными бинарниками CS2):

| Поле | Десятичное | Hex | Куда указывает |
|---|---:|---|---|
| `dwLocalPlayerController` | 37223296 | `0x237FB80` | разыменовать → `CCSPlayerController*` |
| `dwGameRules` | 37374424 | `0x23A49D8` | `C_CSGameRules*` |
| `dwLocalPlayerPawn` | 37376568 | `0x23A5238` | `C_CSPlayerPawn*` |
| `dwCSGOInput` | 37463952 | `0x23BA790` | `CCSGOInput*` |
| `dwGlobalVars` | 34147680 | `0x2090D60` | `CGlobalVars*` |
